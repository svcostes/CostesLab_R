...
tif_dir = 'J:\BNL19A-CD7Images\'; % Where tiff from Zeiss CD7 have been put
...
out_dir = 'D:\BNL19A_cropped_plates'; % Directory where to save cropped images
plate_name = 'P4976'; % This will name the new directory with cropped images and analysis.
file_name = '497_slice9-01';
num_z = 9; % number of Z stack
num_digit = 3; % IF your numbers for position go until 99, use 2, if it goes until 999, use3. Default is 4 (1440 positions)
num_img = 5; % number of full images per well
...
switch strain
    case 'mouse' % skin mouse cells are larger. Need a larger cutoff
        size_cutoff = 800; nuc_th = 1.1; max_fitc = 25000; % Maximum pixels intensity for fitc. This is used to diplay max projection only. It allows to compare different batches
    case 'human'
...
while read_flag
    ...
    mask = nuc_segmentor_local(nuc_img,10,1,nuc_th,1,0);
    ...
    writeim(tmp_col,[well_folder '\' well_info],'jpeg',0); % actually writing file
