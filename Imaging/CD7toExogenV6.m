...
%{ 
These appear to just import dip image -JDO
...
tif_dir = '/data/PLATES_MISSING_POSITIONS'; % Where tiff from Zeiss CD7 have been put
fitc_str = 'AF488';  % Replace to the right suffix for Dapi images
dapi_str = 'DAPI';  % Replace with the right suffix for FITC images
out_dir = '/data/BNL_19C/Training_2021_July_JDO_remote'; % Directory where to save cropped images
plate_name = 'P731_training_remote_server'; % This will name the new directory with cropped images and analysis.
file_name = '731_Fe_0_4h_Set2_A_19C'
...
start_sub = 1; % change this number to restart from a specificu subwell.
