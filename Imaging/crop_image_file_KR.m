...
% channels
% K. Rienecker Feb 2023 – editing script to move params to config file and match function with nf workflow
...
function main(tif_dir, out_dir, plate_name, ch_name, ch_name_short, ch_DAPI, Z_DAPI, num_ch, size_cutoff, nuc_th, nuc_rad, P2A_min, max_ch) 
...
image_path = ['/data/2022-11-15/895_Gamma_0_4h_Set3_A_21B/*'];
img = bfopen(image_path);

%Metadata from bf open is stored in the data {s,2} element
