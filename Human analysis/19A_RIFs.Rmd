...
```{r}
setwd(getwd()) ## Change as necessary: this is the main directory
...
```{r}
## Read all metadata
subject_meta = read.csv('Sample_metadata.csv', sep = ",", header = TRUE)
...
```{r}
## Read first file
foci_gamma_first = data.frame(Plate = gamma_plate_nums[1], Plate_well = paste(gamma_plate_nums[1], read.table(paste("average_well/BNL19A/average_well_P", gamma_plate_nums[1],'.txt', sep=""), sep="\t", header = TRUE)$Well, sep = "_"), read.table(paste("average_well/BNL19A/average_well_P", gamma_plate_nums[1],'.txt', sep=""), sep="\t", header = TRUE))

gamma_table=foci_gamma_first

foci_si_first = data.frame(Plate = si_plate_nums[1], Plate_well = paste(si_plate_nums[1], read.table(paste("average_well/BNL19A/average_well_P", si_plate_nums[1],'.txt', sep=""), sep="\t", header = TRUE)$Well, sep = "_"), read.table(paste("average_well/BNL19A/average_well_P", si_plate_nums[1],'.txt', sep=""), sep="\t", header = TRUE))

si_table=foci_si_first

foci_ar_first = data.frame(Plate = ar_plate_nums[1], Plate_well = paste(ar_plate_nums[1], read.table(paste("average_well/BNL19A/average_well_P", ar_plate_nums[1],'.txt', sep=""), sep="\t", header = TRUE)$Well, sep = "_"), read.table(paste("average_well/BNL19A/average_well_P", ar_plate_nums[1],'.txt', sep=""), sep="\t", header = TRUE))

ar_table=foci_ar_first

foci_fe_first = data.frame(Plate = fe_plate_nums[1], Plate_well = paste(fe_plate_nums[1], read.table(paste("average_well/BNL19A/average_well_P", fe_plate_nums[1],'.txt', sep=""), sep="\t", header = TRUE)$Well, sep = "_"), read.table(paste("average_well/BNL19A/average_well_P", fe_plate_nums[1],'.txt', sep=""), sep="\t", header = TRUE))
...
for(ii in 2:gamma_plate_count){
  temp_gamma_filename = paste('average_well/BNL19A/average_well_P', gamma_plate_nums[ii],'.txt', sep="")
  temp_gamma_table = data.frame(Plate = gamma_plate_nums[ii], Plate_well = paste(gamma_plate_nums[ii], read.table(paste('average_well/BNL19A/average_well_P', gamma_plate_nums[ii],'.txt', sep=""), sep="\t", header = TRUE)$Well, sep = "_"), read.table(paste('average_well/BNL19A/average_well_P', gamma_plate_nums[ii],'.txt', sep=""), sep="\t", header = TRUE))
  gamma_table = rbind(gamma_table, temp_gamma_table)
}

for(ii in 2:si_plate_count){
  temp_si_filename = paste('average_well/BNL19A/average_well_P', si_plate_nums[ii],'.txt', sep="")
  temp_si_table = data.frame(Plate = si_plate_nums[ii], Plate_well = paste(si_plate_nums[ii], read.table(paste('average_well/BNL19A/average_well_P', si_plate_nums[ii],'.txt', sep=""), sep="\t", header = TRUE)$Well, sep = "_"), read.table(paste('average_well/BNL19A/average_well_P', si_plate_nums[ii],'.txt', sep=""), sep="\t", header = TRUE))
  si_table = rbind(si_table, temp_si_table)
}

for(ii in 2:ar_plate_count){
  temp_ar_filename = paste('average_well/BNL19A/average_well_P', ar_plate_nums[ii],'.txt', sep="")
  temp_ar_table = data.frame(Plate = ar_plate_nums[ii], Plate_well = paste(ar_plate_nums[ii], read.table(paste('average_well/BNL19A/average_well_P', ar_plate_nums[ii],'.txt', sep=""), sep="\t", header = TRUE)$Well, sep = "_"), read.table(paste('average_well/BNL19A/average_well_P', ar_plate_nums[ii],'.txt', sep=""), sep="\t", header = TRUE))
  ar_table = rbind(ar_table, temp_ar_table)
  }

for(ii in 2:fe_plate_count){
  temp_fe_filename = paste('average_well/BNL19A/average_well_P', fe_plate_nums[ii],'.txt', sep="")
  temp_fe_table = data.frame(Plate = fe_plate_nums[ii], Plate_well = paste(fe_plate_nums[ii], read.table(paste('average_well/BNL19A/average_well_P', fe_plate_nums[ii],'.txt', sep=""), sep="\t", header = TRUE)$Well, sep = "_"), read.table(paste('average_well/BNL19A/average_well_P', fe_plate_nums[ii],'.txt', sep=""), sep="\t", header = TRUE))
