...
### Graphs: Raw data with and without normalisation
...
RIF_Raw_LD_HD$Run_Set_Duplicate = paste(RIF_Raw_LD_HD$Run_set, RIF_Raw_LD_HD$Duplicate, sep = "_Dup_")
...
RIF_Raw_LD_HD$Time_dose=factor(RIF_Raw_LD_HD$Time_dose, levels=c("4h 0 Gy control", "4h Low dose", "4h High dose","24h 0 Gy control",
                                                                 "24h Low dose", "24h High dose"))
Run_18B_19A=c("Run_18B_Set_2", "Run_19A_Set_1")
...
ggsave("Raw_No_Norm_all_subj.pdf", graph_without_Norm, width=25, height=7)

## for the 10 people that overlapp in 18B_Set_2 and in 19A_Set_1
...
#
RIF_Raw_LD_HD_10p$Run_Set_Duplicate = paste(RIF_Raw_LD_HD_10p$Run_set, RIF_Raw_LD_HD_10p$Duplicate, sep = "_Dup_")
...
RIF_Raw_LD_HD_10p$Time_dose=factor(RIF_Raw_LD_HD_10p$Time_dose, levels=c("4h 0 Gy control", "4h Low dose", "4h High dose","24h 0 Gy control",
                                                                 "24h Low dose", "24h High dose"))
#
graph_without_Norm <- ggplot(RIF_Raw_LD_HD_10p, aes(x=Time_dose, y=RIF)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Raw_No_Norm_10p.pdf", graph_without_Norm, width=25, height=7)
...
RIF_Raw_LD_HD_Norm$Run_Set_Duplicate = paste(RIF_Raw_LD_HD_Norm$Run_set, RIF_Raw_LD_HD_Norm$Duplicate, sep = "_Dup_")
...
ggsave("Raw_Norm_all_subj.pdf", graph_with_Norm, width=25, height=7)

## for the 10 people that overlapp in 18B_Set_2 and in 19A_Set_1
Subject_18BS2_19AS1 = c(1214, 1215,1216,1217,1218,1219,1220,1221,1222,1223)
RIF_Raw_LD_HD_10p_Norm = RIF_Raw_LD_HD_Norm %>% filter(RIF_Raw_LD_HD_Norm$Sample_ID %in% Subject_18BS2_19AS1)
#
RIF_Raw_LD_HD_10p_Norm$Run_Set_Duplicate = paste(RIF_Raw_LD_HD_10p_Norm$Run_set, RIF_Raw_LD_HD_10p_Norm$Duplicate, sep = "_Dup_")
RIF_Raw_LD_HD_10p_Norm$Timepoint=factor(RIF_Raw_LD_HD_10p_Norm$Timepoint, levels=c("4h", "24h"))
RIF_Raw_LD_HD_10p_Norm$Radiation_type=factor(RIF_Raw_LD_HD_10p_Norm$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
RIF_Raw_LD_HD_10p_Norm$Time_dose=paste(RIF_Raw_LD_HD_10p_Norm$Timepoint, RIF_Raw_LD_HD_10p_Norm$Dose_relative, sep = " ")
RIF_Raw_LD_HD_10p_Norm$Time_dose=factor(RIF_Raw_LD_HD_10p_Norm$Time_dose, levels=c("4h Low dose", "4h High dose",
                                                                 "24h Low dose", "24h High dose"))
#
graph_with_Norm <- ggplot(RIF_Raw_LD_HD_10p_Norm, aes(x=Time_dose, y=RIF_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Raw_Norm_10p.pdf", graph_with_Norm, width=25, height=7)
...
```{r}
### Graphs after correction using Finsam's function (for correction between Radiation type within each run and set)

### Graphs: Raw data with and without normalization

## Without normalization
RIF_Correct1_Control = Corrected_DNA_Damage
RIF_Correct1_Control$avg_nfoci_high_dose=NULL
RIF_Correct1_Control$avg_nfoci_low_dose=NULL
RIF_Correct1_Control$avg_foci_no_outl_0=NULL
RIF_Correct1_Control$avg_foci_no_outl_high_dose=NULL
RIF_Correct1_Control$avg_foci_no_outl_low_dose=NULL
...
#
RIF_Correct1_LD = Corrected_DNA_Damage
RIF_Correct1_LD$avg_nfoci_high_dose=NULL
RIF_Correct1_LD$avg_nfoci_0=NULL
RIF_Correct1_LD$avg_foci_no_outl_0=NULL
RIF_Correct1_LD$avg_foci_no_outl_high_dose=NULL
RIF_Correct1_LD$avg_foci_no_outl_low_dose=NULL
RIF_Correct1_LD$Dose_relative= "Low dose"
colnames(RIF_Correct1_LD)[colnames(RIF_Correct1_LD) == "avg_nfoci_low_dose"] <- "RIF"
#
RIF_Correct1_HD = Corrected_DNA_Damage
RIF_Correct1_HD$avg_nfoci_low_dose=NULL
RIF_Correct1_HD$avg_nfoci_0=NULL
RIF_Correct1_HD$avg_foci_no_outl_0=NULL
RIF_Correct1_HD$avg_foci_no_outl_high_dose=NULL
RIF_Correct1_HD$avg_foci_no_outl_low_dose=NULL
...
RIF_Correct1_LD_HD$Run_Set_Duplicate = paste(RIF_Correct1_LD_HD$Run_set, RIF_Correct1_LD_HD$Duplicate, sep = "_Dup_")
RIF_Correct1_LD_HD$Timepoint=factor(RIF_Correct1_LD_HD$Timepoint, levels=c("4h", "24h"))
...
RIF_Correct1_LD_HD$Time_dose=factor(RIF_Correct1_LD_HD$Time_dose, levels=c("4h 0 Gy control", "4h Low dose", "4h High dose","24h 0 Gy control",
                                                                 "24h Low dose", "24h High dose"))
...
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Correction_1_No_Norm_all_subj.pdf", graph_without_Norm, width=25, height=7)

## for the 10 people that overlapp in 18B_Set_2 and in 19A_Set_1
Subject_18BS2_19AS1 = c(1214, 1215,1216,1217,1218,1219,1220,1221,1222,1223)
RIF_Correct1_LD_HD_10p = RIF_Correct1_LD_HD %>% filter(RIF_Correct1_LD_HD$Sample_ID %in% Subject_18BS2_19AS1)
#
RIF_Correct1_LD_HD_10p$Run_Set_Duplicate = paste(RIF_Correct1_LD_HD_10p$Run_set, RIF_Correct1_LD_HD_10p$Duplicate, sep = "_Dup_")
RIF_Correct1_LD_HD_10p$Timepoint=factor(RIF_Correct1_LD_HD_10p$Timepoint, levels=c("4h", "24h"))
RIF_Correct1_LD_HD_10p$Radiation_type=factor(RIF_Correct1_LD_HD_10p$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
RIF_Correct1_LD_HD_10p$Time_dose=paste(RIF_Correct1_LD_HD_10p$Timepoint, RIF_Correct1_LD_HD_10p$Dose_relative, sep = " ")
RIF_Correct1_LD_HD_10p$Time_dose=factor(RIF_Correct1_LD_HD_10p$Time_dose, levels=c("4h Low dose", "4h High dose",
                                                                 "24h Low dose", "24h High dose"))
#
graph_without_Norm <- ggplot(RIF_Correct1_LD_HD_10p, aes(x=Time_dose, y=RIF)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Correction_1_No_Norm_10p.pdf", graph_without_Norm, width=25, height=7)

## With Normalization
RIF_Correct1_Norm = Corrected_DNA_Damage
RIF_Correct1_Norm$RIF_Norm_low_dose=RIF_Correct1_Norm$avg_nfoci_low_dose / RIF_Correct1_Norm$avg_nfoci_0
RIF_Correct1_Norm$RIF_Norm_high_dose=RIF_Correct1_Norm$avg_nfoci_high_dose / RIF_Correct1_Norm$avg_nfoci_0
#
# 
RIF_Correct1_Norm_LD= RIF_Correct1_Norm 
RIF_Correct1_Norm_LD$RIF_Norm_high_dose=NULL
RIF_Correct1_Norm_LD$avg_nfoci_high_dose=NULL
RIF_Correct1_Norm_LD$avg_foci_no_outl_high_dose=NULL
RIF_Correct1_Norm_LD$avg_nfoci_low_dose=NULL
RIF_Correct1_Norm_LD$avg_foci_no_outl_low_dose=NULL
RIF_Correct1_Norm_LD$avg_nfoci_0=NULL
RIF_Correct1_Norm_LD$avg_foci_no_outl_0=NULL
RIF_Correct1_Norm_LD$Dose_relative= "Low dose"
colnames(RIF_Correct1_Norm_LD)[colnames(RIF_Correct1_Norm_LD) == "RIF_Norm_low_dose"] <- "RIF_Norm"
#
RIF_Correct1_Norm_HD= RIF_Correct1_Norm 
RIF_Correct1_Norm_HD$RIF_Norm_low_dose=NULL
RIF_Correct1_Norm_HD$avg_nfoci_high_dose=NULL
RIF_Correct1_Norm_HD$avg_foci_no_outl_high_dose=NULL
RIF_Correct1_Norm_HD$avg_nfoci_low_dose=NULL
RIF_Correct1_Norm_HD$avg_foci_no_outl_low_dose=NULL
RIF_Correct1_Norm_HD$avg_nfoci_0=NULL
RIF_Correct1_Norm_HD$avg_foci_no_outl_0=NULL
RIF_Correct1_Norm_HD$Dose_relative= "High dose"
colnames(RIF_Correct1_Norm_HD)[colnames(RIF_Correct1_Norm_HD) == "RIF_Norm_high_dose"] <- "RIF_Norm"
#
RIF_Correct1_LD_HD_Norm = bind_rows(RIF_Correct1_Norm_LD, RIF_Correct1_Norm_HD)
RIF_Correct1_LD_HD_Norm$Point = paste(RIF_Correct1_LD_HD_Norm$Radiation_type, RIF_Correct1_LD_HD_Norm$Timepoint, sep = '_')
RIF_Correct1_LD_HD_Norm$Run_Set_Duplicate = paste(RIF_Correct1_LD_HD_Norm$Run_set, RIF_Correct1_LD_HD_Norm$Duplicate, sep = "_Dup_")
RIF_Correct1_LD_HD_Norm$Timepoint=factor(RIF_Correct1_LD_HD_Norm$Timepoint, levels=c("4h", "24h"))
RIF_Correct1_LD_HD_Norm$Radiation_type=factor(RIF_Correct1_LD_HD_Norm$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
RIF_Correct1_LD_HD_Norm$Rad_dose=paste(RIF_Correct1_LD_HD_Norm$Radiation_type, RIF_Correct1_LD_HD_Norm$Dose_relative, sep = " ")
RIF_Correct1_LD_HD_Norm$Time_dose=paste(RIF_Correct1_LD_HD_Norm$Timepoint, RIF_Correct1_LD_HD_Norm$Dose_relative, sep = " ")
RIF_Correct1_LD_HD_Norm$Time_dose=factor(RIF_Correct1_LD_HD_Norm$Time_dose, levels=c("4h Low dose", "4h High dose",
                                                                 "24h Low dose", "24h High dose"))

Run_18B_19A=c("Run_18B_Set_2", "Run_19A_Set_1")
RIF_Correct1_LD_HD_Norm_Run = RIF_Correct1_LD_HD_Norm %>% filter(RIF_Correct1_LD_HD_Norm$Run_set %in% Run_18B_19A)

graph_with_Norm <- ggplot(RIF_Correct1_LD_HD_Norm_Run, aes(x=Time_dose, y=RIF_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Correction_1_Norm_all_subj.pdf", graph_with_Norm, width=25, height=7)

## for the 10 people that overlapp in 18B_Set_2 and in 19A_Set_1
Subject_18BS2_19AS1 = c(1214, 1215,1216,1217,1218,1219,1220,1221,1222,1223)
RIF_Correct1_LD_HD_10p_Norm = RIF_Correct1_LD_HD_Norm %>% filter(RIF_Correct1_LD_HD_Norm$Sample_ID %in% Subject_18BS2_19AS1)
#
RIF_Correct1_LD_HD_10p_Norm$Run_Set_Duplicate = paste(RIF_Correct1_LD_HD_10p_Norm$Run_set, RIF_Correct1_LD_HD_10p_Norm$Duplicate, sep = "_Dup_")
RIF_Correct1_LD_HD_10p_Norm$Timepoint=factor(RIF_Correct1_LD_HD_10p_Norm$Timepoint, levels=c("4h", "24h"))
RIF_Correct1_LD_HD_10p_Norm$Radiation_type=factor(RIF_Correct1_LD_HD_10p_Norm$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
RIF_Correct1_LD_HD_10p_Norm$Time_dose=paste(RIF_Correct1_LD_HD_10p_Norm$Timepoint, RIF_Correct1_LD_HD_10p_Norm$Dose_relative, sep = " ")
RIF_Correct1_LD_HD_10p_Norm$Time_dose=factor(RIF_Correct1_LD_HD_10p_Norm$Time_dose, levels=c("4h Low dose", "4h High dose",
                                                                 "24h Low dose", "24h High dose"))
#
graph_with_Norm <- ggplot(RIF_Correct1_LD_HD_10p_Norm, aes(x=Time_dose, y=RIF_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Correction_1_Norm_10p.pdf", graph_with_Norm, width=25, height=7)
...
```{r}
### Now we isolate the 10 people that overlap in 19C_Set_1 and in 18B_set_2 

# only 19A_Set_1 and 18B_Set_2
Run_19A_18B = c("Run_18B_Set_2","Run_19A_Set_1")
...
Subject_18BS2_19AS1 = c(1214, 1215,1216,1217,1218,1219,1220,1221,1222,1223)
RIF_correct_19A_18B_10p = RIF_correct_19A_18B %>% filter(RIF_correct_19A_18B$Sample_ID %in% Subject_18BS2_19AS1 )
...
## z-score correction
# 4h
control_18B_4h_Fe$avg_nfoci_0 = (((control_18B_4h_Fe$avg_nfoci_0 - Mean_Cont_Fe_4h)/Std_Cont_Fe_4h)*Std_ref_Cont_Fe_4h) + Mean_ref_Cont_Fe_4h
control_18B_4h_Ar$avg_nfoci_0 = (((control_18B_4h_Ar$avg_nfoci_0 - Mean_Cont_Ar_4h)/Std_Cont_Ar_4h)*Std_ref_Cont_Ar_4h) + Mean_ref_Cont_Ar_4h
control_18B_4h_Si$avg_nfoci_0 = (((control_18B_4h_Si$avg_nfoci_0 - Mean_Cont_Si_4h)/Std_Cont_Si_4h)*Std_ref_Cont_Si_4h) + Mean_ref_Cont_Si_4h
control_18B_4h_Gamma$avg_nfoci_0 = (((control_18B_4h_Gamma$avg_nfoci_0 - Mean_Cont_Gamma_4h)/Std_Cont_Gamma_4h)*Std_ref_Cont_Gamma_4h) + Mean_ref_Cont_Gamma_4h
# 24h
control_18B_24h_Fe$avg_nfoci_0 = (((control_18B_24h_Fe$avg_nfoci_0 - Mean_Cont_Fe_24h)/Std_Cont_Fe_24h)*Std_ref_Cont_Fe_24h) + Mean_ref_Cont_Fe_24h
control_18B_24h_Ar$avg_nfoci_0 = (((control_18B_24h_Ar$avg_nfoci_0 - Mean_Cont_Ar_24h)/Std_Cont_Ar_24h)*Std_ref_Cont_Ar_24h) + Mean_ref_Cont_Ar_24h
control_18B_24h_Si$avg_nfoci_0 = (((control_18B_24h_Si$avg_nfoci_0 - Mean_Cont_Si_24h)/Std_Cont_Si_24h)*Std_ref_Cont_Si_24h) + Mean_ref_Cont_Si_24h
control_18B_24h_Gamma$avg_nfoci_0 = (((control_18B_24h_Gamma$avg_nfoci_0 - Mean_Cont_Gamma_24h)/Std_Cont_Gamma_24h)*Std_ref_Cont_Gamma_24h) + Mean_ref_Cont_Gamma_24h
##
##
## For Low dose irradiated samples
LD_18B= Samp_18B_10p
...
## z-score correction
# 4h
LD_18B_4h_Fe$avg_nfoci_low_dose = (((LD_18B_4h_Fe$avg_nfoci_low_dose - Mean_LD_Fe_4h)/Std_LD_Fe_4h)*Std_ref_LD_Fe_4h) + Mean_ref_LD_Fe_4h
LD_18B_4h_Ar$avg_nfoci_low_dose = (((LD_18B_4h_Ar$avg_nfoci_low_dose - Mean_LD_Ar_4h)/Std_LD_Ar_4h)*Std_ref_LD_Ar_4h) + Mean_ref_LD_Ar_4h
LD_18B_4h_Si$avg_nfoci_low_dose = (((LD_18B_4h_Si$avg_nfoci_low_dose - Mean_LD_Si_4h)/Std_LD_Si_4h)*Std_ref_LD_Si_4h) + Mean_ref_LD_Si_4h
LD_18B_4h_Gamma$avg_nfoci_low_dose = (((LD_18B_4h_Gamma$avg_nfoci_low_dose - Mean_LD_Gamma_4h)/Std_LD_Gamma_4h)*Std_ref_LD_Gamma_4h) + Mean_ref_LD_Gamma_4h
# 24h
LD_18B_24h_Fe$avg_nfoci_low_dose = (((LD_18B_24h_Fe$avg_nfoci_low_dose - Mean_LD_Fe_24h)/Std_LD_Fe_24h)*Std_ref_LD_Fe_24h) + Mean_ref_LD_Fe_24h
LD_18B_24h_Ar$avg_nfoci_low_dose = (((LD_18B_24h_Ar$avg_nfoci_low_dose - Mean_LD_Ar_24h)/Std_LD_Ar_24h)*Std_ref_LD_Ar_24h) + Mean_ref_LD_Ar_24h
LD_18B_24h_Si$avg_nfoci_low_dose = (((LD_18B_24h_Si$avg_nfoci_low_dose - Mean_LD_Si_24h)/Std_LD_Si_24h)*Std_ref_LD_Si_24h) + Mean_ref_LD_Si_24h
LD_18B_24h_Gamma$avg_nfoci_low_dose = (((LD_18B_24h_Gamma$avg_nfoci_low_dose - Mean_LD_Gamma_24h)/Std_LD_Gamma_24h)*Std_ref_LD_Gamma_24h) + Mean_ref_LD_Gamma_24h
...
## z-score correction
# 4h
HD_18B_4h_Fe$avg_nfoci_high_dose = (((HD_18B_4h_Fe$avg_nfoci_high_dose - Mean_HD_Fe_4h)/Std_HD_Fe_4h)*Std_ref_HD_Fe_4h) + Mean_ref_HD_Fe_4h
HD_18B_4h_Ar$avg_nfoci_high_dose = (((HD_18B_4h_Ar$avg_nfoci_high_dose - Mean_HD_Ar_4h)/Std_HD_Ar_4h)*Std_ref_HD_Ar_4h) + Mean_ref_HD_Ar_4h
HD_18B_4h_Si$avg_nfoci_high_dose = (((HD_18B_4h_Si$avg_nfoci_high_dose - Mean_HD_Si_4h)/Std_HD_Si_4h)*Std_ref_HD_Si_4h) + Mean_ref_HD_Si_4h
HD_18B_4h_Gamma$avg_nfoci_high_dose = (((HD_18B_4h_Gamma$avg_nfoci_high_dose - Mean_HD_Gamma_4h)/Std_HD_Gamma_4h)*Std_ref_HD_Gamma_4h) + Mean_ref_HD_Gamma_4h
# 24h
HD_18B_24h_Fe$avg_nfoci_high_dose = (((HD_18B_24h_Fe$avg_nfoci_high_dose - Mean_HD_Fe_24h)/Std_HD_Fe_24h)*Std_ref_HD_Fe_24h) + Mean_ref_HD_Fe_24h
HD_18B_24h_Ar$avg_nfoci_high_dose = (((HD_18B_24h_Ar$avg_nfoci_high_dose - Mean_HD_Ar_24h)/Std_HD_Ar_24h)*Std_ref_HD_Ar_24h) + Mean_ref_HD_Ar_24h
HD_18B_24h_Si$avg_nfoci_high_dose = (((HD_18B_24h_Si$avg_nfoci_high_dose - Mean_HD_Si_24h)/Std_HD_Si_24h)*Std_ref_HD_Si_24h) + Mean_ref_HD_Si_24h
HD_18B_24h_Gamma$avg_nfoci_high_dose = (((HD_18B_24h_Gamma$avg_nfoci_high_dose - Mean_HD_Gamma_24h)/Std_HD_Gamma_24h)*Std_ref_HD_Gamma_24h) + Mean_ref_HD_Gamma_24h


### Now we regroup everything
## regroup 18B
Cont_18B_All_rad= bind_rows(control_18B_4h_Fe,  control_18B_24h_Fe, 
                            control_18B_4h_Ar,  control_18B_24h_Ar,
                            control_18B_4h_Si,  control_18B_24h_Si,
                            control_18B_4h_Gamma,  control_18B_24h_Gamma)

LD_18B_All_rad= bind_rows(LD_18B_4h_Fe,  LD_18B_24h_Fe, 
                          LD_18B_4h_Ar,  LD_18B_24h_Ar,
                          LD_18B_4h_Si,  LD_18B_24h_Si,
                          LD_18B_4h_Gamma,  LD_18B_24h_Gamma)

HD_18B_All_rad= bind_rows(HD_18B_4h_Fe,  HD_18B_24h_Fe, 
                          HD_18B_4h_Ar,  HD_18B_24h_Ar,
                          HD_18B_4h_Si,  HD_18B_24h_Si,
                          HD_18B_4h_Gamma,  HD_18B_24h_Gamma)
...
Samp_19A_10p_LD = Samp_19A_10p
Samp_19A_10p_LD$avg_nfoci_high_dose = NULL
colnames(Samp_19A_10p_LD)[colnames(Samp_19A_10p_LD)=="avg_nfoci_low_dose"]<- "RIF"
Samp_19A_10p_LD$Dose_relative="Low dose"

Samp_19A_10p_HD = Samp_19A_10p
Samp_19A_10p_HD$avg_nfoci_low_dose = NULL
colnames(Samp_19A_10p_HD)[colnames(Samp_19A_10p_HD)=="avg_nfoci_high_dose"]<- "RIF"
Samp_19A_10p_HD$Dose_relative="High dose"

Samp_19A_10p_control = Samp_19A_10p
Samp_19A_10p_control$avg_nfoci_low_dose = NULL
Samp_19A_10p_control$avg_nfoci_high_dose = NULL
Samp_19A_10p_control$RIF= Samp_19A_10p_control$avg_nfoci_0
Samp_19A_10p_control$Dose_relative="0 Gy control"


Samp_plot_19A_10p= bind_rows(Samp_19A_10p_LD, Samp_19A_10p_HD, Samp_19A_10p_control)

################### regroup 18B and 19A 
All_18B_19A = bind_rows(LD_HD_18B, Samp_plot_19A_10p)
All_18B_19A$RIF_Norm = All_18B_19A$RIF / All_18B_19A$avg_nfoci_0
All_18B_19A$Run_Set_Duplicate = paste(All_18B_19A$Run_set, All_18B_19A$Duplicate, sep = "_Dup_")
...
All_18B_19A$Time_dose=factor(All_18B_19A$Time_dose, levels=c("4h 0 Gy control", "4h Low dose", "4h High dose","24h 0 Gy control",
                                                                 "24h Low dose", "24h High dose"))
...
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Corrected_Rad_zscore_no_norm_10p.pdf", graph_without_Norm, width=25, height=7)

dose_relative=c("Low dose", "High dose")
All_18B_19A = All_18B_19A %>% filter(All_18B_19A$Dose_relative %in% dose_relative)
All_18B_19A$Time_dose=factor(All_18B_19A$Time_dose, levels=c("4h 0 Gy control", "4h Low dose", "4h High dose","24h 0 Gy control",
                                                                 "24h Low dose", "24h High dose"))
All_18B_19A$Radiation_type=factor(All_18B_19A$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))

graph_with_Norm <- ggplot(All_18B_19A, aes(x=Time_dose, y=RIF_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Corrected_Rad_zscore_norm_10p.pdf", graph_with_Norm, width=25, height=7)

```
```{r}
### Do the same for all 18B. 

############################## For controls and irradiated samples 18B we also calculate mean and std to perform the "z-score" normalization

Samp_18B_allp = RIF_correct_19A_18B %>% filter(RIF_correct_19A_18B$Run_set =="Run_18B_Set_2")
Samp_19A_allp = RIF_correct_19A_18B %>% filter(RIF_correct_19A_18B$Run_set =="Run_19A_Set_1")

## For Controls 
Controls_18B= Samp_18B_allp
Controls_18B$avg_nfoci_low_dose=NULL
Controls_18B$avg_nfoci_high_dose=NULL
#
### 4h 
...
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Corrected_Rad_zscore_no_norm_allp.pdf", graph_without_Norm, width=25, height=7)
...
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Corrected_Rad_zscore_norm_allp.pdf", graph_with_Norm, width=25, height=7)


```
```{r}
### Do the them for all 18B but using mean and std calculated for 18B on the 10 people only
...
Subject_18BS2_19AS1 = c(1214, 1215,1216,1217,1218,1219,1220,1221,1222,1223)
Samp_18B_10p = Samp_18B_allp %>% filter(Samp_18B_allp$Sample_ID %in% Subject_18BS2_19AS1 )
...
#
Cont_18B_All_rad$RIF = Cont_18B_All_rad$avg_nfoci_0
Cont_18B_All_rad$Dose_relative = "O Gy control"
...
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Corrected_Rad_zscore_no_norm_allp_mean_std_10p18B_only.pdf", graph_without_Norm, width=25, height=7)
...
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Corrected_Rad_zscore_norm_allp_mean_std_10p18B_only.pdf", graph_with_Norm, width=25, height=7)
