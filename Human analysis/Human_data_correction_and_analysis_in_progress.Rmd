...
gamma_plate_nums_19C = c(637,645,653,661,669,677,639,647,655,663,671,679,638,646,654,662,670,678,640,648,656,664,672,680,633,641,649,657,665,673,635,643,651,659,667,675,634,642,650,658,666,674,636,644,652,660,668,676)
gamma_plate_count_19C = length(gamma_plate_nums_19C)
ar_plate_nums_19C = c(753,757,761,765,769,773,755,759,763,767,771,775,754,758,762,766,770,774,756,760,764,768,772,776)
ar_plate_count_19C = length(ar_plate_nums_19C)
si_plate_nums_19C = c(692,691,690,689,704,703,702,701,688,687,686,685,700,699,698,697,684,683,682,681,696,695,694,693)  
si_plate_count_19C = length(si_plate_nums_19C)
fe_plate_nums_19C = c(729,733,737,741,745,749,731,735,739,743, 747,751,730,734,738,742,746,750,732,736,740,744,748,752)
gamma_si_fe_ar_plate_nums_19C = c(gamma_plate_nums_19C, si_plate_nums_19C, fe_plate_nums_19C, ar_plate_nums_19C)
gamma_si_fe_ar_plate_count_19C = length(gamma_si_fe_ar_plate_nums_19C)

#### Read first file
foci_gamma_first_19C = data.frame(Plate = gamma_plate_nums_19C[1], Plate_well = paste(gamma_plate_nums_19C[1], read.table(paste("BNL19C-ProcessedFiles-Threshold3000/average_well_P", gamma_plate_nums_19C[1],'.txt', sep=""), sep="\t", header = TRUE)$Well, sep = "_"), read.table(paste("BNL19C-ProcessedFiles-Threshold3000/average_well_P", gamma_plate_nums_19C[1],'.txt', sep=""), sep="\t", header = TRUE))

gamma_table_19C=foci_gamma_first_19C

foci_si_first_19C = data.frame(Plate = si_plate_nums_19C[1], Plate_well = paste(si_plate_nums_19C[1], read.table(paste("BNL19C-ProcessedFiles-Threshold3000/average_well_P", si_plate_nums_19C[1],'.txt', sep=""), sep="\t", header = TRUE)$Well, sep = "_"), read.table(paste("BNL19C-ProcessedFiles-Threshold3000/average_well_P", si_plate_nums_19C[1],'.txt', sep=""), sep="\t", header = TRUE))

si_table_19C=foci_si_first_19C

foci_ar_first_19C = data.frame(Plate = ar_plate_nums_19C[1], Plate_well = paste(ar_plate_nums_19C[1], read.table(paste("BNL19C-ProcessedFiles-Threshold3000/average_well_P", ar_plate_nums_19C[1],'.txt', sep=""), sep="\t", header = TRUE)$Well, sep = "_"), read.table(paste("BNL19C-ProcessedFiles-Threshold3000/average_well_P", ar_plate_nums_19C[1],'.txt', sep=""), sep="\t", header = TRUE))

ar_table_19C=foci_ar_first_19C

foci_fe_first_19C = data.frame(Plate = fe_plate_nums_19C[1], Plate_well = paste(fe_plate_nums_19C[1], read.table(paste("BNL19C-ProcessedFiles-Threshold3000/average_well_P", fe_plate_nums_19C[1],'.txt', sep=""), sep="\t", header = TRUE)$Well, sep = "_"), read.table(paste("BNL19C-ProcessedFiles-Threshold3000/average_well_P", fe_plate_nums_19C[1],'.txt', sep=""), sep="\t", header = TRUE))
...
for(ii in 2:gamma_plate_count_19C){
  temp_gamma_filename = paste('BNL19C-ProcessedFiles-Threshold3000/average_well_P', gamma_plate_nums_19C[ii],'.txt', sep="")
  temp_gamma_table = data.frame(Plate = gamma_plate_nums_19C[ii], Plate_well = paste(gamma_plate_nums_19C[ii], read.table(paste('BNL19C-ProcessedFiles-Threshold3000/average_well_P', gamma_plate_nums_19C[ii],'.txt', sep=""), sep="\t", header = TRUE)$Well, sep = "_"), read.table(paste('BNL19C-ProcessedFiles-Threshold3000/average_well_P', gamma_plate_nums_19C[ii],'.txt', sep=""), sep="\t", header = TRUE))
  gamma_table_19C = rbind(gamma_table_19C, temp_gamma_table)
}

for(ii in 2:si_plate_count_19C){
  temp_si_filename = paste('BNL19C-ProcessedFiles-Threshold3000/average_well_P', si_plate_nums_19C[ii],'.txt', sep="")
  temp_si_table = data.frame(Plate = si_plate_nums_19C[ii], Plate_well = paste(si_plate_nums_19C[ii], read.table(paste('BNL19C-ProcessedFiles-Threshold3000/average_well_P', si_plate_nums_19C[ii],'.txt', sep=""), sep="\t", header = TRUE)$Well, sep = "_"), read.table(paste('BNL19C-ProcessedFiles-Threshold3000/average_well_P', si_plate_nums_19C[ii],'.txt', sep=""), sep="\t", header = TRUE))
  si_table_19C = rbind(si_table_19C, temp_si_table)
}

for(ii in 2:ar_plate_count_19C){
  temp_ar_filename = paste('BNL19C-ProcessedFiles-Threshold3000/average_well_P', ar_plate_nums_19C[ii],'.txt', sep="")
  temp_ar_table = data.frame(Plate = ar_plate_nums_19C[ii], Plate_well = paste(ar_plate_nums_19C[ii], read.table(paste('BNL19C-ProcessedFiles-Threshold3000/average_well_P', ar_plate_nums_19C[ii],'.txt', sep=""), sep="\t", header = TRUE)$Well, sep = "_"), read.table(paste('BNL19C-ProcessedFiles-Threshold3000/average_well_P', ar_plate_nums_19C[ii],'.txt', sep=""), sep="\t", header = TRUE))
  ar_table_19C = rbind(ar_table_19C, temp_ar_table)
  }

for(ii in 2:fe_plate_count_19C){
  temp_fe_filename = paste('BNL19C-ProcessedFiles-Threshold3000/average_well_P', fe_plate_nums_19C[ii],'.txt', sep="")
  temp_fe_table = data.frame(Plate = fe_plate_nums_19C[ii], Plate_well = paste(fe_plate_nums_19C[ii], read.table(paste('BNL19C-ProcessedFiles-Threshold3000/average_well_P', fe_plate_nums_19C[ii],'.txt', sep=""), sep="\t", header = TRUE)$Well, sep = "_"), read.table(paste('BNL19C-ProcessedFiles-Threshold3000/average_well_P', fe_plate_nums_19C[ii],'.txt', sep=""), sep="\t", header = TRUE))
  fe_table_19C = rbind(fe_table_19C, temp_fe_table)
  }

#### We combine 18B, 19A and 19C data
ar_table = rbind(ar_table_18B, ar_table_19A, ar_table_19C)
fe_table = rbind(fe_table_18B, fe_table_19A, fe_table_19C)
si_table = rbind(si_table_18B, si_table_19A, si_table_19C)
gamma_table = rbind(gamma_table_19A, gamma_table_19C)
...
gamma_table_w_plate_meta$Run_set[gamma_table_w_plate_meta$Run_set == "Run_19A_Set_3"] <- "Run_18B_Set_1"
gamma_table_w_plate_meta$Run_set[gamma_table_w_plate_meta$Run_set == "Run_19A_Set_4"] <- "Run_18B_Set_2"
...
RIF_Raw_Control = all_RIF_Raw
RIF_Raw_Control$avg_nfoci_high_dose=NULL
RIF_Raw_Control$avg_nfoci_low_dose=NULL
RIF_Raw_Control$avg_foci_no_outl_0=NULL
RIF_Raw_Control$avg_foci_no_outl_high_dose=NULL
RIF_Raw_Control$avg_foci_no_outl_low_dose=NULL
RIF_Raw_Control$Dose_relative= "0 Gy control"
colnames(RIF_Raw_Control)[colnames(RIF_Raw_Control) == "avg_nfoci_0"] <- "RIF"
#
RIF_Raw_LD = all_RIF_Raw
RIF_Raw_LD$avg_nfoci_high_dose=NULL
RIF_Raw_LD$avg_nfoci_0=NULL
RIF_Raw_LD$avg_foci_no_outl_0=NULL
RIF_Raw_LD$avg_foci_no_outl_high_dose=NULL
RIF_Raw_LD$avg_foci_no_outl_low_dose=NULL
RIF_Raw_LD$Dose_relative= "Low dose"
colnames(RIF_Raw_LD)[colnames(RIF_Raw_LD) == "avg_nfoci_low_dose"] <- "RIF"
#
RIF_Raw_HD = all_RIF_Raw
RIF_Raw_HD$avg_nfoci_low_dose=NULL
RIF_Raw_HD$avg_nfoci_0=NULL
RIF_Raw_HD$avg_foci_no_outl_0=NULL
RIF_Raw_HD$avg_foci_no_outl_high_dose=NULL
RIF_Raw_HD$avg_foci_no_outl_low_dose=NULL
RIF_Raw_HD$Dose_relative= "High dose"
colnames(RIF_Raw_HD)[colnames(RIF_Raw_HD) == "avg_nfoci_high_dose"] <- "RIF"
#
RIF_Raw_LD_HD = bind_rows(RIF_Raw_LD, RIF_Raw_HD, RIF_Raw_Control)
RIF_Raw_LD_HD$Timepoint=factor(RIF_Raw_LD_HD$Timepoint, levels=c("4h", "24h"))
RIF_Raw_LD_HD$Radiation_type=factor(RIF_Raw_LD_HD$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
RIF_Raw_LD_HD$Time_dose=paste(RIF_Raw_LD_HD$Timepoint, RIF_Raw_LD_HD$Dose_relative, sep = " ")
RIF_Raw_LD_HD$Time_dose=factor(RIF_Raw_LD_HD$Time_dose, levels=c("4h 0 Gy control", "4h Low dose", "4h High dose","24h 0 Gy control","24h Low dose", "24h High dose"))


#### For 18B and 19A (to be able to check at the end if the second step of the correction was efficient)
Run_18B_19A=c("Run_19A_Set_1", "Run_19A_Set_2", "Run_18B_Set_2", "Run_18B_Set_1", "Run_19A_Set_3","Run_19A_Set_4")
RIF_Raw_LD_HD_Run = RIF_Raw_LD_HD %>% filter(RIF_Raw_LD_HD$Run_set %in% Run_18B_19A)

## Graph RIF vs Timepoint and dose + a panel per Run_set
graph_without_Norm <- ggplot(RIF_Raw_LD_HD_Run, aes(x=Time_dose, y=RIF)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Raw_No_Norm_Run_18B_and_19A.pdf", graph_without_Norm, width=25, height=7)

## Graph RIF vs Run_set for controls only (to check if the first step of the correction works well) color code = radiation and a panel per timepoint
RIF_Raw_LD_HD_Run_Control = RIF_Raw_LD_HD_Run %>% filter(RIF_Raw_LD_HD_Run$Dose_relative == "0 Gy control")
RIF_Raw_LD_HD_Run_Control$Timepoint=factor(RIF_Raw_LD_HD_Run_Control$Timepoint, levels=c("4h", "24h"))
RIF_Raw_LD_HD_Run_Control$Radiation_type=factor(RIF_Raw_LD_HD_Run_Control$Radiation_type, levels=c("Gamma", "Si", "Ar", "Fe"))
Run_rad <- ggplot(RIF_Raw_LD_HD_Run_Control, aes(x=Run_set, y=RIF)) + geom_boxplot(aes(fill=Radiation_type))
Run_rad <- Run_rad + facet_grid(. ~ Timepoint) + theme_gray() + ylim(0,7)
ggsave("Raw_No_Norm_RIF_per_Run_Set_18B_19A.pdf", Run_rad, width=25, height=7)

#### For the 10p that overlap only 
Subject_18BS2_19AS1 = c(1214, 1215,1216,1217,1218,1219,1220,1221,1222,1223)
RIF_Raw_LD_HD_10p = RIF_Raw_LD_HD %>% filter(RIF_Raw_LD_HD$Sample_ID %in% Subject_18BS2_19AS1)
# #
RIF_Raw_LD_HD_10p$Timepoint=factor(RIF_Raw_LD_HD_10p$Timepoint, levels=c("4h", "24h"))
RIF_Raw_LD_HD_10p$Radiation_type=factor(RIF_Raw_LD_HD_10p$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
RIF_Raw_LD_HD_10p$Time_dose=paste(RIF_Raw_LD_HD_10p$Timepoint, RIF_Raw_LD_HD_10p$Dose_relative, sep = " ")
RIF_Raw_LD_HD_10p$Time_dose=factor(RIF_Raw_LD_HD_10p$Time_dose, levels=c("4h 0 Gy control", "4h Low dose", "4h High dose","24h 0 Gy control","24h Low dose", "24h High dose"))

graph_without_Norm <- ggplot(RIF_Raw_LD_HD_10p, aes(x=Time_dose, y=RIF)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Raw_RIF_No_Norm_10p_18B_19A.pdf", graph_without_Norm, width=25, height=7)


#### For 19C and 19A (to be able to check at the end if the second step of the correction was efficient)
Run_19C_19A=c("Run_19A_Set_1", "Run_19A_Set_2", "Run_19C_Set_2", "Run_19C_Set_1", "Run_19A_Set_3","Run_19A_Set_4")
RIF_Raw_LD_HD_Run = RIF_Raw_LD_HD %>% filter(RIF_Raw_LD_HD$Run_set %in% Run_19C_19A)

## Graph RIF vs Timepoint and dose + a panel per Run_set
graph_without_Norm <- ggplot(RIF_Raw_LD_HD_Run, aes(x=Time_dose, y=RIF)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Raw_No_Norm_Run_19C_and_19A.pdf", graph_without_Norm, width=25, height=7)
...
Run_rad <- ggplot(RIF_Raw_LD_HD_Run_Control, aes(x=Run_set, y=RIF)) + geom_boxplot(aes(fill=Radiation_type))
Run_rad <- Run_rad + facet_grid(. ~ Timepoint) + theme_gray() + ylim(0,7)
ggsave("Raw_No_Norm_RIF_per_Run_Set_19C_19A.pdf", Run_rad, width=25, height=7)

#### For the 10p that overlap only 
Subject_19CS1_19AS1 =  c(1589,1590,1591,1592,1593,1594,1595,1596,1597)
RIF_Raw_LD_HD_10p = RIF_Raw_LD_HD %>% filter(RIF_Raw_LD_HD$Sample_ID %in% Subject_19CS1_19AS1)
# #
RIF_Raw_LD_HD_10p$Timepoint=factor(RIF_Raw_LD_HD_10p$Timepoint, levels=c("4h", "24h"))
RIF_Raw_LD_HD_10p$Radiation_type=factor(RIF_Raw_LD_HD_10p$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
RIF_Raw_LD_HD_10p$Time_dose=paste(RIF_Raw_LD_HD_10p$Timepoint, RIF_Raw_LD_HD_10p$Dose_relative, sep = " ")
...
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Raw_RIF_No_Norm_10p_19C_19A.pdf", graph_without_Norm, width=25, height=7)

## With Normalization
RIF_Raw_Norm = all_RIF_Raw
RIF_Raw_Norm$RIF_Norm_low_dose=RIF_Raw_Norm$avg_nfoci_low_dose / RIF_Raw_Norm$avg_nfoci_0
RIF_Raw_Norm$RIF_Norm_high_dose=RIF_Raw_Norm$avg_nfoci_high_dose / RIF_Raw_Norm$avg_nfoci_0
#
# 
RIF_Raw_Norm_LD= RIF_Raw_Norm 
RIF_Raw_Norm_LD$RIF_Norm_high_dose=NULL
RIF_Raw_Norm_LD$avg_nfoci_high_dose=NULL
RIF_Raw_Norm_LD$avg_foci_no_outl_high_dose=NULL
RIF_Raw_Norm_LD$avg_nfoci_low_dose=NULL
RIF_Raw_Norm_LD$avg_foci_no_outl_low_dose=NULL
RIF_Raw_Norm_LD$avg_nfoci_0=NULL
RIF_Raw_Norm_LD$avg_foci_no_outl_0=NULL
RIF_Raw_Norm_LD$Dose_relative= "Low dose"
colnames(RIF_Raw_Norm_LD)[colnames(RIF_Raw_Norm_LD) == "RIF_Norm_low_dose"] <- "RIF_Norm"
#
RIF_Raw_Norm_HD= RIF_Raw_Norm 
RIF_Raw_Norm_HD$RIF_Norm_low_dose=NULL
RIF_Raw_Norm_HD$avg_nfoci_high_dose=NULL
RIF_Raw_Norm_HD$avg_foci_no_outl_high_dose=NULL
RIF_Raw_Norm_HD$avg_nfoci_low_dose=NULL
RIF_Raw_Norm_HD$avg_foci_no_outl_low_dose=NULL
RIF_Raw_Norm_HD$avg_nfoci_0=NULL
RIF_Raw_Norm_HD$avg_foci_no_outl_0=NULL
RIF_Raw_Norm_HD$Dose_relative= "High dose"
colnames(RIF_Raw_Norm_HD)[colnames(RIF_Raw_Norm_HD) == "RIF_Norm_high_dose"] <- "RIF_Norm"
#
RIF_Raw_LD_HD_Norm = bind_rows(RIF_Raw_Norm_LD, RIF_Raw_Norm_HD)
RIF_Raw_LD_HD_Norm$Point = paste(RIF_Raw_LD_HD_Norm$Radiation_type, RIF_Raw_LD_HD_Norm$Timepoint, sep = '_')
RIF_Raw_LD_HD_Norm$Timepoint=factor(RIF_Raw_LD_HD_Norm$Timepoint, levels=c("4h", "24h"))
RIF_Raw_LD_HD_Norm$Radiation_type=factor(RIF_Raw_LD_HD_Norm$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
RIF_Raw_LD_HD_Norm$Rad_dose=paste(RIF_Raw_LD_HD_Norm$Radiation_type, RIF_Raw_LD_HD_Norm$Dose_relative, sep = " ")
RIF_Raw_LD_HD_Norm$Time_dose=paste(RIF_Raw_LD_HD_Norm$Timepoint, RIF_Raw_LD_HD_Norm$Dose_relative, sep = " ")
RIF_Raw_LD_HD_Norm$Time_dose=factor(RIF_Raw_LD_HD_Norm$Time_dose, levels=c("4h Low dose", "4h High dose",
                                                                 "24h Low dose", "24h High dose"))

#### For 18B and 19A (to be able to check at the end if the second step of the correction was efficient)
Run_18B_19A=c("Run_19A_Set_1", "Run_19A_Set_2", "Run_18B_Set_2", "Run_18B_Set_1", "Run_19A_Set_3","Run_19A_Set_4")
RIF_Raw_LD_HD_Norm_Run = RIF_Raw_LD_HD_Norm %>% filter(RIF_Raw_LD_HD_Norm$Run_set %in% Run_18B_19A)

graph_with_Norm <- ggplot(RIF_Raw_LD_HD_Norm_Run, aes(x=Time_dose, y=RIF_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Raw_Norm_Run_18B_and_19A.pdf", graph_with_Norm, width=25, height=7)


#### For 19C and 19A (to be able to check at the end if the second step of the correction was efficient)
Run_19C_19A=c("Run_19A_Set_1", "Run_19A_Set_2", "Run_19C_Set_2", "Run_19C_Set_1", "Run_19A_Set_3","Run_19A_Set_4")
RIF_Raw_LD_HD_Norm_Run = RIF_Raw_LD_HD_Norm %>% filter(RIF_Raw_LD_HD_Norm$Run_set %in% Run_19C_19A)

graph_with_Norm <- ggplot(RIF_Raw_LD_HD_Norm_Run, aes(x=Time_dose, y=RIF_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Raw_Norm_Run_19C_and_19A.pdf", graph_with_Norm, width=25, height=7)
...
## When all 18B, 19A and 19C plates will be considered we will have 8 different Run/Set values (cf. file Run_set_batch and Run_19C_Set_3 and Run_19C_Set_4 are considered as Run_18B_Set_1 and Run_18B_Set_2  respectively) 
...
Run_set_7 = Raw_pc %>% filter(Raw_pc$Run_set_batch == 7)
Run_set_8 = Raw_pc %>% filter(Raw_pc$Run_set_batch == 8)
...
metadata$BMI_group=NULL
edata_control=Run_set_7[,grep("avg_nfoci_0|avg_foci_no_outl_0",colnames(Run_set_7))]
edata_control=t(edata_control)
modcombat = model.matrix(~1, data= metadata) 
...
metadata$BMI_group=NULL
edata_control=Run_set_8[,grep("avg_nfoci_0|avg_foci_no_outl_0",colnames(Run_set_8))]
edata_control=t(edata_control)
modcombat = model.matrix(~1, data= metadata) 
...
metadata$BMI_group=NULL
edata_Irradiated=Irradiated_Responses_Run_set_7[,grep("avg_nfoci|avg_foci_no_outl",colnames(Irradiated_Responses_Run_set_7))]
edata_Irradiated=t(edata_Irradiated)
modcombat = model.matrix(~1, data= metadata) 
...
metadata$BMI_group=NULL
edata_Irradiated=Irradiated_Responses_Run_set_8[,grep("avg_nfoci|avg_foci_no_outl",colnames(Irradiated_Responses_Run_set_8))]
edata_Irradiated=t(edata_Irradiated)
modcombat = model.matrix(~1, data= metadata) 
...
## add columns with data normalized (used only for the graphs below, these 2 columns are then removed)
Corrected_DNA_Damage$nfoci_high_dose_norm = Corrected_DNA_Damage$avg_nfoci_high_dose / Corrected_DNA_Damage$avg_nfoci_0
Corrected_DNA_Damage$nfoci_low_dose_norm = Corrected_DNA_Damage$avg_nfoci_low_dose / Corrected_DNA_Damage$avg_nfoci_0

##################################################################################################
############################### Graphs after correction: step 1 ##################################
##################################################################################################

## Without normalization
# control
RIF_Correct1_Control = Corrected_DNA_Damage[,grepl("avg_nfoci_0|Sample|Run_set|Duplicate|Timepoint|Radiation_type|Age|Gender|BMI",colnames(Corrected_DNA_Damage))]
RIF_Correct1_Control$Dose_relative= "0 Gy control"
colnames(RIF_Correct1_Control)[colnames(RIF_Correct1_Control) == "avg_nfoci_0"] <- "RIF"
# Low dose
RIF_Correct1_LD = Corrected_DNA_Damage[,grepl("avg_nfoci_low|Sample|Run_set|Duplicate|Timepoint|Radiation_type|Age|Gender|BMI",colnames(Corrected_DNA_Damage))]
RIF_Correct1_LD$Dose_relative= "Low dose"
colnames(RIF_Correct1_LD)[colnames(RIF_Correct1_LD) == "avg_nfoci_low_dose"] <- "RIF"
# High dose
RIF_Correct1_HD = Corrected_DNA_Damage[,grepl("avg_nfoci_high|Sample|Run_set|Duplicate|Timepoint|Radiation_type|Age|Gender|BMI",colnames(Corrected_DNA_Damage))]
RIF_Correct1_HD$Dose_relative= "High dose"
colnames(RIF_Correct1_HD)[colnames(RIF_Correct1_HD) == "avg_nfoci_high_dose"] <- "RIF"
## regroup no normalization
RIF_Correct1_LD_HD = bind_rows(RIF_Correct1_LD, RIF_Correct1_HD, RIF_Correct1_Control)
RIF_Correct1_LD_HD$Radiation_type=factor(RIF_Correct1_LD_HD$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
RIF_Correct1_LD_HD$Time_dose=paste(RIF_Correct1_LD_HD$Timepoint, RIF_Correct1_LD_HD$Dose_relative, sep = " ")
RIF_Correct1_LD_HD$Time_dose=factor(RIF_Correct1_LD_HD$Time_dose, levels=c("4h 0 Gy control", "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))

#### For Run 18B and 19A 
Run_18B_19A=c("Run_19A_Set_1", "Run_19A_Set_2", "Run_18B_Set_2", "Run_18B_Set_1", "Run_19A_Set_3", "Run_19A_Set_4")
RIF_Correct1_LD_HD_Run = RIF_Correct1_LD_HD %>% filter(RIF_Correct1_LD_HD$Run_set %in% Run_18B_19A)
## Graph RIF vs Time point/dose + a panel per Radiation 
graph_without_Norm <- ggplot(RIF_Correct1_LD_HD_Run, aes(x=Time_dose, y=RIF)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Correction_step1_No_Norm_Run_18B_19A.pdf", graph_without_Norm, width=25, height=7)
#
## Graph RIF vs Run_Set, color code radiation + a panel per time point
RIF_Correct1_LD_HD_Run_Control = RIF_Correct1_LD_HD_Run %>% filter(RIF_Correct1_LD_HD_Run$Dose_relative == "0 Gy control")
RIF_Correct1_LD_HD_Run_Control$RIF_Correct1_LD_HD_Run_Control=factor(RIF_Correct1_LD_HD_Run_Control$RIF_Correct1_LD_HD_Run_Control, levels=c("4h", "24h"))
RIF_Correct1_LD_HD_Run_Control$Radiation_type=factor(RIF_Correct1_LD_HD_Run_Control$Radiation_type, levels=c("Gamma","Si", "Ar", "Fe"))
Run_rad <- ggplot(RIF_Correct1_LD_HD_Run_Control, aes(x=Run_set, y=RIF)) + geom_boxplot(aes(fill=Radiation_type))
Run_rad <- Run_rad + facet_grid(. ~ Timepoint) + theme_gray() + ylim(0,7)
ggsave("Correction_step1_No_Norm_RIF_per_Run_Set_18B_19A.pdf", Run_rad, width=25, height=7)

### 10p that overlap
RIF_Correct1_LD_HD_Run_10p = RIF_Correct1_LD_HD_Run %>% filter(RIF_Correct1_LD_HD_Run$Sample_ID %in% Subject_18BS2_19AS1)
RIF_Correct1_LD_HD_Run_10p$Radiation_type=factor(RIF_Correct1_LD_HD_Run_10p$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
RIF_Correct1_LD_HD_Run_10p$Time_dose=paste(RIF_Correct1_LD_HD_Run_10p$Timepoint, RIF_Correct1_LD_HD_Run_10p$Dose_relative, sep = " ")
RIF_Correct1_LD_HD_Run_10p$Time_dose=factor(RIF_Correct1_LD_HD_Run_10p$Time_dose, levels=c("4h 0 Gy control", "4h Low dose", "4h High dose","24h 0 Gy control","24h Low dose", "24h High dose"))
#
graph_without_Norm <- ggplot(RIF_Correct1_LD_HD_Run_10p, aes(x=Time_dose, y=RIF)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Correction_1_No_Norm_10p_18B_19A.pdf", graph_without_Norm, width=25, height=7)


#### For Run 19C and 19A 
Run_19C_19A=c("Run_19A_Set_1", "Run_19A_Set_2", "Run_19C_Set_2", "Run_19C_Set_1", "Run_19A_Set_3", "Run_19A_Set_4")
RIF_Correct1_LD_HD_Run = RIF_Correct1_LD_HD %>% filter(RIF_Correct1_LD_HD$Run_set %in% Run_19C_19A)
## Graph RIF vs Time point/dose + a panel per Radiation 
graph_without_Norm <- ggplot(RIF_Correct1_LD_HD_Run, aes(x=Time_dose, y=RIF)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Correction_step1_No_Norm_Run_19C_19A.pdf", graph_without_Norm, width=25, height=7)
#
## Graph RIF vs Run_Set, color code radiation + a panel per time point
RIF_Correct1_LD_HD_Run_Control = RIF_Correct1_LD_HD_Run %>% filter(RIF_Correct1_LD_HD_Run$Dose_relative == "0 Gy control")
RIF_Correct1_LD_HD_Run_Control$Timepoint=factor(RIF_Correct1_LD_HD_Run_Control$Timepoint, levels=c("4h", "24h"))
RIF_Correct1_LD_HD_Run_Control$Radiation_type=factor(RIF_Correct1_LD_HD_Run_Control$Radiation_type, levels=c("Gamma","Si", "Ar", "Fe"))
Run_rad <- ggplot(RIF_Correct1_LD_HD_Run_Control, aes(x=Run_set, y=RIF)) + geom_boxplot(aes(fill=Radiation_type))
Run_rad <- Run_rad + facet_grid(. ~ Timepoint) + theme_gray() + ylim(0,7)
ggsave("Correction_step1_No_Norm_RIF_per_Run_Set_19C_19A.pdf", Run_rad, width=25, height=7)

### 10p that overlap
RIF_Correct1_LD_HD_Run_10p = RIF_Correct1_LD_HD_Run %>% filter(RIF_Correct1_LD_HD_Run$Sample_ID %in% Subject_19CS1_19AS1)
RIF_Correct1_LD_HD_Run_10p$Radiation_type=factor(RIF_Correct1_LD_HD_Run_10p$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
RIF_Correct1_LD_HD_Run_10p$Time_dose=paste(RIF_Correct1_LD_HD_Run_10p$Timepoint, RIF_Correct1_LD_HD_Run_10p$Dose_relative, sep = " ")
RIF_Correct1_LD_HD_Run_10p$Time_dose=factor(RIF_Correct1_LD_HD_Run_10p$Time_dose, levels=c("4h 0 Gy control", "4h Low dose", "4h High dose","24h 0 Gy control","24h Low dose", "24h High dose"))
#
...
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Correction_1_No_Norm_10p_19C_19A.pdf", graph_without_Norm, width=25, height=7)



## With normalization
# Low dose
RIF_Correct1_LD_Norm = Corrected_DNA_Damage[,grepl("low_dose_norm|Sample|Run_set|Duplicate|Timepoint|Radiation_type|Age|Gender|BMI",colnames(Corrected_DNA_Damage))]
RIF_Correct1_LD_Norm$Dose_relative= "Low dose"
colnames(RIF_Correct1_LD_Norm)[colnames(RIF_Correct1_LD_Norm) == "nfoci_low_dose_norm"] <- "RIF_Norm"
# High dose
RIF_Correct1_HD_Norm = Corrected_DNA_Damage[,grepl("high_dose_norm|Run_set|Sample|Duplicate|Timepoint|Radiation_type|Age|Gender|BMI",colnames(Corrected_DNA_Damage))]
RIF_Correct1_HD_Norm$Dose_relative= "High dose"
colnames(RIF_Correct1_HD_Norm)[colnames(RIF_Correct1_HD_Norm) == "nfoci_high_dose_norm"] <- "RIF_Norm"
## regroup no normalization
RIF_Correct1_LD_HD_Norm = bind_rows(RIF_Correct1_LD_Norm, RIF_Correct1_HD_Norm)
RIF_Correct1_LD_HD_Norm$Radiation_type=factor(RIF_Correct1_LD_HD_Norm$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
RIF_Correct1_LD_HD_Norm$Time_dose=paste(RIF_Correct1_LD_HD_Norm$Timepoint, RIF_Correct1_LD_HD_Norm$Dose_relative, sep = " ")
RIF_Correct1_LD_HD_Norm$Time_dose=factor(RIF_Correct1_LD_HD_Norm$Time_dose, levels=c("4h 0 Gy control", "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))

#### For Run 18B and 19A 
Run_18B_19A=c("Run_19A_Set_1", "Run_19A_Set_2", "Run_18B_Set_2", "Run_18B_Set_1", "Run_19A_Set_3", "Run_19A_Set_4")
RIF_Correct1_LD_HD_Run_Norm = RIF_Correct1_LD_HD_Norm %>% filter(RIF_Correct1_LD_HD_Norm$Run_set %in% Run_18B_19A)
## Graph all subjects
graph_with_Norm <- ggplot(RIF_Correct1_LD_HD_Run_Norm, aes(x=Time_dose, y=RIF_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Correction_step1_Norm_Run_19C_19A.pdf", graph_with_Norm, width=25, height=7)
#
#### For Run 19C and 19A 
Run_19C_19A=c("Run_19A_Set_1", "Run_19A_Set_2", "Run_19C_Set_2", "Run_19C_Set_1", "Run_19A_Set_3", "Run_19A_Set_4")
RIF_Correct1_LD_HD_Run_Norm = RIF_Correct1_LD_HD_Norm %>% filter(RIF_Correct1_LD_HD_Norm$Run_set %in% Run_19C_19A)
## Graph all subjects
graph_with_Norm <- ggplot(RIF_Correct1_LD_HD_Run_Norm, aes(x=Time_dose, y=RIF_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
...
Corrected_DNA_Damage$nfoci_high_dose_norm = NULL
Corrected_DNA_Damage$nfoci_low_dose_norm = NULL


##################################################################################################
################################## Correction step 2: z-score ####################################
##################################################################################################

# 19A will be used as the z-score of "reference" since we have 10 people that overlap with 18B and 19A as well as 10 people that overlap in 19C and 19A. 
# Besides all z-score used for the normalization (18B, 19A and 19C) will be calculated based on either the 10 people that overlap in 18B and 19A or the 10 people that overlap in 19C and 19A. 

############ First for z-score for 19A and 18B 
#
...
## Now we apply the "z-score correction" on all subjects from 18B 
#
#
...
## z-score correction
# 4h
control_allp_18B_4h_Fe$avg_nfoci_0 = ((((control_allp_18B_4h_Fe$avg_nfoci_0 - Mean_ref_18B_Cont_Fe_4h)/Std_ref_18B_Cont_Fe_4h)*Std_ref_19A_Cont_Fe_4h) + Mean_ref_19A_Cont_Fe_4h)

control_allp_18B_4h_Ar$avg_nfoci_0 = ((((control_allp_18B_4h_Ar$avg_nfoci_0 - Mean_ref_18B_Cont_Ar_4h)/Std_ref_18B_Cont_Ar_4h)*Std_ref_19A_Cont_Ar_4h) + Mean_ref_19A_Cont_Ar_4h) 

control_allp_18B_4h_Si$avg_nfoci_0 = ((((control_allp_18B_4h_Si$avg_nfoci_0 - Mean_ref_18B_Cont_Si_4h)/Std_ref_18B_Cont_Si_4h)*Std_ref_19A_Cont_Si_4h) + Mean_ref_19A_Cont_Si_4h)
                                          
control_allp_18B_4h_Gamma$avg_nfoci_0 = ((((control_allp_18B_4h_Gamma$avg_nfoci_0 - Mean_ref_18B_Cont_Gamma_4h)/Std_ref_18B_Cont_Gamma_4h)*Std_ref_19A_Cont_Gamma_4h) + Mean_ref_19A_Cont_Gamma_4h)

# 24h
control_allp_18B_24h_Fe$avg_nfoci_0 = ((((control_allp_18B_24h_Fe$avg_nfoci_0 - Mean_ref_18B_Cont_Fe_24h)/Std_ref_18B_Cont_Fe_24h)*Std_ref_19A_Cont_Fe_24h) + Mean_ref_19A_Cont_Fe_24h)
                                          
control_allp_18B_24h_Ar$avg_nfoci_0 = ((((control_allp_18B_24h_Ar$avg_nfoci_0 - Mean_ref_18B_Cont_Ar_24h)/Std_ref_18B_Cont_Ar_24h)*Std_ref_19A_Cont_Ar_24h) + Mean_ref_19A_Cont_Ar_24h) 

control_allp_18B_24h_Si$avg_nfoci_0 = ((((control_allp_18B_24h_Si$avg_nfoci_0 - Mean_ref_18B_Cont_Si_24h)/Std_ref_18B_Cont_Si_24h)*Std_ref_19A_Cont_Si_24h) + Mean_ref_19A_Cont_Si_24h)
                                          
control_allp_18B_24h_Gamma$avg_nfoci_0 = ((((control_allp_18B_24h_Gamma$avg_nfoci_0 - Mean_ref_18B_Cont_Gamma_24h)/Std_ref_18B_Cont_Gamma_24h)*Std_ref_19A_Cont_Gamma_24h) + Mean_ref_19A_Cont_Gamma_24h)
#
#
## For Low dose irradiated samples
...
## z-score correction
# 4h
LD_allp_18B_4h_Fe$avg_nfoci_low_dose = ((((LD_allp_18B_4h_Fe$avg_nfoci_low_dose -Mean_ref_18B_LD_Fe_4h)/Std_ref_18B_LD_Fe_4h)*Std_ref_19A_LD_Fe_4h) + Mean_ref_19A_LD_Fe_4h)

LD_allp_18B_4h_Ar$avg_nfoci_low_dose = ((((LD_allp_18B_4h_Ar$avg_nfoci_low_dose -Mean_ref_18B_LD_Ar_4h)/Std_ref_18B_LD_Ar_4h)*Std_ref_19A_LD_Ar_4h) + Mean_ref_19A_LD_Ar_4h)

LD_allp_18B_4h_Si$avg_nfoci_low_dose = ((((LD_allp_18B_4h_Si$avg_nfoci_low_dose -Mean_ref_18B_LD_Si_4h)/Std_ref_18B_LD_Si_4h)*Std_ref_19A_LD_Si_4h) + Mean_ref_19A_LD_Si_4h)
                                            
LD_allp_18B_4h_Gamma$avg_nfoci_low_dose = ((((LD_allp_18B_4h_Gamma$avg_nfoci_low_dose -Mean_ref_18B_LD_Gamma_4h)/Std_ref_18B_LD_Gamma_4h)*Std_ref_19A_LD_Gamma_4h) + Mean_ref_19A_LD_Gamma_4h)
#
# 24h
LD_allp_18B_24h_Fe$avg_nfoci_low_dose = ((((LD_allp_18B_24h_Fe$avg_nfoci_low_dose -Mean_ref_18B_LD_Fe_24h)/Std_ref_18B_LD_Fe_24h)*Std_ref_19A_LD_Fe_24h) + Mean_ref_19A_LD_Fe_24h)

LD_allp_18B_24h_Ar$avg_nfoci_low_dose = ((((LD_allp_18B_24h_Ar$avg_nfoci_low_dose -Mean_ref_18B_LD_Ar_24h)/Std_ref_18B_LD_Ar_24h)*Std_ref_19A_LD_Ar_24h) + Mean_ref_19A_LD_Ar_24h)

LD_allp_18B_24h_Si$avg_nfoci_low_dose = ((((LD_allp_18B_24h_Si$avg_nfoci_low_dose -Mean_ref_18B_LD_Si_24h)/Std_ref_18B_LD_Si_24h)*Std_ref_19A_LD_Si_24h) + Mean_ref_19A_LD_Si_24h)
                                            
LD_allp_18B_24h_Gamma$avg_nfoci_low_dose = ((((LD_allp_18B_24h_Gamma$avg_nfoci_low_dose -Mean_ref_18B_LD_Gamma_24h)/Std_ref_18B_LD_Gamma_24h)*Std_ref_19A_LD_Gamma_24h) + Mean_ref_19A_LD_Gamma_24h)
#
## For high dose irradiated samples
...
## z-score correction
# 4h
HD_allp_18B_4h_Fe$avg_nfoci_high_dose= ((((HD_allp_18B_4h_Fe$avg_nfoci_high_dose -Mean_ref_18B_HD_Fe_4h)/Std_ref_18B_HD_Fe_4h)*Std_ref_19A_HD_Fe_4h) + Mean_ref_19A_HD_Fe_4h)

HD_allp_18B_4h_Ar$avg_nfoci_high_dose= ((((HD_allp_18B_4h_Ar$avg_nfoci_high_dose -Mean_ref_18B_HD_Ar_4h)/Std_ref_18B_HD_Ar_4h)*Std_ref_19A_HD_Ar_4h) + Mean_ref_19A_HD_Ar_4h)

HD_allp_18B_4h_Si$avg_nfoci_high_dose= ((((HD_allp_18B_4h_Si$avg_nfoci_high_dose -Mean_ref_18B_HD_Si_4h)/Std_ref_18B_HD_Si_4h)*Std_ref_19A_HD_Si_4h) + Mean_ref_19A_HD_Si_4h)

HD_allp_18B_4h_Gamma$avg_nfoci_high_dose= ((((HD_allp_18B_4h_Gamma$avg_nfoci_high_dose -Mean_ref_18B_HD_Gamma_4h)/Std_ref_18B_HD_Gamma_4h)*Std_ref_19A_HD_Gamma_4h) + Mean_ref_19A_HD_Gamma_4h)
#
# 24h
HD_allp_18B_24h_Fe$avg_nfoci_high_dose= ((((HD_allp_18B_24h_Fe$avg_nfoci_high_dose -Mean_ref_18B_HD_Fe_24h)/Std_ref_18B_HD_Fe_24h)*Std_ref_19A_HD_Fe_24h) + Mean_ref_19A_HD_Fe_24h)

HD_allp_18B_24h_Ar$avg_nfoci_high_dose= ((((HD_allp_18B_24h_Ar$avg_nfoci_high_dose -Mean_ref_18B_HD_Ar_24h)/Std_ref_18B_HD_Ar_24h)*Std_ref_19A_HD_Ar_24h) + Mean_ref_19A_HD_Ar_24h)

HD_allp_18B_24h_Si$avg_nfoci_high_dose= ((((HD_allp_18B_24h_Si$avg_nfoci_high_dose -Mean_ref_18B_HD_Si_24h)/Std_ref_18B_HD_Si_24h)*Std_ref_19A_HD_Si_24h) + Mean_ref_19A_HD_Si_24h)

HD_allp_18B_24h_Gamma$avg_nfoci_high_dose= ((((HD_allp_18B_24h_Gamma$avg_nfoci_high_dose -Mean_ref_18B_HD_Gamma_24h)/Std_ref_18B_HD_Gamma_24h) *Std_ref_19A_HD_Gamma_24h) + Mean_ref_19A_HD_Gamma_24h)
#
...
All_18B_19A$RIF_Norm = All_18B_19A$RIF / All_18B_19A$avg_nfoci_0
All_18B_19A$Timepoint=factor(All_18B_19A$Timepoint, levels=c("4h", "24h"))
All_18B_19A$Time_dose=paste(All_18B_19A$Timepoint, All_18B_19A$Dose_relative, sep = " ")
All_18B_19A$Time_dose=factor(All_18B_19A$Time_dose, levels=c("4h 0 Gy control",  "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))
All_18B_19A$Radiation_type=factor(All_18B_19A$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))

## Graph RIF vs Run_Set, color code radiation + a panel per time point without normalization
graph_without_Norm <- ggplot(All_18B_19A, aes(x=Time_dose, y=RIF)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Correction_step2_No_Norm_RIF_per_Run_Set_18B_19A.pdf", graph_without_Norm, width=25, height=7)
#
## Graph RIF vs Run_Set, color code radiation + a panel per time point with normalization
dose_relative= c("Low dose", "High dose")
All_18B_19A_Norm = All_18B_19A %>% filter(All_18B_19A$Dose_relative %in% dose_relative)
All_18B_19A_Norm$Time_dose=factor(All_18B_19A_Norm$Time_dose, levels=c("4h 0 Gy control",  "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))
All_18B_19A_Norm$Radiation_type=factor(All_18B_19A_Norm$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
graph_with_Norm <- ggplot(All_18B_19A_Norm, aes(x=Time_dose, y=RIF_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Correction_step2_Norm_RIF_per_Run_Set_18B_19A.pdf", graph_with_Norm, width=25, height=7)

########## Now we plot the same two latest plots but for the 10 subjects that overlap in 18B and 19A just to check the correction worked well 
All_18B_19A_10p = All_18B_19A %>% filter(All_18B_19A$Sample_ID %in% Subject_18BS2_19AS1)
All_18B_19A_10p$Time_dose=factor(All_18B_19A_10p$Time_dose, levels=c("4h 0 Gy control",  "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))
All_18B_19A_10p$Radiation_type=factor(All_18B_19A_10p$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
# without normalization
graph_without_Norm <- ggplot(All_18B_19A_10p, aes(x=Time_dose, y=RIF)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Correction_step2_No_Norm_RIF_per_Run_Set_18B_19A_10p_overlap.pdf", graph_without_Norm, width=25, height=7)
#
# with normalization
dose_relative= c("Low dose", "High dose")
All_18B_19A_Norm_10p = All_18B_19A_10p %>% filter(All_18B_19A_10p$Dose_relative %in% dose_relative)
All_18B_19A_Norm_10p$Time_dose=factor(All_18B_19A_Norm_10p$Time_dose, levels=c("4h 0 Gy control",  "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))
All_18B_19A_Norm_10p$Radiation_type=factor(All_18B_19A_Norm_10p$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
graph_with_Norm <- ggplot(All_18B_19A_Norm_10p, aes(x=Time_dose, y=RIF_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Correction_step2_Norm_RIF_per_Run_Set_18B_19A_10p_overlap.pdf", graph_with_Norm, width=25, height=7)


############ Now we do exaclty the same but for 19A and 19C
# Select the 10 people that overlap in these two run
Subject_19CS1_19AS1 = c(1589,1590,1591,1592,1593,1594,1595,1596,1597)
RIF_correct_19A_19C_10p = Corrected_DNA_Damage %>% filter(Corrected_DNA_Damage$Sample_ID %in% Subject_19CS1_19AS1 )
#
#### Z-score for 19A
Samp_19A_10p = RIF_correct_19A_19C_10p %>% filter(RIF_correct_19A_19C_10p$Run_set =="Run_19A_Set_1")
## For Controls 
Controls_19A= Samp_19A_10p
Controls_19A$avg_nfoci_low_dose=NULL
Controls_19A$avg_nfoci_high_dose=NULL
...
#### Z-score for 19C
Samp_19C_10p = RIF_correct_19A_19C_10p %>% filter(RIF_correct_19A_19C_10p$Run_set =="Run_19C_Set_2")

## For Controls 
Controls_19C= Samp_19C_10p
Controls_19C$avg_nfoci_low_dose=NULL
Controls_19C$avg_nfoci_high_dose=NULL
Controls_19C$nfoci_high_dose_norm=NULL 
Controls_19C$nfoci_low_dose_norm=NULL 
#
### 4h 
...
####### Mean
# 4h
Mean_ref_19C_Cont_Fe_4h = mean(NaRV.omit(control_19C_4h_Fe$avg_nfoci_0))
Mean_ref_19C_Cont_Ar_4h = mean(NaRV.omit(control_19C_4h_Ar$avg_nfoci_0))
Mean_ref_19C_Cont_Si_4h = mean(NaRV.omit(control_19C_4h_Si$avg_nfoci_0))
Mean_ref_19C_Cont_Gamma_4h = mean(NaRV.omit(control_19C_4h_Gamma$avg_nfoci_0))
# 24h
Mean_ref_19C_Cont_Fe_24h = mean(NaRV.omit(control_19C_24h_Fe$avg_nfoci_0))
Mean_ref_19C_Cont_Ar_24h = mean(NaRV.omit(control_19C_24h_Ar$avg_nfoci_0))
Mean_ref_19C_Cont_Si_24h = mean(NaRV.omit(control_19C_24h_Si$avg_nfoci_0))
Mean_ref_19C_Cont_Gamma_24h = mean(NaRV.omit(control_19C_24h_Gamma$avg_nfoci_0))
####### sd
# 4h
Std_ref_19C_Cont_Fe_4h = sd(NaRV.omit(control_19C_4h_Fe$avg_nfoci_0))
Std_ref_19C_Cont_Ar_4h = sd(NaRV.omit(control_19C_4h_Ar$avg_nfoci_0))
Std_ref_19C_Cont_Si_4h = sd(NaRV.omit(control_19C_4h_Si$avg_nfoci_0))
Std_ref_19C_Cont_Gamma_4h = sd(NaRV.omit(control_19C_4h_Gamma$avg_nfoci_0))
# 24h
Std_ref_19C_Cont_Fe_24h = sd(NaRV.omit(control_19C_24h_Fe$avg_nfoci_0))
Std_ref_19C_Cont_Ar_24h = sd(NaRV.omit(control_19C_24h_Ar$avg_nfoci_0))
Std_ref_19C_Cont_Si_24h = sd(NaRV.omit(control_19C_24h_Si$avg_nfoci_0))
Std_ref_19C_Cont_Gamma_24h = sd(NaRV.omit(control_19C_24h_Gamma$avg_nfoci_0))
#
#
## For Low dose irradiated samples
LD_19C= Samp_19C_10p
...
LD_19C$nfoci_high_dose_norm=NULL 
LD_19C$nfoci_low_dose_norm=NULL 
LD_19C$nfoci_0=NULL 
#
### 4h 
...
####### Mean
# 4h
Mean_ref_19C_LD_Fe_4h = mean(NaRV.omit(LD_19C_4h_Fe$avg_nfoci_low_dose))
Mean_ref_19C_LD_Ar_4h = mean(NaRV.omit(LD_19C_4h_Ar$avg_nfoci_low_dose))
Mean_ref_19C_LD_Si_4h = mean(NaRV.omit(LD_19C_4h_Si$avg_nfoci_low_dose))
Mean_ref_19C_LD_Gamma_4h = mean(NaRV.omit(LD_19C_4h_Gamma$avg_nfoci_low_dose))
# 24h
Mean_ref_19C_LD_Fe_24h = mean(NaRV.omit(LD_19C_24h_Fe$avg_nfoci_low_dose))
Mean_ref_19C_LD_Ar_24h = mean(NaRV.omit(LD_19C_24h_Ar$avg_nfoci_low_dose))
Mean_ref_19C_LD_Si_24h = mean(NaRV.omit(LD_19C_24h_Si$avg_nfoci_low_dose))
Mean_ref_19C_LD_Gamma_24h = mean(NaRV.omit(LD_19C_24h_Gamma$avg_nfoci_low_dose))
####### sd
# 4h
Std_ref_19C_LD_Fe_4h = sd(NaRV.omit(LD_19C_4h_Fe$avg_nfoci_low_dose))
Std_ref_19C_LD_Ar_4h = sd(NaRV.omit(LD_19C_4h_Ar$avg_nfoci_low_dose))
Std_ref_19C_LD_Si_4h = sd(NaRV.omit(LD_19C_4h_Si$avg_nfoci_low_dose))
Std_ref_19C_LD_Gamma_4h = sd(NaRV.omit(LD_19C_4h_Gamma$avg_nfoci_low_dose))
# 24h
Std_ref_19C_LD_Fe_24h = sd(NaRV.omit(LD_19C_24h_Fe$avg_nfoci_low_dose))
Std_ref_19C_LD_Ar_24h = sd(NaRV.omit(LD_19C_24h_Ar$avg_nfoci_low_dose))
Std_ref_19C_LD_Si_24h = sd(NaRV.omit(LD_19C_24h_Si$avg_nfoci_low_dose))
Std_ref_19C_LD_Gamma_24h = sd(NaRV.omit(LD_19C_24h_Gamma$avg_nfoci_low_dose))
#
#
## For high dose irradiated samples
HD_19C= Samp_19C_10p
...
HD_19C$nfoci_low_dose_norm=NULL 
HD_19C$nfoci_high_dose_norm=NULL 
HD_19C$nfoci_0=NULL 
#
### 4h 
...
####### Mean
# 4h
Mean_ref_19C_HD_Fe_4h = mean(NaRV.omit(HD_19C_4h_Fe$avg_nfoci_high_dose))
Mean_ref_19C_HD_Ar_4h = mean(NaRV.omit(HD_19C_4h_Ar$avg_nfoci_high_dose))
Mean_ref_19C_HD_Si_4h = mean(NaRV.omit(HD_19C_4h_Si$avg_nfoci_high_dose))
Mean_ref_19C_HD_Gamma_4h = mean(NaRV.omit(HD_19C_4h_Gamma$avg_nfoci_high_dose))
# 24h
Mean_ref_19C_HD_Fe_24h = mean(NaRV.omit(HD_19C_24h_Fe$avg_nfoci_high_dose))
Mean_ref_19C_HD_Ar_24h = mean(NaRV.omit(HD_19C_24h_Ar$avg_nfoci_high_dose))
Mean_ref_19C_HD_Si_24h = mean(NaRV.omit(HD_19C_24h_Si$avg_nfoci_high_dose))
Mean_ref_19C_HD_Gamma_24h = mean(NaRV.omit(HD_19C_24h_Gamma$avg_nfoci_high_dose))
####### sd
# 4h
Std_ref_19C_HD_Fe_4h = sd(NaRV.omit(HD_19C_4h_Fe$avg_nfoci_high_dose))
Std_ref_19C_HD_Ar_4h = sd(NaRV.omit(HD_19C_4h_Ar$avg_nfoci_high_dose))
Std_ref_19C_HD_Si_4h = sd(NaRV.omit(HD_19C_4h_Si$avg_nfoci_high_dose))
Std_ref_19C_HD_Gamma_4h = sd(NaRV.omit(HD_19C_4h_Gamma$avg_nfoci_high_dose))
# 24h
Std_ref_19C_HD_Fe_24h = sd(NaRV.omit(HD_19C_24h_Fe$avg_nfoci_high_dose))
Std_ref_19C_HD_Ar_24h = sd(NaRV.omit(HD_19C_24h_Ar$avg_nfoci_high_dose))
Std_ref_19C_HD_Si_24h = sd(NaRV.omit(HD_19C_24h_Si$avg_nfoci_high_dose))
Std_ref_19C_HD_Gamma_24h = sd(NaRV.omit(HD_19C_24h_Gamma$avg_nfoci_high_dose))


## Now we apply the "z-score correction" on all subjects from 19C 
#
#
Run_19C = c("Run_19C_Set_2", "Run_19C_Set_1")
Run_19A = c("Run_19A_Set_1", "Run_19A_Set_2", "Run_19A_Set_3", "Run_19A_Set_4")
#
Samp_19C_allp = Corrected_DNA_Damage %>% filter(Corrected_DNA_Damage$Run_set %in% Run_19C)
Samp_19A_allp = Corrected_DNA_Damage %>% filter(Corrected_DNA_Damage$Run_set %in% Run_19A)
#
## For Controls 
Controls_allp_19C= Samp_19C_allp
Controls_allp_19C$avg_nfoci_low_dose=NULL
Controls_allp_19C$avg_nfoci_high_dose=NULL
Controls_allp_19C$nfoci_low_dose_norm=NULL
Controls_allp_19C$nfoci_high_dose_norm=NULL
#
### 4h 
...
## z-score correction
# 4h
control_allp_19C_4h_Fe$avg_nfoci_0 = ((((control_allp_19C_4h_Fe$avg_nfoci_0 - Mean_ref_19C_Cont_Fe_4h)/Std_ref_19C_Cont_Fe_4h)*Std_ref_19A_Cont_Fe_4h) + Mean_ref_19A_Cont_Fe_4h)

control_allp_19C_4h_Ar$avg_nfoci_0 = ((((control_allp_19C_4h_Ar$avg_nfoci_0 - Mean_ref_19C_Cont_Ar_4h)/Std_ref_19C_Cont_Ar_4h)*Std_ref_19A_Cont_Ar_4h) + Mean_ref_19A_Cont_Ar_4h) 

control_allp_19C_4h_Si$avg_nfoci_0 = ((((control_allp_19C_4h_Si$avg_nfoci_0 - Mean_ref_19C_Cont_Si_4h)/Std_ref_19C_Cont_Si_4h)*Std_ref_19A_Cont_Si_4h) + Mean_ref_19A_Cont_Si_4h)
                                          
control_allp_19C_4h_Gamma$avg_nfoci_0 = ((((control_allp_19C_4h_Gamma$avg_nfoci_0 - Mean_ref_19C_Cont_Gamma_4h)/Std_ref_19C_Cont_Gamma_4h)*Std_ref_19A_Cont_Gamma_4h) + Mean_ref_19A_Cont_Gamma_4h)

# 24h
control_allp_19C_24h_Fe$avg_nfoci_0 = ((((control_allp_19C_24h_Fe$avg_nfoci_0 - Mean_ref_19C_Cont_Fe_24h)/Std_ref_19C_Cont_Fe_24h)*Std_ref_19A_Cont_Fe_24h) + Mean_ref_19A_Cont_Fe_24h)
                                          
control_allp_19C_24h_Ar$avg_nfoci_0 = ((((control_allp_19C_24h_Ar$avg_nfoci_0 - Mean_ref_19C_Cont_Ar_24h)/Std_ref_19C_Cont_Ar_24h)*Std_ref_19A_Cont_Ar_24h) + Mean_ref_19A_Cont_Ar_24h) 

control_allp_19C_24h_Si$avg_nfoci_0 = ((((control_allp_19C_24h_Si$avg_nfoci_0 - Mean_ref_19C_Cont_Si_24h)/Std_ref_19C_Cont_Si_24h)*Std_ref_19A_Cont_Si_24h) + Mean_ref_19A_Cont_Si_24h)
                                          
control_allp_19C_24h_Gamma$avg_nfoci_0 = ((((control_allp_19C_24h_Gamma$avg_nfoci_0 - Mean_ref_19C_Cont_Gamma_24h)/Std_ref_19C_Cont_Gamma_24h)*Std_ref_19A_Cont_Gamma_24h) + Mean_ref_19A_Cont_Gamma_24h)
#
#
## For Low dose irradiated samples
LD_allp_19C= Samp_19C_allp
LD_allp_19C$avg_nfoci_0=NULL
LD_allp_19C$avg_nfoci_high_dose=NULL
LD_allp_19C$nfoci_low_dose_norm=NULL
LD_allp_19C$nfoci_high_dose_norm=NULL
#
### 4h 
...
## z-score correction
# 4h
LD_allp_19C_4h_Fe$avg_nfoci_low_dose = ((((LD_allp_19C_4h_Fe$avg_nfoci_low_dose -Mean_ref_19C_LD_Fe_4h)/Std_ref_19C_LD_Fe_4h)*Std_ref_19A_LD_Fe_4h) + Mean_ref_19A_LD_Fe_4h)

LD_allp_19C_4h_Ar$avg_nfoci_low_dose = ((((LD_allp_19C_4h_Ar$avg_nfoci_low_dose -Mean_ref_19C_LD_Ar_4h)/Std_ref_19C_LD_Ar_4h)*Std_ref_19A_LD_Ar_4h) + Mean_ref_19A_LD_Ar_4h)

LD_allp_19C_4h_Si$avg_nfoci_low_dose = ((((LD_allp_19C_4h_Si$avg_nfoci_low_dose -Mean_ref_19C_LD_Si_4h)/Std_ref_19C_LD_Si_4h)*Std_ref_19A_LD_Si_4h) + Mean_ref_19A_LD_Si_4h)
                                            
LD_allp_19C_4h_Gamma$avg_nfoci_low_dose = ((((LD_allp_19C_4h_Gamma$avg_nfoci_low_dose -Mean_ref_19C_LD_Gamma_4h)/Std_ref_19C_LD_Gamma_4h)*Std_ref_19A_LD_Gamma_4h) + Mean_ref_19A_LD_Gamma_4h)
#
# 24h
LD_allp_19C_24h_Fe$avg_nfoci_low_dose = ((((LD_allp_19C_24h_Fe$avg_nfoci_low_dose -Mean_ref_19C_LD_Fe_24h)/Std_ref_19C_LD_Fe_24h)*Std_ref_19A_LD_Fe_24h) + Mean_ref_19A_LD_Fe_24h)

LD_allp_19C_24h_Ar$avg_nfoci_low_dose = ((((LD_allp_19C_24h_Ar$avg_nfoci_low_dose -Mean_ref_19C_LD_Ar_24h)/Std_ref_19C_LD_Ar_24h)*Std_ref_19A_LD_Ar_24h) + Mean_ref_19A_LD_Ar_24h)

LD_allp_19C_24h_Si$avg_nfoci_low_dose = ((((LD_allp_19C_24h_Si$avg_nfoci_low_dose -Mean_ref_19C_LD_Si_24h)/Std_ref_19C_LD_Si_24h)*Std_ref_19A_LD_Si_24h) + Mean_ref_19A_LD_Si_24h)
                                            
LD_allp_19C_24h_Gamma$avg_nfoci_low_dose = ((((LD_allp_19C_24h_Gamma$avg_nfoci_low_dose -Mean_ref_19C_LD_Gamma_24h)/Std_ref_19C_LD_Gamma_24h)*Std_ref_19A_LD_Gamma_24h) + Mean_ref_19A_LD_Gamma_24h)
#
## For high dose irradiated samples
HD_allp_19C= Samp_19C_allp
HD_allp_19C$avg_nfoci_0=NULL
HD_allp_19C$avg_nfoci_low_dose=NULL
HD_allp_19C$nfoci_low_dose_norm=NULL
HD_allp_19C$nfoci_high_dose_norm=NULL
#
### 4h 
...
## z-score correction
# 4h
HD_allp_19C_4h_Fe$avg_nfoci_high_dose= ((((HD_allp_19C_4h_Fe$avg_nfoci_high_dose -Mean_ref_19C_HD_Fe_4h)/Std_ref_19C_HD_Fe_4h)*Std_ref_19A_HD_Fe_4h) + Mean_ref_19A_HD_Fe_4h)

HD_allp_19C_4h_Ar$avg_nfoci_high_dose= ((((HD_allp_19C_4h_Ar$avg_nfoci_high_dose -Mean_ref_19C_HD_Ar_4h)/Std_ref_19C_HD_Ar_4h)*Std_ref_19A_HD_Ar_4h) + Mean_ref_19A_HD_Ar_4h)

HD_allp_19C_4h_Si$avg_nfoci_high_dose= ((((HD_allp_19C_4h_Si$avg_nfoci_high_dose -Mean_ref_19C_HD_Si_4h)/Std_ref_19C_HD_Si_4h)*Std_ref_19A_HD_Si_4h) + Mean_ref_19A_HD_Si_4h)

HD_allp_19C_4h_Gamma$avg_nfoci_high_dose= ((((HD_allp_19C_4h_Gamma$avg_nfoci_high_dose -Mean_ref_19C_HD_Gamma_4h)/Std_ref_19C_HD_Gamma_4h)*Std_ref_19A_HD_Gamma_4h) + Mean_ref_19A_HD_Gamma_4h)
#
# 24h
HD_allp_19C_24h_Fe$avg_nfoci_high_dose= ((((HD_allp_19C_24h_Fe$avg_nfoci_high_dose -Mean_ref_19C_HD_Fe_24h)/Std_ref_19C_HD_Fe_24h)*Std_ref_19A_HD_Fe_24h) + Mean_ref_19A_HD_Fe_24h)

HD_allp_19C_24h_Ar$avg_nfoci_high_dose= ((((HD_allp_19C_24h_Ar$avg_nfoci_high_dose -Mean_ref_19C_HD_Ar_24h)/Std_ref_19C_HD_Ar_24h)*Std_ref_19A_HD_Ar_24h) + Mean_ref_19A_HD_Ar_24h)

HD_allp_19C_24h_Si$avg_nfoci_high_dose= ((((HD_allp_19C_24h_Si$avg_nfoci_high_dose -Mean_ref_19C_HD_Si_24h)/Std_ref_19C_HD_Si_24h)*Std_ref_19A_HD_Si_24h) + Mean_ref_19A_HD_Si_24h)

HD_allp_19C_24h_Gamma$avg_nfoci_high_dose= ((((HD_allp_19C_24h_Gamma$avg_nfoci_high_dose -Mean_ref_19C_HD_Gamma_24h)/Std_ref_19C_HD_Gamma_24h) *Std_ref_19A_HD_Gamma_24h) + Mean_ref_19A_HD_Gamma_24h)
#
### Now we regroup everything
## regroup 19C
...
#
Control_19C_meta_use= Cont_19C_All_rad[,grepl("Sample_ID|Duplicate|Run_set|Timepoint|Radiation_type|avg",colnames(Cont_19C_All_rad))]
LD_control_19C=merge(LD_19C_All_rad, Control_19C_meta_use, by=c("Sample_ID", "Duplicate", "Run_set", "Timepoint", "Radiation_type") )
colnames(LD_control_19C)[colnames(LD_control_19C)=="avg_nfoci_low_dose"]<- "RIF"
LD_control_19C$Dose_relative="Low dose"
HD_control_19C=merge(HD_19C_All_rad, Control_19C_meta_use, by=c("Sample_ID", "Duplicate", "Run_set", "Timepoint", "Radiation_type") )
colnames(HD_control_19C)[colnames(HD_control_19C)=="avg_nfoci_high_dose"]<- "RIF"
HD_control_19C$Dose_relative="High dose"
Cont_19C_All_rad$RIF = Cont_19C_All_rad$avg_nfoci_0
Cont_19C_All_rad$Dose_relative = "0 Gy control"
LD_HD_19C=bind_rows(LD_control_19C, HD_control_19C, Cont_19C_All_rad)
#
#19A was used as reference: data were not modified. We format the table to fit the same structure as 19C
Samp_19A_allp_LD = Samp_19A_allp
Samp_19A_allp_LD$avg_nfoci_high_dose = NULL
Samp_19A_allp_LD$nfoci_high_dose_norm=NULL
Samp_19A_allp_LD$nfoci_low_dose_norm=NULL
...
#
################### regroup 19C and 19A 
All_19C_19A = bind_rows(LD_HD_19C, Samp_plot_19A_allp)
All_19C_19A$RIF_Norm = All_19C_19A$RIF / All_19C_19A$avg_nfoci_0
All_19C_19A$Timepoint=factor(All_19C_19A$Timepoint, levels=c("4h", "24h"))
All_19C_19A$Time_dose=paste(All_19C_19A$Timepoint, All_19C_19A$Dose_relative, sep = " ")
All_19C_19A$Time_dose=factor(All_19C_19A$Time_dose, levels=c("4h 0 Gy control",  "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))
All_19C_19A$Radiation_type=factor(All_19C_19A$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))

## Graph RIF vs Run_Set, color code radiation + a panel per time point without normalization
graph_without_Norm <- ggplot(All_19C_19A, aes(x=Time_dose, y=RIF)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Correction_step2_No_Norm_RIF_per_Run_Set_19C_19A.pdf", graph_without_Norm, width=25, height=7)
#
## Graph RIF vs Run_Set, color code radiation + a panel per time point with normalization
dose_relative= c("Low dose", "High dose")
All_19C_19A_Norm = All_19C_19A %>% filter(All_19C_19A$Dose_relative %in% dose_relative)
All_19C_19A_Norm$Time_dose=factor(All_19C_19A_Norm$Time_dose, levels=c("4h 0 Gy control",  "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))
All_19C_19A_Norm$Radiation_type=factor(All_19C_19A_Norm$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
graph_with_Norm <- ggplot(All_19C_19A_Norm, aes(x=Time_dose, y=RIF_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Correction_step2_Norm_RIF_per_Run_Set_19C_19A.pdf", graph_with_Norm, width=25, height=7)

########## Now we plot the same two latest plots but for the 10 subjects that overlap in 19C and 19A just to check the correction worked well 
All_19C_19A_10p = All_19C_19A %>% filter(All_19C_19A$Sample_ID %in% Subject_19CS1_19AS1)
All_19C_19A_10p$Time_dose=factor(All_19C_19A_10p$Time_dose, levels=c("4h 0 Gy control",  "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))
All_19C_19A_10p$Radiation_type=factor(All_19C_19A_10p$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
# without normalization
graph_without_Norm <- ggplot(All_19C_19A_10p, aes(x=Time_dose, y=RIF)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Correction_step2_No_Norm_RIF_per_Run_Set_19C_19A_10p_overlap.pdf", graph_without_Norm, width=25, height=7)
#
# with normalization
dose_relative= c("Low dose", "High dose")
All_19C_19A_Norm_10p = All_19C_19A_10p %>% filter(All_19C_19A_10p$Dose_relative %in% dose_relative)
All_19C_19A_Norm_10p$Time_dose=factor(All_19C_19A_Norm_10p$Time_dose, levels=c("4h 0 Gy control",  "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))
All_19C_19A_Norm_10p$Radiation_type=factor(All_19C_19A_Norm_10p$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
graph_with_Norm <- ggplot(All_19C_19A_Norm_10p, aes(x=Time_dose, y=RIF_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Correction_step2_Norm_RIF_per_Run_Set_19C_19A_10p_overlap.pdf", graph_with_Norm, width=25, height=7)


#####################################################################################################
###### Now we regroup data 18B/19A and 19C/19A after the final step of the correction ###############
#####################################################################################################
All_Corrected_DD=bind_rows(All_18B_19A, All_19C_19A)
All_Corrected_DD=unique(All_Corrected_DD) # use unique function because we have 19A data in double otherwise
All_Corrected_DD$RIF_Norm = NULL
All_Corrected_DD$Rad_dose_Gy = NULL
All_Corrected_DD$Time_dose = NULL
colnames(All_Corrected_DD)[colnames(All_Corrected_DD)=="RIF"]<- "avg_nfoci"

#### The correction may generate negative values => we fix those negative value to 0 
...
# For Gamma we rename 19C_set3 and 19C_Set4 as respectively 18B_Set1 and 18B_Set2 (since they are the same subjects: easier for the upcoming analyses)
All_Cell_Death_Raw$Run_set[All_Cell_Death_Raw$Run_set == "Run_19A_Set_3"] <- "Run_18B_Set_1"
All_Cell_Death_Raw$Run_set[All_Cell_Death_Raw$Run_set == "Run_19A_Set_4"] <- "Run_18B_Set_2"
...
## Without normalization
CD_Raw_Control = All_Cell_Death_Raw
CD_Raw_Control$Dead_Cells_high_dose=NULL
CD_Raw_Control$Dead_Cells_low_dose=NULL
CD_Raw_Control$Dead_Q1Q4_0=NULL
CD_Raw_Control$Dead_Q1Q4_high_dose=NULL
CD_Raw_Control$Dead_Q1Q4_low_dose=NULL
CD_Raw_Control$Dose_relative= "0 Gy control"
colnames(CD_Raw_Control)[colnames(CD_Raw_Control) == "Dead_Cells_0"] <- "Dead_Cells"
#
CD_Raw_LD = All_Cell_Death_Raw
CD_Raw_LD$Dead_Cells_high_dose=NULL
CD_Raw_LD$Dead_Cells_0=NULL
CD_Raw_LD$Dead_Q1Q4_0=NULL
CD_Raw_LD$Dead_Q1Q4_high_dose=NULL
CD_Raw_LD$Dead_Q1Q4_low_dose=NULL
CD_Raw_LD$Dose_relative= "Low dose"
colnames(CD_Raw_LD)[colnames(CD_Raw_LD) == "Dead_Cells_low_dose"] <- "Dead_Cells"
#
CD_Raw_HD = All_Cell_Death_Raw
CD_Raw_HD$Dead_Cells_low_dose=NULL
CD_Raw_HD$Dead_Cells_0=NULL
CD_Raw_HD$Dead_Q1Q4_0=NULL
CD_Raw_HD$Dead_Q1Q4_high_dose=NULL
CD_Raw_HD$Dead_Q1Q4_low_dose=NULL
CD_Raw_HD$Dose_relative= "High dose"
colnames(CD_Raw_HD)[colnames(CD_Raw_HD) == "Dead_Cells_high_dose"] <- "Dead_Cells"
#
CD_Raw_LD_HD = bind_rows(CD_Raw_LD, CD_Raw_HD, CD_Raw_Control)
CD_Raw_LD_HD$Timepoint=factor(CD_Raw_LD_HD$Timepoint, levels=c("4h", "24h"))
CD_Raw_LD_HD$Radiation_type=factor(CD_Raw_LD_HD$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
CD_Raw_LD_HD$Time_dose=paste(CD_Raw_LD_HD$Timepoint, CD_Raw_LD_HD$Dose_relative, sep = " ")
CD_Raw_LD_HD$Time_dose=factor(CD_Raw_LD_HD$Time_dose, levels=c("4h 0 Gy control", "4h Low dose", "4h High dose","24h 0 Gy control","24h Low dose", "24h High dose"))

#### For 18B and 19A (to be able to check at the end if the second step of the correction was efficient)
Run_18B_19A=c("Run_19A_Set_1", "Run_19A_Set_2", "Run_18B_Set_2", "Run_18B_Set_1", "Run_19A_Set_3","Run_19A_Set_4")
CD_Raw_LD_HD_Run = CD_Raw_LD_HD %>% filter(CD_Raw_LD_HD$Run_set %in% Run_18B_19A)

## Graph CD % vs Timepoint and dose + a panel per Run_set
graph_without_Norm <- ggplot(CD_Raw_LD_HD_Run, aes(x=Time_dose, y=Dead_Cells)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Raw_CD_No_Norm_Run_18B_and_19A.pdf", graph_without_Norm, width=25, height=7)

## Graph CD % vs Run_set for controls only (to check if the first step of the correction works well) color code = radiation and a panel per timepoint
CD_Raw_LD_HD_Run_Control = CD_Raw_LD_HD_Run %>% filter(CD_Raw_LD_HD_Run$Dose_relative == "0 Gy control")
CD_Raw_LD_HD_Run_Control$Timepoint=factor(CD_Raw_LD_HD_Run_Control$Timepoint, levels=c("4h", "24h"))
CD_Raw_LD_HD_Run_Control$Radiation_type=factor(CD_Raw_LD_HD_Run_Control$Radiation_type, levels=c("Gamma", "Si", "Ar", "Fe"))
Run_rad <- ggplot(CD_Raw_LD_HD_Run_Control, aes(x=Run_set, y=Dead_Cells)) + geom_boxplot(aes(fill=Radiation_type))
Run_rad <- Run_rad + facet_grid(. ~ Timepoint) + theme_gray() + ylim(0,7)
ggsave("Raw_CD_No_Norm_per_Run_Set_18B_19A.pdf", Run_rad, width=25, height=7)

#### For the 10p that overlap only 
Subject_18BS2_19AS1 = c(1214, 1215,1216,1217,1218,1219,1220,1221,1222,1223)
CD_Raw_LD_HD_10p = CD_Raw_LD_HD %>% filter(CD_Raw_LD_HD$Sample_ID %in% Subject_18BS2_19AS1)
# #
CD_Raw_LD_HD_10p$Timepoint=factor(CD_Raw_LD_HD_10p$Timepoint, levels=c("4h", "24h"))
CD_Raw_LD_HD_10p$Radiation_type=factor(CD_Raw_LD_HD_10p$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
CD_Raw_LD_HD_10p$Time_dose=paste(CD_Raw_LD_HD_10p$Timepoint, CD_Raw_LD_HD_10p$Dose_relative, sep = " ")
CD_Raw_LD_HD_10p$Time_dose=factor(CD_Raw_LD_HD_10p$Time_dose, levels=c("4h 0 Gy control", "4h Low dose", "4h High dose","24h 0 Gy control","24h Low dose", "24h High dose"))

graph_without_Norm <- ggplot(CD_Raw_LD_HD_10p, aes(x=Time_dose, y=Dead_Cells)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Raw_CD_No_Norm_10p_18B_19A.pdf", graph_without_Norm, width=25, height=7)


#### For 19C and 19A (to be able to check at the end if the second step of the correction was efficient)
Run_19C_19A=c("Run_19A_Set_1", "Run_19A_Set_2", "Run_19C_Set_2", "Run_19C_Set_1", "Run_19A_Set_3","Run_19A_Set_4")
CD_Raw_LD_HD_Run = CD_Raw_LD_HD %>% filter(CD_Raw_LD_HD$Run_set %in% Run_19C_19A)

## Graph CD% vs Timepoint and dose + a panel per Run_set
graph_without_Norm <- ggplot(CD_Raw_LD_HD_Run, aes(x=Time_dose, y=Dead_Cells)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Raw_CD_No_Norm_Run_19C_and_19A.pdf", graph_without_Norm, width=25, height=7)

## Graph CD% vs Run_set for controls only (to check if the first step of the correction works well) color code = radiation and a panel per timepoint
CD_Raw_LD_HD_Run_Control = CD_Raw_LD_HD_Run %>% filter(CD_Raw_LD_HD_Run$Dose_relative == "0 Gy control")
CD_Raw_LD_HD_Run_Control$Timepoint=factor(CD_Raw_LD_HD_Run_Control$Timepoint, levels=c("4h", "24h"))
CD_Raw_LD_HD_Run_Control$Radiation_type=factor(CD_Raw_LD_HD_Run_Control$Radiation_type, levels=c("Gamma", "Si", "Ar", "Fe"))
CD_rad <- ggplot(CD_Raw_LD_HD_Run_Control, aes(x=Run_set, y=Dead_Cells)) + geom_boxplot(aes(fill=Radiation_type))
Run_rad <- Run_rad + facet_grid(. ~ Timepoint) + theme_gray() + ylim(0,7)
ggsave("Raw_CD_No_Norm_per_Run_Set_19C_19A.pdf", Run_rad, width=25, height=7)

#### For the 10p that overlap only 
Subject_19CS1_19AS1 =  c(1589,1590,1591,1592,1593,1594,1595,1596,1597)
CD_Raw_LD_HD_10p = CD_Raw_LD_HD %>% filter(CD_Raw_LD_HD$Sample_ID %in% Subject_19CS1_19AS1)
# #
CD_Raw_LD_HD_10p$Timepoint=factor(CD_Raw_LD_HD_10p$Timepoint, levels=c("4h", "24h"))
CD_Raw_LD_HD_10p$Radiation_type=factor(CD_Raw_LD_HD_10p$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
CD_Raw_LD_HD_10p$Time_dose=paste(CD_Raw_LD_HD_10p$Timepoint, CD_Raw_LD_HD_10p$Dose_relative, sep = " ")
...
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Raw_CD_No_Norm_10p_19C_19A.pdf", graph_without_Norm, width=25, height=7)


## With Normalization
CD_Raw_Norm = All_Cell_Death_Raw
CD_Raw_Norm$CD_Norm_low_dose=CD_Raw_Norm$Dead_Cells_low_dose / CD_Raw_Norm$Dead_Cells_0
CD_Raw_Norm$CD_Norm_high_dose=CD_Raw_Norm$Dead_Cells_high_dose / CD_Raw_Norm$Dead_Cells_0
#
# 
CD_Raw_Norm_LD= CD_Raw_Norm 
CD_Raw_Norm_LD$CD_Norm_high_dose=NULL
CD_Raw_Norm_LD$Dead_Cells_high_dose=NULL
CD_Raw_Norm_LD$Dead_Q1Q4_high_dose=NULL
CD_Raw_Norm_LD$Dead_Cells_low_dose=NULL
CD_Raw_Norm_LD$Dead_Q1Q4_low_dose=NULL
CD_Raw_Norm_LD$Dead_Cells_0=NULL
CD_Raw_Norm_LD$Dead_Q1Q4_0=NULL
CD_Raw_Norm_LD$Dose_relative= "Low dose"
colnames(CD_Raw_Norm_LD)[colnames(CD_Raw_Norm_LD) == "CD_Norm_low_dose"] <- "CD_Norm"
#
CD_Raw_Norm_HD= CD_Raw_Norm 
CD_Raw_Norm_HD$CD_Norm_low_dose=NULL
CD_Raw_Norm_HD$Dead_Cells_high_dose=NULL
CD_Raw_Norm_HD$Dead_Q1Q4_high_dose=NULL
CD_Raw_Norm_HD$Dead_Cells_low_dose=NULL
CD_Raw_Norm_HD$Dead_Q1Q4_low_dose=NULL
CD_Raw_Norm_HD$Dead_Cells_0=NULL
CD_Raw_Norm_HD$Dead_Q1Q4_0=NULL
CD_Raw_Norm_HD$Dose_relative= "High dose"
colnames(CD_Raw_Norm_HD)[colnames(CD_Raw_Norm_HD) == "CD_Norm_high_dose"] <- "CD_Norm"
#
CD_Raw_LD_HD_Norm = bind_rows(CD_Raw_Norm_LD, CD_Raw_Norm_HD)
CD_Raw_LD_HD_Norm$Point = paste(CD_Raw_LD_HD_Norm$Radiation_type, CD_Raw_LD_HD_Norm$Timepoint, sep = '_')
CD_Raw_LD_HD_Norm$Timepoint=factor(CD_Raw_LD_HD_Norm$Timepoint, levels=c("4h", "24h"))
CD_Raw_LD_HD_Norm$Radiation_type=factor(CD_Raw_LD_HD_Norm$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
CD_Raw_LD_HD_Norm$Rad_dose=paste(CD_Raw_LD_HD_Norm$Radiation_type, CD_Raw_LD_HD_Norm$Dose_relative, sep = " ")
CD_Raw_LD_HD_Norm$Time_dose=paste(CD_Raw_LD_HD_Norm$Timepoint, CD_Raw_LD_HD_Norm$Dose_relative, sep = " ")
CD_Raw_LD_HD_Norm$Time_dose=factor(CD_Raw_LD_HD_Norm$Time_dose, levels=c("4h Low dose", "4h High dose",
                                                                 "24h Low dose", "24h High dose"))
...
#### For 18B and 19A (to be able to check at the end if the second step of the correction was efficient)
Run_18B_19A=c("Run_19A_Set_1", "Run_19A_Set_2", "Run_18B_Set_2", "Run_18B_Set_1", "Run_19A_Set_3","Run_19A_Set_4")
CD_Raw_LD_HD_Norm_Run = CD_Raw_LD_HD_Norm %>% filter(CD_Raw_LD_HD_Norm$Run_set %in% Run_18B_19A)

graph_with_Norm <- ggplot(CD_Raw_LD_HD_Norm_Run, aes(x=Time_dose, y=CD_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Raw_CD_Norm_Run_18B_and_19A.pdf", graph_with_Norm, width=25, height=7)

#### For 19C and 19A (to be able to check at the end if the second step of the correction was efficient)
Run_19C_19A=c("Run_19A_Set_1", "Run_19A_Set_2", "Run_19C_Set_2", "Run_19C_Set_1", "Run_19A_Set_3","Run_19A_Set_4")
CD_Raw_LD_HD_Norm_Run = CD_Raw_LD_HD_Norm %>% filter(CD_Raw_LD_HD_Norm$Run_set %in% Run_19C_19A)

graph_with_Norm <- ggplot(CD_Raw_LD_HD_Norm_Run, aes(x=Time_dose, y=CD_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Raw_CD_Norm_Run_19C_and_19A.pdf", graph_with_Norm, width=25, height=7)
...
metadata=Run_set_1[,grep("Sample_ID|Timepoint|Age|BMI|Gender",colnames(Run_set_1))]
metadata$BMI_group=NULL
edata_control=Run_set_1[,grep("Dead_Q1Q4_0|Dead_Cells_0",colnames(Run_set_1))]
edata_control=t(edata_control)
modcombat = model.matrix(~1, data= metadata) 
Batch_C= Run_set_1$Radiation_Batch
## Run Finsam's function
...
metadata=Run_set_2[,grep("Sample_ID|Timepoint|Age|BMI|Gender",colnames(Run_set_2))]
metadata$BMI_group=NULL
edata_control=Run_set_2[,grep("Dead_Q1Q4_0|Dead_Cells_0",colnames(Run_set_2))]
edata_control=t(edata_control)
modcombat = model.matrix(~1, data= metadata) 
Batch_C= Run_set_2$Radiation_Batch
## Run Finsam's function
...
metadata=Run_set_3[,grep("Sample_ID|Timepoint|Age|BMI|Gender",colnames(Run_set_3))]
metadata$BMI_group=NULL
edata_control=Run_set_3[,grep("Dead_Q1Q4_0|Dead_Cells_0",colnames(Run_set_3))]
edata_control=t(edata_control)
modcombat = model.matrix(~1, data= metadata) 
Batch_C= Run_set_3$Radiation_Batch
## Run Finsam's function
...
metadata=Run_set_4[,grep("Sample_ID|Timepoint|Age|BMI|Gender",colnames(Run_set_4))]
metadata$BMI_group=NULL
edata_control=Run_set_4[,grep("Dead_Q1Q4_0|Dead_Cells_0",colnames(Run_set_4))]
edata_control=t(edata_control)
modcombat = model.matrix(~1, data= metadata) 
Batch_C= Run_set_4$Radiation_Batch
## Run Finsam's function
...
metadata=Run_set_5[,grep("Sample_ID|Timepoint|Age|BMI|Gender",colnames(Run_set_5))]
metadata$BMI_group=NULL
edata_control=Run_set_5[,grep("Dead_Q1Q4_0|Dead_Cells_0",colnames(Run_set_5))]
edata_control=t(edata_control)
modcombat = model.matrix(~1, data= metadata) 
Batch_C= Run_set_5$Radiation_Batch
## Run Finsam's function
...
metadata=Run_set_6[,grep("Sample_ID|Timepoint|Age|BMI|Gender",colnames(Run_set_6))]
metadata$BMI_group=NULL
edata_control=Run_set_6[,grep("Dead_Q1Q4_0|Dead_Cells_0",colnames(Run_set_6))]
edata_control=t(edata_control)
modcombat = model.matrix(~1, data= metadata) 
Batch_C= Run_set_6$Radiation_Batch
## Run Finsam's function
...
metadata=Run_set_7[,grep("Sample_ID|Timepoint|Age|BMI|Gender",colnames(Run_set_7))]
metadata$BMI_group=NULL
edata_control=Run_set_7[,grep("Dead_Q1Q4_0|Dead_Cells_0",colnames(Run_set_7))]
edata_control=t(edata_control)
modcombat = model.matrix(~1, data= metadata) 
Batch_C= Run_set_7$Radiation_Batch
## Run Finsam's function
...
metadata=Run_set_8[,grep("Sample_ID|Timepoint|Age|BMI|Gender",colnames(Run_set_8))]
metadata$BMI_group=NULL
edata_control=Run_set_8[,grep("Dead_Q1Q4_0|Dead_Cells_0",colnames(Run_set_8))]
edata_control=t(edata_control)
modcombat = model.matrix(~1, data= metadata) 
Batch_C= Run_set_8$Radiation_Batch
## Run Finsam's function
...
## add columns with data normalized (used only for the graphs below, these 2 columns are then removed)
Corrected_Cell_Death$CD_high_dose_norm = Corrected_Cell_Death$Dead_Cells_high_dose / Corrected_Cell_Death$Dead_Cells_0
Corrected_Cell_Death$CD_low_dose_norm = Corrected_Cell_Death$Dead_Cells_low_dose / Corrected_Cell_Death$Dead_Cells_0

Corrected_Cell_Death$Dead_Q1Q4_0 = NULL
Corrected_Cell_Death$Dead_Q1Q4_low_dose= NULL
Corrected_Cell_Death$Dead_Q1Q4_high_dose= NULL
...
## Without normalization
# control
CD_Correct1_Control = Corrected_Dead_Cells[,grepl("Dead_Cells_0|Sample|Run_set|Duplicate|Timepoint|Radiation_type|Age|Gender|BMI",colnames(Corrected_Dead_Cells))]
CD_Correct1_Control$Dose_relative= "0 Gy control"
colnames(CD_Correct1_Control)[colnames(CD_Correct1_Control) == "Dead_Cells_0"] <- "Dead_Cells"
# Low dose
CD_Correct1_LD = Corrected_Dead_Cells[,grepl("Dead_Cells_low|Sample|Run_set|Duplicate|Timepoint|Radiation_type|Age|Gender|BMI",colnames(Corrected_Dead_Cells))]
CD_Correct1_LD$Dose_relative= "Low dose"
colnames(CD_Correct1_LD)[colnames(CD_Correct1_LD) == "Dead_Cells_low_dose"] <- "Dead_Cells"
# High dose
CD_Correct1_HD = Corrected_Dead_Cells[,grepl("Dead_Cells_high|Sample|Run_set|Duplicate|Timepoint|Radiation_type|Age|Gender|BMI",colnames(Corrected_Dead_Cells))]
CD_Correct1_HD$Dose_relative= "High dose"
colnames(CD_Correct1_HD)[colnames(CD_Correct1_HD) == "Dead_Cells_high_dose"] <- "Dead_Cells"
## regroup no normalization
CD_Correct1_LD_HD = bind_rows(CD_Correct1_LD, CD_Correct1_HD, CD_Correct1_Control)
CD_Correct1_LD_HD$Radiation_type=factor(CD_Correct1_LD_HD$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
CD_Correct1_LD_HD$Time_dose=paste(CD_Correct1_LD_HD$Timepoint, CD_Correct1_LD_HD$Dose_relative, sep = " ")
CD_Correct1_LD_HD$Time_dose=factor(CD_Correct1_LD_HD$Time_dose, levels=c("4h 0 Gy control", "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))



#### For Run 18B and 19A 
Run_18B_19A=c("Run_19A_Set_1", "Run_19A_Set_2", "Run_18B_Set_2", "Run_18B_Set_1", "Run_19A_Set_3", "Run_19A_Set_4")
CD_Correct1_LD_HD_Run = CD_Correct1_LD_HD %>% filter(CD_Correct1_LD_HD$Run_set %in% Run_18B_19A)
## Graph CD % vs Time point/dose + a panel per Radiation 
graph_without_Norm <- ggplot(CD_Correct1_LD_HD_Run, aes(x=Time_dose, y=Dead_Cells)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Correction_CD_step1_No_Norm_Run_18B_19A.pdf", graph_without_Norm, width=25, height=7)
#
## Graph CD % vs Run_Set, color code radiation + a panel per time point
CD_Correct1_LD_HD_Run_Control = CD_Correct1_LD_HD_Run %>% filter(CD_Correct1_LD_HD_Run$Dose_relative == "0 Gy control")
CD_Correct1_LD_HD_Run_Control$CD_Correct1_LD_HD_Run_Control=factor(CD_Correct1_LD_HD_Run_Control$CD_Correct1_LD_HD_Run_Control, levels=c("4h", "24h"))
CD_Correct1_LD_HD_Run_Control$Radiation_type=factor(CD_Correct1_LD_HD_Run_Control$Radiation_type, levels=c("Gamma","Si", "Ar", "Fe"))
Run_rad <- ggplot(CD_Correct1_LD_HD_Run_Control, aes(x=Run_set, y=Dead_Cells)) + geom_boxplot(aes(fill=Radiation_type))
Run_rad <- Run_rad + facet_grid(. ~ Timepoint) + theme_gray() + ylim(0,7)
ggsave("Correction_step1_No_Norm_CD_per_Run_Set_18B_19A.pdf", Run_rad, width=25, height=7)

### 10p that overlap
CD_Correct1_LD_HD_Run_10p = CD_Correct1_LD_HD_Run %>% filter(CD_Correct1_LD_HD_Run$Sample_ID %in% Subject_18BS2_19AS1)
CD_Correct1_LD_HD_Run_10p$Radiation_type=factor(CD_Correct1_LD_HD_Run_10p$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
CD_Correct1_LD_HD_Run_10p$Time_dose=paste(CD_Correct1_LD_HD_Run_10p$Timepoint, CD_Correct1_LD_HD_Run_10p$Dose_relative, sep = " ")
CD_Correct1_LD_HD_Run_10p$Time_dose=factor(CD_Correct1_LD_HD_Run_10p$Time_dose, levels=c("4h 0 Gy control", "4h Low dose", "4h High dose","24h 0 Gy control","24h Low dose", "24h High dose"))
#
graph_without_Norm <- ggplot(CD_Correct1_LD_HD_Run_10p, aes(x=Time_dose, y=Dead_Cells)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Correction_1_No_Norm_10p_18B_19A.pdf", graph_without_Norm, width=25, height=7)
...
#### For Run 19C and 19A 
Run_19C_19A=c("Run_19A_Set_1", "Run_19A_Set_2", "Run_19C_Set_2", "Run_19C_Set_1", "Run_19A_Set_3", "Run_19A_Set_4")
CD_Correct1_LD_HD_Run = CD_Correct1_LD_HD %>% filter(CD_Correct1_LD_HD$Run_set %in% Run_19C_19A)
## Graph CD % vs Time point/dose + a panel per Radiation 
graph_without_Norm <- ggplot(CD_Correct1_LD_HD_Run, aes(x=Time_dose, y=Dead_Cells)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("CorrectioN_CD_step1_No_Norm_Run_19C_19A.pdf", graph_without_Norm, width=25, height=7)
#
## Graph CD % vs Run_Set, color code radiation + a panel per time point
CD_Correct1_LD_HD_Run_Control = CD_Correct1_LD_HD_Run %>% filter(CD_Correct1_LD_HD_Run$Dose_relative == "0 Gy control")
CD_Correct1_LD_HD_Run_Control$Timepoint=factor(CD_Correct1_LD_HD_Run_Control$Timepoint, levels=c("4h", "24h"))
CD_Correct1_LD_HD_Run_Control$Radiation_type=factor(CD_Correct1_LD_HD_Run_Control$Radiation_type, levels=c("Gamma","Si", "Ar", "Fe"))
Run_rad <- ggplot(CD_Correct1_LD_HD_Run_Control, aes(x=Run_set, y=Dead_Cells)) + geom_boxplot(aes(fill=Radiation_type))
Run_rad <- Run_rad + facet_grid(. ~ Timepoint) + theme_gray() + ylim(0,7)
ggsave("Correction_step1_No_Norm_CD_per_Run_Set_19C_19A.pdf", Run_rad, width=25, height=7)

### 10p that overlap
CD_Correct1_LD_HD_Run_10p = CD_Correct1_LD_HD_Run %>% filter(CD_Correct1_LD_HD_Run$Sample_ID %in% Subject_19CS1_19AS1)
CD_Correct1_LD_HD_Run_10p$Radiation_type=factor(CD_Correct1_LD_HD_Run_10p$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
CD_Correct1_LD_HD_Run_10p$Time_dose=paste(CD_Correct1_LD_HD_Run_10p$Timepoint, CD_Correct1_LD_HD_Run_10p$Dose_relative, sep = " ")
CD_Correct1_LD_HD_Run_10p$Time_dose=factor(CD_Correct1_LD_HD_Run_10p$Time_dose, levels=c("4h 0 Gy control", "4h Low dose", "4h High dose","24h 0 Gy control","24h Low dose", "24h High dose"))
#
...
## With normalization
# Low dose
CD_Correct1_LD_Norm = Corrected_Cell_Death[,grepl("low_dose_norm|Sample|Run_set|Duplicate|Timepoint|Radiation_type|Age|Gender|BMI",colnames(Corrected_Cell_Death))]
CD_Correct1_LD_Norm$Dose_relative= "Low dose"
colnames(CD_Correct1_LD_Norm)[colnames(CD_Correct1_LD_Norm) == "CD_low_dose_norm"] <- "CD_Norm"
# High dose
CD_Correct1_HD_Norm = Corrected_Cell_Death[,grepl("high_dose_norm|Run_set|Sample|Duplicate|Timepoint|Radiation_type|Age|Gender|BMI",colnames(Corrected_Cell_Death))]
CD_Correct1_HD_Norm$Dose_relative= "High dose"
colnames(CD_Correct1_HD_Norm)[colnames(CD_Correct1_HD_Norm) == "CD_high_dose_norm"] <- "CD_Norm"
## regroup no normalization
CD_Correct1_LD_HD_Norm = bind_rows(CD_Correct1_LD_Norm, CD_Correct1_HD_Norm)
CD_Correct1_LD_HD_Norm$Radiation_type=factor(CD_Correct1_LD_HD_Norm$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
CD_Correct1_LD_HD_Norm$Time_dose=paste(CD_Correct1_LD_HD_Norm$Timepoint, CD_Correct1_LD_HD_Norm$Dose_relative, sep = " ")
CD_Correct1_LD_HD_Norm$Time_dose=factor(CD_Correct1_LD_HD_Norm$Time_dose, levels=c("4h 0 Gy control", "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))


#### For Run 18B and 19A 
Run_18B_19A=c("Run_19A_Set_1", "Run_19A_Set_2", "Run_18B_Set_2", "Run_18B_Set_1", "Run_19A_Set_3", "Run_19A_Set_4")
CD_Correct1_LD_HD_Run_Norm = CD_Correct1_LD_HD_Norm %>% filter(CD_Correct1_LD_HD_Norm$Run_set %in% Run_18B_19A)
## Graph all subjects
graph_with_Norm <- ggplot(CD_Correct1_LD_HD_Run_Norm, aes(x=Time_dose, y=CD_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Correction_CD_step1_Norm_Run_19C_19A.pdf", graph_with_Norm, width=25, height=7)
#
#### For Run 19C and 19A 
Run_19C_19A=c("Run_19A_Set_1", "Run_19A_Set_2", "Run_19C_Set_2", "Run_19C_Set_1", "Run_19A_Set_3", "Run_19A_Set_4")
CD_Correct1_LD_HD_Run_Norm = CD_Correct1_LD_HD_Norm %>% filter(CD_Correct1_LD_HD_Norm$Run_set %in% Run_19C_19A)
## Graph all subjects
graph_with_Norm <- ggplot(CD_Correct1_LD_HD_Run_Norm, aes(x=Time_dose, y=CD_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
...
Corrected_Cell_Death$CD_high_dose_norm = NULL
Corrected_Cell_Death$CD_low_dose_norm = NULL
...
# Select the 10 people that overlap in these two run
Subject_18BS2_19AS1 = c(1214, 1215,1216,1217,1218,1219,1220,1221,1222,1223)
CD_correct_19A_18B_10p = Corrected_Cell_Death %>% filter(Corrected_Cell_Death$Sample_ID %in% Subject_18BS2_19AS1 )
#
#### Z-score for 19A
Samp_19A_10p = CD_correct_19A_18B_10p %>% filter(CD_correct_19A_18B_10p$Run_set =="Run_19A_Set_1")
## For Controls 
Controls_19A= Samp_19A_10p
...
####### Mean
# 4h
Mean_ref_19A_Cont_Fe_4h = mean(NaRV.omit(control_19A_4h_Fe$Dead_Cells_0))
Mean_ref_19A_Cont_Ar_4h = mean(NaRV.omit(control_19A_4h_Ar$Dead_Cells_0))
Mean_ref_19A_Cont_Si_4h = mean(NaRV.omit(control_19A_4h_Si$Dead_Cells_0))
Mean_ref_19A_Cont_Gamma_4h = mean(NaRV.omit(control_19A_4h_Gamma$Dead_Cells_0))
# 24h
Mean_ref_19A_Cont_Fe_24h = mean(NaRV.omit(control_19A_24h_Fe$Dead_Cells_0))
Mean_ref_19A_Cont_Ar_24h = mean(NaRV.omit(control_19A_24h_Ar$Dead_Cells_0))
Mean_ref_19A_Cont_Si_24h = mean(NaRV.omit(control_19A_24h_Si$Dead_Cells_0))
Mean_ref_19A_Cont_Gamma_24h = mean(NaRV.omit(control_19A_24h_Gamma$Dead_Cells_0))
####### sd
# 4h
Std_ref_19A_Cont_Fe_4h = sd(NaRV.omit(control_19A_4h_Fe$Dead_Cells_0))
Std_ref_19A_Cont_Ar_4h = sd(NaRV.omit(control_19A_4h_Ar$Dead_Cells_0))
Std_ref_19A_Cont_Si_4h = sd(NaRV.omit(control_19A_4h_Si$Dead_Cells_0))
Std_ref_19A_Cont_Gamma_4h = sd(NaRV.omit(control_19A_4h_Gamma$Dead_Cells_0))
# 24h
Std_ref_19A_Cont_Fe_24h = sd(NaRV.omit(control_19A_24h_Fe$Dead_Cells_0))
Std_ref_19A_Cont_Ar_24h = sd(NaRV.omit(control_19A_24h_Ar$Dead_Cells_0))
Std_ref_19A_Cont_Si_24h = sd(NaRV.omit(control_19A_24h_Si$Dead_Cells_0))
Std_ref_19A_Cont_Gamma_24h = sd(NaRV.omit(control_19A_24h_Gamma$Dead_Cells_0))
#
#
## For Low dose irradiated samples
LD_19A= Samp_19A_10p
...
####### Mean
# 4h
Mean_ref_19A_LD_Fe_4h = mean(NaRV.omit(LD_19A_4h_Fe$Dead_Cells_low_dose))
Mean_ref_19A_LD_Ar_4h = mean(NaRV.omit(LD_19A_4h_Ar$Dead_Cells_low_dose))
Mean_ref_19A_LD_Si_4h = mean(NaRV.omit(LD_19A_4h_Si$Dead_Cells_low_dose))
Mean_ref_19A_LD_Gamma_4h = mean(NaRV.omit(LD_19A_4h_Gamma$Dead_Cells_low_dose))
# 24h
Mean_ref_19A_LD_Fe_24h = mean(NaRV.omit(LD_19A_24h_Fe$Dead_Cells_low_dose))
Mean_ref_19A_LD_Ar_24h = mean(NaRV.omit(LD_19A_24h_Ar$Dead_Cells_low_dose))
Mean_ref_19A_LD_Si_24h = mean(NaRV.omit(LD_19A_24h_Si$Dead_Cells_low_dose))
Mean_ref_19A_LD_Gamma_24h = mean(NaRV.omit(LD_19A_24h_Gamma$Dead_Cells_low_dose))
####### sd
# 4h
Std_ref_19A_LD_Fe_4h = sd(NaRV.omit(LD_19A_4h_Fe$Dead_Cells_low_dose))
Std_ref_19A_LD_Ar_4h = sd(NaRV.omit(LD_19A_4h_Ar$Dead_Cells_low_dose))
Std_ref_19A_LD_Si_4h = sd(NaRV.omit(LD_19A_4h_Si$Dead_Cells_low_dose))
Std_ref_19A_LD_Gamma_4h = sd(NaRV.omit(LD_19A_4h_Gamma$Dead_Cells_low_dose))
# 24h
Std_ref_19A_LD_Fe_24h = sd(NaRV.omit(LD_19A_24h_Fe$Dead_Cells_low_dose))
Std_ref_19A_LD_Ar_24h = sd(NaRV.omit(LD_19A_24h_Ar$Dead_Cells_low_dose))
Std_ref_19A_LD_Si_24h = sd(NaRV.omit(LD_19A_24h_Si$Dead_Cells_low_dose))
Std_ref_19A_LD_Gamma_24h = sd(NaRV.omit(LD_19A_24h_Gamma$Dead_Cells_low_dose))
#
## For high dose irradiated samples
HD_19A= Samp_19A_10p
...
####### Mean
# 4h
Mean_ref_19A_HD_Fe_4h = mean(NaRV.omit(HD_19A_4h_Fe$Dead_Cells_high_dose))
Mean_ref_19A_HD_Ar_4h = mean(NaRV.omit(HD_19A_4h_Ar$Dead_Cells_high_dose))
Mean_ref_19A_HD_Si_4h = mean(NaRV.omit(HD_19A_4h_Si$Dead_Cells_high_dose))
Mean_ref_19A_HD_Gamma_4h = mean(NaRV.omit(HD_19A_4h_Gamma$Dead_Cells_high_dose))
# 24h
Mean_ref_19A_HD_Fe_24h = mean(NaRV.omit(HD_19A_24h_Fe$Dead_Cells_high_dose))
Mean_ref_19A_HD_Ar_24h = mean(NaRV.omit(HD_19A_24h_Ar$Dead_Cells_high_dose))
Mean_ref_19A_HD_Si_24h = mean(NaRV.omit(HD_19A_24h_Si$Dead_Cells_high_dose))
Mean_ref_19A_HD_Gamma_24h = mean(NaRV.omit(HD_19A_24h_Gamma$Dead_Cells_high_dose))
####### sd
# 4h
Std_ref_19A_HD_Fe_4h = sd(NaRV.omit(HD_19A_4h_Fe$Dead_Cells_high_dose))
Std_ref_19A_HD_Ar_4h = sd(NaRV.omit(HD_19A_4h_Ar$Dead_Cells_high_dose))
Std_ref_19A_HD_Si_4h = sd(NaRV.omit(HD_19A_4h_Si$Dead_Cells_high_dose))
Std_ref_19A_HD_Gamma_4h = sd(NaRV.omit(HD_19A_4h_Gamma$Dead_Cells_high_dose))
# 24h
Std_ref_19A_HD_Fe_24h = sd(NaRV.omit(HD_19A_24h_Fe$Dead_Cells_high_dose))
Std_ref_19A_HD_Ar_24h = sd(NaRV.omit(HD_19A_24h_Ar$Dead_Cells_high_dose))
Std_ref_19A_HD_Si_24h = sd(NaRV.omit(HD_19A_24h_Si$Dead_Cells_high_dose))
Std_ref_19A_HD_Gamma_24h = sd(NaRV.omit(HD_19A_24h_Gamma$Dead_Cells_high_dose))

#### Z-score for 18B
Samp_18B_10p = CD_correct_19A_18B_10p %>% filter(CD_correct_19A_18B_10p$Run_set =="Run_18B_Set_2")
## For Controls 
Controls_18B= Samp_18B_10p
...
####### Mean
# 4h
Mean_ref_18B_Cont_Fe_4h = mean(NaRV.omit(control_18B_4h_Fe$Dead_Cells_0))
Mean_ref_18B_Cont_Ar_4h = mean(NaRV.omit(control_18B_4h_Ar$Dead_Cells_0))
Mean_ref_18B_Cont_Si_4h = mean(NaRV.omit(control_18B_4h_Si$Dead_Cells_0))
Mean_ref_18B_Cont_Gamma_4h = mean(NaRV.omit(control_18B_4h_Gamma$Dead_Cells_0))
# 24h
Mean_ref_18B_Cont_Fe_24h = mean(NaRV.omit(control_18B_24h_Fe$Dead_Cells_0))
Mean_ref_18B_Cont_Ar_24h = mean(NaRV.omit(control_18B_24h_Ar$Dead_Cells_0))
Mean_ref_18B_Cont_Si_24h = mean(NaRV.omit(control_18B_24h_Si$Dead_Cells_0))
Mean_ref_18B_Cont_Gamma_24h = mean(NaRV.omit(control_18B_24h_Gamma$Dead_Cells_0))
####### sd
# 4h
Std_ref_18B_Cont_Fe_4h = sd(NaRV.omit(control_18B_4h_Fe$Dead_Cells_0))
Std_ref_18B_Cont_Ar_4h = sd(NaRV.omit(control_18B_4h_Ar$Dead_Cells_0))
Std_ref_18B_Cont_Si_4h = sd(NaRV.omit(control_18B_4h_Si$Dead_Cells_0))
Std_ref_18B_Cont_Gamma_4h = sd(NaRV.omit(control_18B_4h_Gamma$Dead_Cells_0))
# 24h
Std_ref_18B_Cont_Fe_24h = sd(NaRV.omit(control_18B_24h_Fe$Dead_Cells_0))
Std_ref_18B_Cont_Ar_24h = sd(NaRV.omit(control_18B_24h_Ar$Dead_Cells_0))
Std_ref_18B_Cont_Si_24h = sd(NaRV.omit(control_18B_24h_Si$Dead_Cells_0))
Std_ref_18B_Cont_Gamma_24h = sd(NaRV.omit(control_18B_24h_Gamma$Dead_Cells_0))
#
#
## For Low dose irradiated samples
LD_18B= Samp_18B_10p
...
####### Mean
# 4h
Mean_ref_18B_LD_Fe_4h = mean(NaRV.omit(LD_18B_4h_Fe$Dead_Cells_low_dose))
Mean_ref_18B_LD_Ar_4h = mean(NaRV.omit(LD_18B_4h_Ar$Dead_Cells_low_dose))
Mean_ref_18B_LD_Si_4h = mean(NaRV.omit(LD_18B_4h_Si$Dead_Cells_low_dose))
Mean_ref_18B_LD_Gamma_4h = mean(NaRV.omit(LD_18B_4h_Gamma$Dead_Cells_low_dose))
# 24h
Mean_ref_18B_LD_Fe_24h = mean(NaRV.omit(LD_18B_24h_Fe$Dead_Cells_low_dose))
Mean_ref_18B_LD_Ar_24h = mean(NaRV.omit(LD_18B_24h_Ar$Dead_Cells_low_dose))
Mean_ref_18B_LD_Si_24h = mean(NaRV.omit(LD_18B_24h_Si$Dead_Cells_low_dose))
Mean_ref_18B_LD_Gamma_24h = mean(NaRV.omit(LD_18B_24h_Gamma$Dead_Cells_low_dose))
####### sd
# 4h
Std_ref_18B_LD_Fe_4h = sd(NaRV.omit(LD_18B_4h_Fe$Dead_Cells_low_dose))
Std_ref_18B_LD_Ar_4h = sd(NaRV.omit(LD_18B_4h_Ar$Dead_Cells_low_dose))
Std_ref_18B_LD_Si_4h = sd(NaRV.omit(LD_18B_4h_Si$Dead_Cells_low_dose))
Std_ref_18B_LD_Gamma_4h = sd(NaRV.omit(LD_18B_4h_Gamma$Dead_Cells_low_dose))
# 24h
Std_ref_18B_LD_Fe_24h = sd(NaRV.omit(LD_18B_24h_Fe$Dead_Cells_low_dose))
Std_ref_18B_LD_Ar_24h = sd(NaRV.omit(LD_18B_24h_Ar$Dead_Cells_low_dose))
Std_ref_18B_LD_Si_24h = sd(NaRV.omit(LD_18B_24h_Si$Dead_Cells_low_dose))
Std_ref_18B_LD_Gamma_24h = sd(NaRV.omit(LD_18B_24h_Gamma$Dead_Cells_low_dose))
#
## For high dose irradiated samples
HD_18B= Samp_18B_10p
...
####### Mean
# 4h
Mean_ref_18B_HD_Fe_4h = mean(NaRV.omit(HD_18B_4h_Fe$Dead_Cells_high_dose))
Mean_ref_18B_HD_Ar_4h = mean(NaRV.omit(HD_18B_4h_Ar$Dead_Cells_high_dose))
Mean_ref_18B_HD_Si_4h = mean(NaRV.omit(HD_18B_4h_Si$Dead_Cells_high_dose))
Mean_ref_18B_HD_Gamma_4h = mean(NaRV.omit(HD_18B_4h_Gamma$Dead_Cells_high_dose))
# 24h
Mean_ref_18B_HD_Fe_24h = mean(NaRV.omit(HD_18B_24h_Fe$Dead_Cells_high_dose))
Mean_ref_18B_HD_Ar_24h = mean(NaRV.omit(HD_18B_24h_Ar$Dead_Cells_high_dose))
Mean_ref_18B_HD_Si_24h = mean(NaRV.omit(HD_18B_24h_Si$Dead_Cells_high_dose))
Mean_ref_18B_HD_Gamma_24h = mean(NaRV.omit(HD_18B_24h_Gamma$Dead_Cells_high_dose))
####### sd
# 4h
Std_ref_18B_HD_Fe_4h = sd(NaRV.omit(HD_18B_4h_Fe$Dead_Cells_high_dose))
Std_ref_18B_HD_Ar_4h = sd(NaRV.omit(HD_18B_4h_Ar$Dead_Cells_high_dose))
Std_ref_18B_HD_Si_4h = sd(NaRV.omit(HD_18B_4h_Si$Dead_Cells_high_dose))
Std_ref_18B_HD_Gamma_4h = sd(NaRV.omit(HD_18B_4h_Gamma$Dead_Cells_high_dose))
# 24h
Std_ref_18B_HD_Fe_24h = sd(NaRV.omit(HD_18B_24h_Fe$Dead_Cells_high_dose))
Std_ref_18B_HD_Ar_24h = sd(NaRV.omit(HD_18B_24h_Ar$Dead_Cells_high_dose))
Std_ref_18B_HD_Si_24h = sd(NaRV.omit(HD_18B_24h_Si$Dead_Cells_high_dose))
Std_ref_18B_HD_Gamma_24h = sd(NaRV.omit(HD_18B_24h_Gamma$Dead_Cells_high_dose))
...
Run_19A = c("Run_19A_Set_1", "Run_19A_Set_2", "Run_19A_Set_3", "Run_19A_Set_4")
#
Samp_18B_allp = Corrected_Cell_Death %>% filter(Corrected_Cell_Death$Run_set %in% Run_18B)
Samp_19A_allp = Corrected_Cell_Death %>% filter(Corrected_Cell_Death$Run_set %in% Run_19A)
#
## For Controls 
Controls_allp_18B= Samp_18B_allp
...
## z-score correction
# 4h
control_allp_18B_4h_Fe$Dead_Cells_0 = ((((control_allp_18B_4h_Fe$Dead_Cells_0 - Mean_ref_18B_Cont_Fe_4h)/Std_ref_18B_Cont_Fe_4h)*Std_ref_19A_Cont_Fe_4h) + Mean_ref_19A_Cont_Fe_4h)

control_allp_18B_4h_Ar$Dead_Cells_0 = ((((control_allp_18B_4h_Ar$Dead_Cells_0 - Mean_ref_18B_Cont_Ar_4h)/Std_ref_18B_Cont_Ar_4h)*Std_ref_19A_Cont_Ar_4h) + Mean_ref_19A_Cont_Ar_4h) 

control_allp_18B_4h_Si$Dead_Cells_0 = ((((control_allp_18B_4h_Si$Dead_Cells_0 - Mean_ref_18B_Cont_Si_4h)/Std_ref_18B_Cont_Si_4h)*Std_ref_19A_Cont_Si_4h) + Mean_ref_19A_Cont_Si_4h)
                                          
control_allp_18B_4h_Gamma$Dead_Cells_0 = ((((control_allp_18B_4h_Gamma$Dead_Cells_0 - Mean_ref_18B_Cont_Gamma_4h)/Std_ref_18B_Cont_Gamma_4h)*Std_ref_19A_Cont_Gamma_4h) + Mean_ref_19A_Cont_Gamma_4h)

# 24h
control_allp_18B_24h_Fe$Dead_Cells_0 = ((((control_allp_18B_24h_Fe$Dead_Cells_0 - Mean_ref_18B_Cont_Fe_24h)/Std_ref_18B_Cont_Fe_24h)*Std_ref_19A_Cont_Fe_24h) + Mean_ref_19A_Cont_Fe_24h)
                                          
control_allp_18B_24h_Ar$Dead_Cells_0 = ((((control_allp_18B_24h_Ar$Dead_Cells_0 - Mean_ref_18B_Cont_Ar_24h)/Std_ref_18B_Cont_Ar_24h)*Std_ref_19A_Cont_Ar_24h) + Mean_ref_19A_Cont_Ar_24h) 

control_allp_18B_24h_Si$Dead_Cells_0 = ((((control_allp_18B_24h_Si$Dead_Cells_0 - Mean_ref_18B_Cont_Si_24h)/Std_ref_18B_Cont_Si_24h)*Std_ref_19A_Cont_Si_24h) + Mean_ref_19A_Cont_Si_24h)
                                          
control_allp_18B_24h_Gamma$Dead_Cells_0 = ((((control_allp_18B_24h_Gamma$Dead_Cells_0 - Mean_ref_18B_Cont_Gamma_24h)/Std_ref_18B_Cont_Gamma_24h)*Std_ref_19A_Cont_Gamma_24h) + Mean_ref_19A_Cont_Gamma_24h)
#
#
## For Low dose irradiated samples
LD_allp_18B= Samp_18B_allp
...
## z-score correction
# 4h
LD_allp_18B_4h_Fe$Dead_Cells_low_dose = ((((LD_allp_18B_4h_Fe$Dead_Cells_low_dose -Mean_ref_18B_LD_Fe_4h)/Std_ref_18B_LD_Fe_4h)*Std_ref_19A_LD_Fe_4h) + Mean_ref_19A_LD_Fe_4h)

LD_allp_18B_4h_Ar$Dead_Cells_low_dose = ((((LD_allp_18B_4h_Ar$Dead_Cells_low_dose -Mean_ref_18B_LD_Ar_4h)/Std_ref_18B_LD_Ar_4h)*Std_ref_19A_LD_Ar_4h) + Mean_ref_19A_LD_Ar_4h)

LD_allp_18B_4h_Si$Dead_Cells_low_dose = ((((LD_allp_18B_4h_Si$Dead_Cells_low_dose -Mean_ref_18B_LD_Si_4h)/Std_ref_18B_LD_Si_4h)*Std_ref_19A_LD_Si_4h) + Mean_ref_19A_LD_Si_4h)
                                            
LD_allp_18B_4h_Gamma$Dead_Cells_low_dose = ((((LD_allp_18B_4h_Gamma$Dead_Cells_low_dose -Mean_ref_18B_LD_Gamma_4h)/Std_ref_18B_LD_Gamma_4h)*Std_ref_19A_LD_Gamma_4h) + Mean_ref_19A_LD_Gamma_4h)
#
# 24h
LD_allp_18B_24h_Fe$Dead_Cells_low_dose = ((((LD_allp_18B_24h_Fe$Dead_Cells_low_dose -Mean_ref_18B_LD_Fe_24h)/Std_ref_18B_LD_Fe_24h)*Std_ref_19A_LD_Fe_24h) + Mean_ref_19A_LD_Fe_24h)

LD_allp_18B_24h_Ar$Dead_Cells_low_dose = ((((LD_allp_18B_24h_Ar$Dead_Cells_low_dose -Mean_ref_18B_LD_Ar_24h)/Std_ref_18B_LD_Ar_24h)*Std_ref_19A_LD_Ar_24h) + Mean_ref_19A_LD_Ar_24h)

LD_allp_18B_24h_Si$Dead_Cells_low_dose = ((((LD_allp_18B_24h_Si$Dead_Cells_low_dose -Mean_ref_18B_LD_Si_24h)/Std_ref_18B_LD_Si_24h)*Std_ref_19A_LD_Si_24h) + Mean_ref_19A_LD_Si_24h)
                                            
LD_allp_18B_24h_Gamma$Dead_Cells_low_dose = ((((LD_allp_18B_24h_Gamma$Dead_Cells_low_dose -Mean_ref_18B_LD_Gamma_24h)/Std_ref_18B_LD_Gamma_24h)*Std_ref_19A_LD_Gamma_24h) + Mean_ref_19A_LD_Gamma_24h)
#
## For high dose irradiated samples
HD_allp_18B= Samp_18B_allp
...
## z-score correction
# 4h
HD_allp_18B_4h_Fe$Dead_Cells_high_dose= ((((HD_allp_18B_4h_Fe$Dead_Cells_high_dose -Mean_ref_18B_HD_Fe_4h)/Std_ref_18B_HD_Fe_4h)*Std_ref_19A_HD_Fe_4h) + Mean_ref_19A_HD_Fe_4h)

HD_allp_18B_4h_Ar$Dead_Cells_high_dose= ((((HD_allp_18B_4h_Ar$Dead_Cells_high_dose -Mean_ref_18B_HD_Ar_4h)/Std_ref_18B_HD_Ar_4h)*Std_ref_19A_HD_Ar_4h) + Mean_ref_19A_HD_Ar_4h)

HD_allp_18B_4h_Si$Dead_Cells_high_dose= ((((HD_allp_18B_4h_Si$Dead_Cells_high_dose -Mean_ref_18B_HD_Si_4h)/Std_ref_18B_HD_Si_4h)*Std_ref_19A_HD_Si_4h) + Mean_ref_19A_HD_Si_4h)

HD_allp_18B_4h_Gamma$Dead_Cells_high_dose= ((((HD_allp_18B_4h_Gamma$Dead_Cells_high_dose -Mean_ref_18B_HD_Gamma_4h)/Std_ref_18B_HD_Gamma_4h)*Std_ref_19A_HD_Gamma_4h) + Mean_ref_19A_HD_Gamma_4h)
#
# 24h
HD_allp_18B_24h_Fe$Dead_Cells_high_dose= ((((HD_allp_18B_24h_Fe$Dead_Cells_high_dose -Mean_ref_18B_HD_Fe_24h)/Std_ref_18B_HD_Fe_24h)*Std_ref_19A_HD_Fe_24h) + Mean_ref_19A_HD_Fe_24h)

HD_allp_18B_24h_Ar$Dead_Cells_high_dose= ((((HD_allp_18B_24h_Ar$Dead_Cells_high_dose -Mean_ref_18B_HD_Ar_24h)/Std_ref_18B_HD_Ar_24h)*Std_ref_19A_HD_Ar_24h) + Mean_ref_19A_HD_Ar_24h)

HD_allp_18B_24h_Si$Dead_Cells_high_dose= ((((HD_allp_18B_24h_Si$Dead_Cells_high_dose -Mean_ref_18B_HD_Si_24h)/Std_ref_18B_HD_Si_24h)*Std_ref_19A_HD_Si_24h) + Mean_ref_19A_HD_Si_24h)

HD_allp_18B_24h_Gamma$Dead_Cells_high_dose= ((((HD_allp_18B_24h_Gamma$Dead_Cells_high_dose -Mean_ref_18B_HD_Gamma_24h)/Std_ref_18B_HD_Gamma_24h) *Std_ref_19A_HD_Gamma_24h) + Mean_ref_19A_HD_Gamma_24h)
#
### Now we regroup everything
## regroup 18B
Cont_18B_All_rad= bind_rows(control_allp_18B_4h_Fe,  control_allp_18B_24h_Fe, 
...
HD_18B_All_rad= bind_rows(HD_allp_18B_4h_Fe,  HD_allp_18B_24h_Fe, 
                           ...
                           HD_allp_18B_4h_Gamma,  HD_allp_18B_24h_Gamma)
#
Control_18B_meta_use= Cont_18B_All_rad[,grepl("Sample_ID|Duplicate|Run_set|Timepoint|Radiation_type|Dead",colnames(Cont_18B_All_rad))]
LD_control_18B=merge(LD_18B_All_rad, Control_18B_meta_use, by=c("Sample_ID", "Duplicate", "Run_set", "Timepoint", "Radiation_type") )
colnames(LD_control_18B)[colnames(LD_control_18B)=="Dead_Cells_low_dose"]<- "Dead_Cells"
LD_control_18B$Dose_relative="Low dose"
HD_control_18B=merge(HD_18B_All_rad, Control_18B_meta_use, by=c("Sample_ID", "Duplicate", "Run_set", "Timepoint", "Radiation_type") )
colnames(HD_control_18B)[colnames(HD_control_18B)=="Dead_Cells_high_dose"]<- "Dead_Cells"
HD_control_18B$Dose_relative="High dose"
Cont_18B_All_rad$Dead_Cells = Cont_18B_All_rad$Dead_Cells_0
Cont_18B_All_rad$Dose_relative = "0 Gy control"
LD_HD_18B=bind_rows(LD_control_18B, HD_control_18B, Cont_18B_All_rad)
#
#19A was used as reference: data were not modified. We format the table to fit the same structure as 18B
...
colnames(Samp_19A_allp_LD)[colnames(Samp_19A_allp_LD)=="Dead_Cells_low_dose"]<- "Dead_Cells"
Samp_19A_allp_LD$Dose_relative="Low dose"
#
Samp_19A_allp_HD = Samp_19A_allp
Samp_19A_allp_HD$Dead_Cells_low_dose = NULL
colnames(Samp_19A_allp_HD)[colnames(Samp_19A_allp_HD)=="Dead_Cells_high_dose"]<- "Dead_Cells"
Samp_19A_allp_HD$Dose_relative="High dose"
#
Samp_19A_allp_cont = Samp_19A_allp
Samp_19A_allp_cont$Dead_Cells_low_dose = NULL
Samp_19A_allp_cont$Dead_Cells_high_dose = NULL
Samp_19A_allp_cont$Dead_Cells = Samp_19A_allp_cont$Dead_Cells_0
Samp_19A_allp_cont$Dose_relative="0 Gy control"
#
Samp_plot_19A_allp= bind_rows(Samp_19A_allp_LD, Samp_19A_allp_HD, Samp_19A_allp_cont)
#
################### regroup 18B and 19A 
All_18B_19A = bind_rows(LD_HD_18B, Samp_plot_19A_allp)
All_18B_19A$Dead_Cells_Norm = All_18B_19A$Dead_Cells / All_18B_19A$Dead_Cells_0
All_18B_19A$Timepoint=factor(All_18B_19A$Timepoint, levels=c("4h", "24h"))
All_18B_19A$Time_dose=paste(All_18B_19A$Timepoint, All_18B_19A$Dose_relative, sep = " ")
All_18B_19A$Time_dose=factor(All_18B_19A$Time_dose, levels=c("4h 0 Gy control",  "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))
All_18B_19A$Radiation_type=factor(All_18B_19A$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))

## Graph Dead_Cells vs Run_Set, color code radiation + a panel per time point without normalization
graph_without_Norm <- ggplot(All_18B_19A, aes(x=Time_dose, y=Dead_Cells)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Correction_step2_No_Norm_Dead_Cells_per_Run_Set_18B_19A.pdf", graph_without_Norm, width=25, height=7)
#
## Graph Dead_Cells vs Run_Set, color code radiation + a panel per time point with normalization
dose_relative= c("Low dose", "High dose")
All_18B_19A_Norm = All_18B_19A %>% filter(All_18B_19A$Dose_relative %in% dose_relative)
All_18B_19A_Norm$Time_dose=factor(All_18B_19A_Norm$Time_dose, levels=c("4h 0 Gy control",  "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))
All_18B_19A_Norm$Radiation_type=factor(All_18B_19A_Norm$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
graph_with_Norm <- ggplot(All_18B_19A_Norm, aes(x=Time_dose, y=Dead_Cells_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Correction_step2_Norm_Dead_Cells_per_Run_Set_18B_19A.pdf", graph_with_Norm, width=25, height=7)
...
All_18B_19A_10p$Radiation_type=factor(All_18B_19A_10p$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
# without normalization
graph_without_Norm <- ggplot(All_18B_19A_10p, aes(x=Time_dose, y=Dead_Cells)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Correction_step2_No_Norm_Dead_Cells_per_Run_Set_18B_19A_10p_overlap.pdf", graph_without_Norm, width=25, height=7)
#
# with normalization
dose_relative= c("Low dose", "High dose")
All_18B_19A_Norm_10p = All_18B_19A_10p %>% filter(All_18B_19A_10p$Dose_relative %in% dose_relative)
All_18B_19A_Norm_10p$Time_dose=factor(All_18B_19A_Norm_10p$Time_dose, levels=c("4h 0 Gy control",  "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))
All_18B_19A_Norm_10p$Radiation_type=factor(All_18B_19A_Norm_10p$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
graph_with_Norm <- ggplot(All_18B_19A_Norm_10p, aes(x=Time_dose, y=Dead_Cells_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Correction_step2_Norm_Dead_Cells_per_Run_Set_18B_19A_10p_overlap.pdf", graph_with_Norm, width=25, height=7)


############ Now we do exaclty the same but for 19A and 19C
# Select the 10 people that overlap in these two run
Subject_19CS1_19AS1 = c(1589,1590,1591,1592,1593,1594,1595,1596,1597)
CD_correct_19A_19C_10p = Corrected_Cell_Death %>% filter(Corrected_Cell_Death$Sample_ID %in% Subject_19CS1_19AS1 )
#
#### Z-score for 19A
Samp_19A_10p = CD_correct_19A_19C_10p %>% filter(CD_correct_19A_19C_10p$Run_set =="Run_19A_Set_1")
## For Controls 
Controls_19A= Samp_19A_10p
Controls_19A$Dead_Cells_low_dose=NULL
Controls_19A$Dead_Cells_high_dose=NULL
...
#### Z-score for 19C
Samp_19C_10p = CD_correct_19C_19C_10p %>% filter(CD_correct_19C_19C_10p$Run_set =="Run_19C_Set_2")
## For Controls 
Controls_19C= Samp_19C_10p
...
####### Mean
# 4h
Mean_ref_19C_Cont_Fe_4h = mean(NaRV.omit(control_19C_4h_Fe$Dead_Cells_0))
Mean_ref_19C_Cont_Ar_4h = mean(NaRV.omit(control_19C_4h_Ar$Dead_Cells_0))
Mean_ref_19C_Cont_Si_4h = mean(NaRV.omit(control_19C_4h_Si$Dead_Cells_0))
Mean_ref_19C_Cont_Gamma_4h = mean(NaRV.omit(control_19C_4h_Gamma$Dead_Cells_0))
# 24h
Mean_ref_19C_Cont_Fe_24h = mean(NaRV.omit(control_19C_24h_Fe$Dead_Cells_0))
Mean_ref_19C_Cont_Ar_24h = mean(NaRV.omit(control_19C_24h_Ar$Dead_Cells_0))
Mean_ref_19C_Cont_Si_24h = mean(NaRV.omit(control_19C_24h_Si$Dead_Cells_0))
Mean_ref_19C_Cont_Gamma_24h = mean(NaRV.omit(control_19C_24h_Gamma$Dead_Cells_0))
####### sd
# 4h
Std_ref_19C_Cont_Fe_4h = sd(NaRV.omit(control_19C_4h_Fe$Dead_Cells_0))
Std_ref_19C_Cont_Ar_4h = sd(NaRV.omit(control_19C_4h_Ar$Dead_Cells_0))
Std_ref_19C_Cont_Si_4h = sd(NaRV.omit(control_19C_4h_Si$Dead_Cells_0))
Std_ref_19C_Cont_Gamma_4h = sd(NaRV.omit(control_19C_4h_Gamma$Dead_Cells_0))
# 24h
Std_ref_19C_Cont_Fe_24h = sd(NaRV.omit(control_19C_24h_Fe$Dead_Cells_0))
Std_ref_19C_Cont_Ar_24h = sd(NaRV.omit(control_19C_24h_Ar$Dead_Cells_0))
Std_ref_19C_Cont_Si_24h = sd(NaRV.omit(control_19C_24h_Si$Dead_Cells_0))
Std_ref_19C_Cont_Gamma_24h = sd(NaRV.omit(control_19C_24h_Gamma$Dead_Cells_0))
#
#
## For Low dose irradiated samples
LD_19C= Samp_19C_10p
...
####### Mean
# 4h
Mean_ref_19C_LD_Fe_4h = mean(NaRV.omit(LD_19C_4h_Fe$Dead_Cells_low_dose))
Mean_ref_19C_LD_Ar_4h = mean(NaRV.omit(LD_19C_4h_Ar$Dead_Cells_low_dose))
Mean_ref_19C_LD_Si_4h = mean(NaRV.omit(LD_19C_4h_Si$Dead_Cells_low_dose))
Mean_ref_19C_LD_Gamma_4h = mean(NaRV.omit(LD_19C_4h_Gamma$Dead_Cells_low_dose))
# 24h
Mean_ref_19C_LD_Fe_24h = mean(NaRV.omit(LD_19C_24h_Fe$Dead_Cells_low_dose))
Mean_ref_19C_LD_Ar_24h = mean(NaRV.omit(LD_19C_24h_Ar$Dead_Cells_low_dose))
Mean_ref_19C_LD_Si_24h = mean(NaRV.omit(LD_19C_24h_Si$Dead_Cells_low_dose))
Mean_ref_19C_LD_Gamma_24h = mean(NaRV.omit(LD_19C_24h_Gamma$Dead_Cells_low_dose))
####### sd
# 4h
Std_ref_19C_LD_Fe_4h = sd(NaRV.omit(LD_19C_4h_Fe$Dead_Cells_low_dose))
Std_ref_19C_LD_Ar_4h = sd(NaRV.omit(LD_19C_4h_Ar$Dead_Cells_low_dose))
Std_ref_19C_LD_Si_4h = sd(NaRV.omit(LD_19C_4h_Si$Dead_Cells_low_dose))
Std_ref_19C_LD_Gamma_4h = sd(NaRV.omit(LD_19C_4h_Gamma$Dead_Cells_low_dose))
# 24h
Std_ref_19C_LD_Fe_24h = sd(NaRV.omit(LD_19C_24h_Fe$Dead_Cells_low_dose))
Std_ref_19C_LD_Ar_24h = sd(NaRV.omit(LD_19C_24h_Ar$Dead_Cells_low_dose))
Std_ref_19C_LD_Si_24h = sd(NaRV.omit(LD_19C_24h_Si$Dead_Cells_low_dose))
Std_ref_19C_LD_Gamma_24h = sd(NaRV.omit(LD_19C_24h_Gamma$Dead_Cells_low_dose))
#
## For high dose irradiated samples
HD_19C= Samp_19C_10p
...
####### Mean
# 4h
Mean_ref_19C_HD_Fe_4h = mean(NaRV.omit(HD_19C_4h_Fe$Dead_Cells_high_dose))
Mean_ref_19C_HD_Ar_4h = mean(NaRV.omit(HD_19C_4h_Ar$Dead_Cells_high_dose))
Mean_ref_19C_HD_Si_4h = mean(NaRV.omit(HD_19C_4h_Si$Dead_Cells_high_dose))
Mean_ref_19C_HD_Gamma_4h = mean(NaRV.omit(HD_19C_4h_Gamma$Dead_Cells_high_dose))
# 24h
Mean_ref_19C_HD_Fe_24h = mean(NaRV.omit(HD_19C_24h_Fe$Dead_Cells_high_dose))
Mean_ref_19C_HD_Ar_24h = mean(NaRV.omit(HD_19C_24h_Ar$Dead_Cells_high_dose))
Mean_ref_19C_HD_Si_24h = mean(NaRV.omit(HD_19C_24h_Si$Dead_Cells_high_dose))
Mean_ref_19C_HD_Gamma_24h = mean(NaRV.omit(HD_19C_24h_Gamma$Dead_Cells_high_dose))
####### sd
# 4h
Std_ref_19C_HD_Fe_4h = sd(NaRV.omit(HD_19C_4h_Fe$Dead_Cells_high_dose))
Std_ref_19C_HD_Ar_4h = sd(NaRV.omit(HD_19C_4h_Ar$Dead_Cells_high_dose))
Std_ref_19C_HD_Si_4h = sd(NaRV.omit(HD_19C_4h_Si$Dead_Cells_high_dose))
Std_ref_19C_HD_Gamma_4h = sd(NaRV.omit(HD_19C_4h_Gamma$Dead_Cells_high_dose))
# 24h
Std_ref_19C_HD_Fe_24h = sd(NaRV.omit(HD_19C_24h_Fe$Dead_Cells_high_dose))
Std_ref_19C_HD_Ar_24h = sd(NaRV.omit(HD_19C_24h_Ar$Dead_Cells_high_dose))
Std_ref_19C_HD_Si_24h = sd(NaRV.omit(HD_19C_24h_Si$Dead_Cells_high_dose))
Std_ref_19C_HD_Gamma_24h = sd(NaRV.omit(HD_19C_24h_Gamma$Dead_Cells_high_dose))
...
Run_19A = c("Run_19A_Set_1", "Run_19A_Set_2", "Run_19A_Set_3", "Run_19A_Set_4")
#
Samp_19C_allp = Corrected_Cell_Death %>% filter(Corrected_Cell_Death$Run_set %in% Run_19C)
Samp_19A_allp = Corrected_Cell_Death %>% filter(Corrected_Cell_Death$Run_set %in% Run_19A)
#
## For Controls 
Controls_allp_19C= Samp_19C_allp
...
## z-score correction
# 4h
control_allp_19C_4h_Fe$Dead_Cells_0 = ((((control_allp_19C_4h_Fe$Dead_Cells_0 - Mean_ref_19C_Cont_Fe_4h)/Std_ref_19C_Cont_Fe_4h)*Std_ref_19A_Cont_Fe_4h) + Mean_ref_19A_Cont_Fe_4h)

control_allp_19C_4h_Ar$Dead_Cells_0 = ((((control_allp_19C_4h_Ar$Dead_Cells_0 - Mean_ref_19C_Cont_Ar_4h)/Std_ref_19C_Cont_Ar_4h)*Std_ref_19A_Cont_Ar_4h) + Mean_ref_19A_Cont_Ar_4h) 

control_allp_19C_4h_Si$Dead_Cells_0 = ((((control_allp_19C_4h_Si$Dead_Cells_0 - Mean_ref_19C_Cont_Si_4h)/Std_ref_19C_Cont_Si_4h)*Std_ref_19A_Cont_Si_4h) + Mean_ref_19A_Cont_Si_4h)
                                          
control_allp_19C_4h_Gamma$Dead_Cells_0 = ((((control_allp_19C_4h_Gamma$Dead_Cells_0 - Mean_ref_19C_Cont_Gamma_4h)/Std_ref_19C_Cont_Gamma_4h)*Std_ref_19A_Cont_Gamma_4h) + Mean_ref_19A_Cont_Gamma_4h)

# 24h
control_allp_19C_24h_Fe$Dead_Cells_0 = ((((control_allp_19C_24h_Fe$Dead_Cells_0 - Mean_ref_19C_Cont_Fe_24h)/Std_ref_19C_Cont_Fe_24h)*Std_ref_19A_Cont_Fe_24h) + Mean_ref_19A_Cont_Fe_24h)
                                          
control_allp_19C_24h_Ar$Dead_Cells_0 = ((((control_allp_19C_24h_Ar$Dead_Cells_0 - Mean_ref_19C_Cont_Ar_24h)/Std_ref_19C_Cont_Ar_24h)*Std_ref_19A_Cont_Ar_24h) + Mean_ref_19A_Cont_Ar_24h) 

control_allp_19C_24h_Si$Dead_Cells_0 = ((((control_allp_19C_24h_Si$Dead_Cells_0 - Mean_ref_19C_Cont_Si_24h)/Std_ref_19C_Cont_Si_24h)*Std_ref_19A_Cont_Si_24h) + Mean_ref_19A_Cont_Si_24h)
                                          
control_allp_19C_24h_Gamma$Dead_Cells_0 = ((((control_allp_19C_24h_Gamma$Dead_Cells_0 - Mean_ref_19C_Cont_Gamma_24h)/Std_ref_19C_Cont_Gamma_24h)*Std_ref_19A_Cont_Gamma_24h) + Mean_ref_19A_Cont_Gamma_24h)
#
#
## For Low dose irradiated samples
LD_allp_19C= Samp_19C_allp
...
## z-score correction
# 4h
LD_allp_19C_4h_Fe$Dead_Cells_low_dose = ((((LD_allp_19C_4h_Fe$Dead_Cells_low_dose -Mean_ref_19C_LD_Fe_4h)/Std_ref_19C_LD_Fe_4h)*Std_ref_19A_LD_Fe_4h) + Mean_ref_19A_LD_Fe_4h)

LD_allp_19C_4h_Ar$Dead_Cells_low_dose = ((((LD_allp_19C_4h_Ar$Dead_Cells_low_dose -Mean_ref_19C_LD_Ar_4h)/Std_ref_19C_LD_Ar_4h)*Std_ref_19A_LD_Ar_4h) + Mean_ref_19A_LD_Ar_4h)

LD_allp_19C_4h_Si$Dead_Cells_low_dose = ((((LD_allp_19C_4h_Si$Dead_Cells_low_dose -Mean_ref_19C_LD_Si_4h)/Std_ref_19C_LD_Si_4h)*Std_ref_19A_LD_Si_4h) + Mean_ref_19A_LD_Si_4h)
                                            
LD_allp_19C_4h_Gamma$Dead_Cells_low_dose = ((((LD_allp_19C_4h_Gamma$Dead_Cells_low_dose -Mean_ref_19C_LD_Gamma_4h)/Std_ref_19C_LD_Gamma_4h)*Std_ref_19A_LD_Gamma_4h) + Mean_ref_19A_LD_Gamma_4h)
#
# 24h
LD_allp_19C_24h_Fe$Dead_Cells_low_dose = ((((LD_allp_19C_24h_Fe$Dead_Cells_low_dose -Mean_ref_19C_LD_Fe_24h)/Std_ref_19C_LD_Fe_24h)*Std_ref_19A_LD_Fe_24h) + Mean_ref_19A_LD_Fe_24h)

LD_allp_19C_24h_Ar$Dead_Cells_low_dose = ((((LD_allp_19C_24h_Ar$Dead_Cells_low_dose -Mean_ref_19C_LD_Ar_24h)/Std_ref_19C_LD_Ar_24h)*Std_ref_19A_LD_Ar_24h) + Mean_ref_19A_LD_Ar_24h)

LD_allp_19C_24h_Si$Dead_Cells_low_dose = ((((LD_allp_19C_24h_Si$Dead_Cells_low_dose -Mean_ref_19C_LD_Si_24h)/Std_ref_19C_LD_Si_24h)*Std_ref_19A_LD_Si_24h) + Mean_ref_19A_LD_Si_24h)
                                            
LD_allp_19C_24h_Gamma$Dead_Cells_low_dose = ((((LD_allp_19C_24h_Gamma$Dead_Cells_low_dose -Mean_ref_19C_LD_Gamma_24h)/Std_ref_19C_LD_Gamma_24h)*Std_ref_19A_LD_Gamma_24h) + Mean_ref_19A_LD_Gamma_24h)
#
## For high dose irradiated samples
HD_allp_19C= Samp_19C_allp
...
## z-score correction
# 4h
HD_allp_19C_4h_Fe$Dead_Cells_high_dose= ((((HD_allp_19C_4h_Fe$Dead_Cells_high_dose -Mean_ref_19C_HD_Fe_4h)/Std_ref_19C_HD_Fe_4h)*Std_ref_19A_HD_Fe_4h) + Mean_ref_19A_HD_Fe_4h)

HD_allp_19C_4h_Ar$Dead_Cells_high_dose= ((((HD_allp_19C_4h_Ar$Dead_Cells_high_dose -Mean_ref_19C_HD_Ar_4h)/Std_ref_19C_HD_Ar_4h)*Std_ref_19A_HD_Ar_4h) + Mean_ref_19A_HD_Ar_4h)

HD_allp_19C_4h_Si$Dead_Cells_high_dose= ((((HD_allp_19C_4h_Si$Dead_Cells_high_dose -Mean_ref_19C_HD_Si_4h)/Std_ref_19C_HD_Si_4h)*Std_ref_19A_HD_Si_4h) + Mean_ref_19A_HD_Si_4h)

HD_allp_19C_4h_Gamma$Dead_Cells_high_dose= ((((HD_allp_19C_4h_Gamma$Dead_Cells_high_dose -Mean_ref_19C_HD_Gamma_4h)/Std_ref_19C_HD_Gamma_4h)*Std_ref_19A_HD_Gamma_4h) + Mean_ref_19A_HD_Gamma_4h)
#
# 24h
HD_allp_19C_24h_Fe$Dead_Cells_high_dose= ((((HD_allp_19C_24h_Fe$Dead_Cells_high_dose -Mean_ref_19C_HD_Fe_24h)/Std_ref_19C_HD_Fe_24h)*Std_ref_19A_HD_Fe_24h) + Mean_ref_19A_HD_Fe_24h)

HD_allp_19C_24h_Ar$Dead_Cells_high_dose= ((((HD_allp_19C_24h_Ar$Dead_Cells_high_dose -Mean_ref_19C_HD_Ar_24h)/Std_ref_19C_HD_Ar_24h)*Std_ref_19A_HD_Ar_24h) + Mean_ref_19A_HD_Ar_24h)

HD_allp_19C_24h_Si$Dead_Cells_high_dose= ((((HD_allp_19C_24h_Si$Dead_Cells_high_dose -Mean_ref_19C_HD_Si_24h)/Std_ref_19C_HD_Si_24h)*Std_ref_19A_HD_Si_24h) + Mean_ref_19A_HD_Si_24h)

HD_allp_19C_24h_Gamma$Dead_Cells_high_dose= ((((HD_allp_19C_24h_Gamma$Dead_Cells_high_dose -Mean_ref_19C_HD_Gamma_24h)/Std_ref_19C_HD_Gamma_24h) *Std_ref_19A_HD_Gamma_24h) + Mean_ref_19A_HD_Gamma_24h)
#
### Now we regroup everything
## regroup 19C
Cont_19C_All_rad= bind_rows(control_allp_19C_4h_Fe,  control_allp_19C_24h_Fe, 
...
HD_19C_All_rad= bind_rows(HD_allp_19C_4h_Fe,  HD_allp_19C_24h_Fe, 
                           ...
                           HD_allp_19C_4h_Gamma,  HD_allp_19C_24h_Gamma)
#
Control_19C_meta_use= Cont_19C_All_rad[,grepl("Sample_ID|Duplicate|Run_set|Timepoint|Radiation_type|Dead",colnames(Cont_19C_All_rad))]
LD_control_19C=merge(LD_19C_All_rad, Control_19C_meta_use, by=c("Sample_ID", "Duplicate", "Run_set", "Timepoint", "Radiation_type") )
colnames(LD_control_19C)[colnames(LD_control_19C)=="Dead_Cells_low_dose"]<- "Dead_Cells"
LD_control_19C$Dose_relative="Low dose"
HD_control_19C=merge(HD_19C_All_rad, Control_19C_meta_use, by=c("Sample_ID", "Duplicate", "Run_set", "Timepoint", "Radiation_type") )
colnames(HD_control_19C)[colnames(HD_control_19C)=="Dead_Cells_high_dose"]<- "Dead_Cells"
HD_control_19C$Dose_relative="High dose"
Cont_19C_All_rad$Dead_Cells = Cont_19C_All_rad$Dead_Cells_0
Cont_19C_All_rad$Dose_relative = "0 Gy control"
LD_HD_19C=bind_rows(LD_control_19C, HD_control_19C, Cont_19C_All_rad)
#
#19A was used as reference: data were not modified. We format the table to fit the same structure as 19C
...
################### regroup 19C and 19A 
All_19C_19A = bind_rows(LD_HD_19C, Samp_plot_19A_allp)
All_19C_19A$Dead_Cells_Norm = All_19C_19A$Dead_Cells / All_19C_19A$Dead_Cells_0
All_19C_19A$Timepoint=factor(All_19C_19A$Timepoint, levels=c("4h", "24h"))
All_19C_19A$Time_dose=paste(All_19C_19A$Timepoint, All_19C_19A$Dose_relative, sep = " ")
All_19C_19A$Time_dose=factor(All_19C_19A$Time_dose, levels=c("4h 0 Gy control",  "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))
All_19C_19A$Radiation_type=factor(All_19C_19A$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
...
## Graph Dead_Cells vs Run_Set, color code radiation + a panel per time point without normalization
graph_without_Norm <- ggplot(All_19C_19A, aes(x=Time_dose, y=Dead_Cells)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Correction_step2_No_Norm_Dead_Cells_per_Run_Set_19C_19A.pdf", graph_without_Norm, width=25, height=7)
#
## Graph Dead_Cells vs Run_Set, color code radiation + a panel per time point with normalization
dose_relative= c("Low dose", "High dose")
All_19C_19A_Norm = All_19C_19A %>% filter(All_19C_19A$Dose_relative %in% dose_relative)
All_19C_19A_Norm$Time_dose=factor(All_19C_19A_Norm$Time_dose, levels=c("4h 0 Gy control",  "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))
All_19C_19A_Norm$Radiation_type=factor(All_19C_19A_Norm$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
graph_with_Norm <- ggplot(All_19C_19A_Norm, aes(x=Time_dose, y=Dead_Cells_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Correction_step2_Norm_Dead_Cells_per_Run_Set_19C_19A.pdf", graph_with_Norm, width=25, height=7)


########## Now we plot the same two latest plots but for the 10 subjects that overlap in 19C and 19A just to check the correction worked well 
All_19C_19A_10p = All_19C_19A %>% filter(All_19C_19A$Sample_ID %in% Subject_19CS2_19AS1)
All_19C_19A_10p$Time_dose=factor(All_19C_19A_10p$Time_dose, levels=c("4h 0 Gy control",  "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))
All_19C_19A_10p$Radiation_type=factor(All_19C_19A_10p$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
# without normalization
graph_without_Norm <- ggplot(All_19C_19A_10p, aes(x=Time_dose, y=Dead_Cells)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Correction_step2_No_Norm_Dead_Cells_per_Run_Set_19C_19A_10p_overlap.pdf", graph_without_Norm, width=25, height=7)
#
# with normalization
dose_relative= c("Low dose", "High dose")
All_19C_19A_Norm_10p = All_19C_19A_10p %>% filter(All_19C_19A_10p$Dose_relative %in% dose_relative)
All_19C_19A_Norm_10p$Time_dose=factor(All_19C_19A_Norm_10p$Time_dose, levels=c("4h 0 Gy control",  "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))
All_19C_19A_Norm_10p$Radiation_type=factor(All_19C_19A_Norm_10p$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
graph_with_Norm <- ggplot(All_19C_19A_Norm_10p, aes(x=Time_dose, y=Dead_Cells_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Correction_step2_Norm_Dead_Cells_per_Run_Set_19C_19A_10p_overlap.pdf", graph_with_Norm, width=25, height=7)


#####################################################################################################
###### Now we regroup data 18B/19A and 19C/19A after the final step of the correction ###############
#####################################################################################################
All_Corrected_CD=bind_rows(All_18B_19A, All_19C_19A)
All_Corrected_CD=unique(All_Corrected_CD) # use unique function because we have 19A data in double otherwise
All_Corrected_CD$Dead_Cells_Norm = NULL
All_Corrected_CD$Rad_dose_Gy = NULL
All_Corrected_CD$Time_dose = NULL
...
colnames(Ox_Stress_extra_24h)[colnames(Ox_Stress_extra_24h)=="Fe_Live_CR_ledian_0_24h"] <- "Fe_Live_CR_median_0"
colnames(Ox_Stress_extra_24h)[colnames(Ox_Stress_extra_24h)=="Fe_Live_CR_median_1_24h"] <- "Fe_Live_CR_median_1"
colnames(Ox_Stress_extra_24h)[colnames(Ox_Stress_extra_24h)=="Fe_Live_CR_median_3_24h"] <- "Fe_Live_CR_median_3"
colnames(Ox_Stress_extra_24h)[colnames(Ox_Stress_extra_24h)=="Ar_Live_CR_median_0_24h"] <- "Ar_Live_CR_median_0"
colnames(Ox_Stress_extra_24h)[colnames(Ox_Stress_extra_24h)=="Ar_Live_CR_median_1_24h"] <- "Ar_Live_CR_median_1"
colnames(Ox_Stress_extra_24h)[colnames(Ox_Stress_extra_24h)=="Ar_Live_CR_median_3_24h"] <- "Ar_Live_CR_median_3"
colnames(Ox_Stress_extra_24h)[colnames(Ox_Stress_extra_24h)=="Si_Live_CR_median_0_24h"] <- "Si_Live_CR_median_0"
colnames(Ox_Stress_extra_24h)[colnames(Ox_Stress_extra_24h)=="Si_Live_CR_median_1_24h"] <- "Si_Live_CR_median_1"
colnames(Ox_Stress_extra_24h)[colnames(Ox_Stress_extra_24h)=="Si_Live_CR_median_3_24h"] <- "Si_Live_CR_median_3"
colnames(Ox_Stress_extra_24h)[colnames(Ox_Stress_extra_24h)=="Gamma_Live_CR_median_0_24h"] <- "Gamma_Live_CR_median_0"
colnames(Ox_Stress_extra_24h)[colnames(Ox_Stress_extra_24h)=="Gamma_Live_CR_median_01_24h"] <- "Gamma_Live_CR_median_01"
colnames(Ox_Stress_extra_24h)[colnames(Ox_Stress_extra_24h)=="Gamma_Live_CR_median_1_24h"] <- "Gamma_Live_CR_median_1"
...
# For Gamma we rename 19C_set3 and 19C_Set4 as respectively 18B_Set1 and 18B_Set2 (since they are the same subjects: easier for the upcoming analyses)
All_Ox_Stress_Raw$Run_set[All_Ox_Stress_Raw$Run_set == "Run_19A_Set_3"] <- "Run_18B_Set_1"
All_Ox_Stress_Raw$Run_set[All_Ox_Stress_Raw$Run_set == "Run_19A_Set_4"] <- "Run_18B_Set_2"
#
#### Formatting: creating unique name for flow data and two columns: 1 for the radiation and 1 for the dose 
OS_meta=All_Ox_Stress_Raw[,grepl("Sample_ID|Run|Age|Gender|BMI|Collection", colnames(All_Ox_Stress_Raw))]
...
## Without normalization
OS_Raw_Control = All_Ox_Stress_Raw
OS_Raw_Control$Ox_Stress_high_dose=NULL
OS_Raw_Control$Ox_Stress_low_dose=NULL
OS_Raw_Control$Ox_Stress_median_0=NULL
OS_Raw_Control$Ox_Stress_median_high_dose=NULL
OS_Raw_Control$Ox_Stress_median_low_dose=NULL
OS_Raw_Control$Dose_relative= "0 Gy control"
colnames(OS_Raw_Control)[colnames(OS_Raw_Control) == "Ox_Stress_0"] <- "Ox_Stress"
#
OS_Raw_LD = All_Ox_Stress_Raw
OS_Raw_LD$Ox_Stress_high_dose=NULL
OS_Raw_LD$Ox_Stress_0=NULL
OS_Raw_LD$Ox_Stress_median_0=NULL
OS_Raw_LD$Ox_Stress_median_high_dose=NULL
OS_Raw_LD$Ox_Stress_median_low_dose=NULL
OS_Raw_LD$Dose_relative= "Low dose"
colnames(OS_Raw_LD)[colnames(OS_Raw_LD) == "Ox_Stress_low_dose"] <- "Ox_Stress"
#
OS_Raw_HD = All_Ox_Stress_Raw
OS_Raw_HD$Ox_Stress_low_dose=NULL
OS_Raw_HD$Ox_Stress_0=NULL
OS_Raw_HD$Ox_Stress_median_0=NULL
OS_Raw_HD$Ox_Stress_median_high_dose=NULL
OS_Raw_HD$Ox_Stress_median_low_dose=NULL
OS_Raw_HD$Dose_relative= "High dose"
colnames(OS_Raw_HD)[colnames(OS_Raw_HD) == "Ox_Stress_high_dose"] <- "Ox_Stress"
#
OS_Raw_LD_HD = bind_rows(OS_Raw_LD, OS_Raw_HD, OS_Raw_Control)
OS_Raw_LD_HD$Timepoint=factor(OS_Raw_LD_HD$Timepoint, levels=c("4h", "24h"))
OS_Raw_LD_HD$Radiation_type=factor(OS_Raw_LD_HD$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
OS_Raw_LD_HD$Time_dose=paste(OS_Raw_LD_HD$Timepoint, OS_Raw_LD_HD$Dose_relative, sep = " ")
OS_Raw_LD_HD$Time_dose=factor(OS_Raw_LD_HD$Time_dose, levels=c("4h 0 Gy control", "4h Low dose", "4h High dose","24h 0 Gy control","24h Low dose", "24h High dose"))

#### For 18B and 19A (to be able to check at the end if the second step of the correction was efficient)
Run_18B_19A=c("Run_19A_Set_1", "Run_19A_Set_2", "Run_18B_Set_2", "Run_18B_Set_1", "Run_19A_Set_3","Run_19A_Set_4")
OS_Raw_LD_HD_Run = OS_Raw_LD_HD %>% filter(OS_Raw_LD_HD$Run_set %in% Run_18B_19A)

## Graph OS vs Timepoint and dose + a panel per Run_set
graph_without_Norm <- ggplot(OS_Raw_LD_HD_Run, aes(x=Time_dose, y=Ox_Stress)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Raw_OS_No_Norm_Run_18B_and_19A.pdf", graph_without_Norm, width=25, height=7)

## Graph OS vs Run_set for controls only (to check if the first step of the correction works well) color code = radiation and a panel per timepoint
OS_Raw_LD_HD_Run_Control = OS_Raw_LD_HD_Run %>% filter(OS_Raw_LD_HD_Run$Dose_relative == "0 Gy control")
OS_Raw_LD_HD_Run_Control$Timepoint=factor(OS_Raw_LD_HD_Run_Control$Timepoint, levels=c("4h", "24h"))
OS_Raw_LD_HD_Run_Control$Radiation_type=factor(OS_Raw_LD_HD_Run_Control$Radiation_type, levels=c("Gamma", "Si", "Ar", "Fe"))
Run_rad <- ggplot(OS_Raw_LD_HD_Run_Control, aes(x=Run_set, y=Ox_Stress)) + geom_boxplot(aes(fill=Radiation_type))
Run_rad <- Run_rad + facet_grid(. ~ Timepoint) + theme_gray() + ylim(0,7)
ggsave("Raw_OS_No_Norm_per_Run_Set_18B_19A.pdf", Run_rad, width=25, height=7)

#### For the 10p that overlap only 
Subject_18BS2_19AS1 = c(1214, 1215,1216,1217,1218,1219,1220,1221,1222,1223)
OS_Raw_LD_HD_10p = OS_Raw_LD_HD %>% filter(OS_Raw_LD_HD$Sample_ID %in% Subject_18BS2_19AS1)
# #
OS_Raw_LD_HD_10p$Timepoint=factor(OS_Raw_LD_HD_10p$Timepoint, levels=c("4h", "24h"))
OS_Raw_LD_HD_10p$Radiation_type=factor(OS_Raw_LD_HD_10p$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
OS_Raw_LD_HD_10p$Time_dose=paste(OS_Raw_LD_HD_10p$Timepoint, OS_Raw_LD_HD_10p$Dose_relative, sep = " ")
OS_Raw_LD_HD_10p$Time_dose=factor(OS_Raw_LD_HD_10p$Time_dose, levels=c("4h 0 Gy control", "4h Low dose", "4h High dose","24h 0 Gy control","24h Low dose", "24h High dose"))

graph_without_Norm <- ggplot(OS_Raw_LD_HD_10p, aes(x=Time_dose, y=Ox_Stress)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Raw_OS_No_Norm_10p_18B_19A.pdf", graph_without_Norm, width=25, height=7)


#### For 19C and 19A (to be able to check at the end if the second step of the correction was efficient)
Run_19C_19A=c("Run_19A_Set_1", "Run_19A_Set_2", "Run_19C_Set_2", "Run_19C_Set_1", "Run_19A_Set_3","Run_19A_Set_4")
OS_Raw_LD_HD_Run = OS_Raw_LD_HD %>% filter(OS_Raw_LD_HD$Run_set %in% Run_19C_19A)

## Graph OS vs Timepoint and dose + a panel per Run_set
graph_without_Norm <- ggplot(OS_Raw_LD_HD_Run, aes(x=Time_dose, y=Ox_Stress)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Raw_OS_No_Norm_Run_19C_and_19A.pdf", graph_without_Norm, width=25, height=7)

## Graph OS vs Run_set for controls only (to check if the first step of the correction works well) color code = radiation and a panel per timepoint
OS_Raw_LD_HD_Run_Control = OS_Raw_LD_HD_Run %>% filter(OS_Raw_LD_HD_Run$Dose_relative == "0 Gy control")
OS_Raw_LD_HD_Run_Control$Timepoint=factor(OS_Raw_LD_HD_Run_Control$Timepoint, levels=c("4h", "24h"))
OS_Raw_LD_HD_Run_Control$Radiation_type=factor(OS_Raw_LD_HD_Run_Control$Radiation_type, levels=c("Gamma", "Si", "Ar", "Fe"))
OS_rad <- ggplot(OS_Raw_LD_HD_Run_Control, aes(x=Run_set, y=Ox_Stress)) + geom_boxplot(aes(fill=Radiation_type))
Run_rad <- Run_rad + facet_grid(. ~ Timepoint) + theme_gray() + ylim(0,7)
ggsave("Raw_OS_No_Norm_per_Run_Set_19C_19A.pdf", Run_rad, width=25, height=7)

#### For the 10p that overlap only 
Subject_19CS1_19AS1 =  c(1589,1590,1591,1592,1593,1594,1595,1596,1597)
OS_Raw_LD_HD_10p = OS_Raw_LD_HD %>% filter(OS_Raw_LD_HD$Sample_ID %in% Subject_19CS1_19AS1)
# #
OS_Raw_LD_HD_10p$Timepoint=factor(OS_Raw_LD_HD_10p$Timepoint, levels=c("4h", "24h"))
OS_Raw_LD_HD_10p$Radiation_type=factor(OS_Raw_LD_HD_10p$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
OS_Raw_LD_HD_10p$Time_dose=paste(OS_Raw_LD_HD_10p$Timepoint, OS_Raw_LD_HD_10p$Dose_relative, sep = " ")
...
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Raw_OS_No_Norm_10p_19C_19A.pdf", graph_without_Norm, width=25, height=7)

## With Normalization
OS_Raw_Norm = All_Ox_Stress_Raw
OS_Raw_Norm$OS_Norm_low_dose=OS_Raw_Norm$Ox_Stress_low_dose / OS_Raw_Norm$Ox_Stress_0
OS_Raw_Norm$OS_Norm_high_dose=OS_Raw_Norm$Ox_Stress_high_dose / OS_Raw_Norm$Ox_Stress_0
#
# 
OS_Raw_Norm_LD= OS_Raw_Norm 
OS_Raw_Norm_LD$OS_Norm_high_dose=NULL
OS_Raw_Norm_LD$Ox_Stress_high_dose=NULL
OS_Raw_Norm_LD$Ox_Stress_median_high_dose=NULL
OS_Raw_Norm_LD$Ox_Stress_low_dose=NULL
OS_Raw_Norm_LD$Ox_Stress_median_low_dose=NULL
OS_Raw_Norm_LD$Ox_Stress_0=NULL
OS_Raw_Norm_LD$Ox_Stress_median_0=NULL
OS_Raw_Norm_LD$Dose_relative= "Low dose"
colnames(OS_Raw_Norm_LD)[colnames(OS_Raw_Norm_LD) == "OS_Norm_low_dose"] <- "OS_Norm"
#
OS_Raw_Norm_HD= OS_Raw_Norm 
OS_Raw_Norm_HD$OS_Norm_low_dose=NULL
OS_Raw_Norm_HD$Ox_Stress_high_dose=NULL
OS_Raw_Norm_HD$Ox_Stress_median_high_dose=NULL
OS_Raw_Norm_HD$Ox_Stress_low_dose=NULL
OS_Raw_Norm_HD$Ox_Stress_median_low_dose=NULL
OS_Raw_Norm_HD$Ox_Stress_0=NULL
OS_Raw_Norm_HD$Ox_Stress_median_0=NULL
OS_Raw_Norm_HD$Dose_relative= "High dose"
colnames(OS_Raw_Norm_HD)[colnames(OS_Raw_Norm_HD) == "OS_Norm_high_dose"] <- "OS_Norm"
#
OS_Raw_LD_HD_Norm = bind_rows(OS_Raw_Norm_LD, OS_Raw_Norm_HD)
OS_Raw_LD_HD_Norm$Point = paste(OS_Raw_LD_HD_Norm$Radiation_type, OS_Raw_LD_HD_Norm$Timepoint, sep = '_')
OS_Raw_LD_HD_Norm$Timepoint=factor(OS_Raw_LD_HD_Norm$Timepoint, levels=c("4h", "24h"))
OS_Raw_LD_HD_Norm$Radiation_type=factor(OS_Raw_LD_HD_Norm$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
OS_Raw_LD_HD_Norm$Rad_dose=paste(OS_Raw_LD_HD_Norm$Radiation_type, OS_Raw_LD_HD_Norm$Dose_relative, sep = " ")
OS_Raw_LD_HD_Norm$Time_dose=paste(OS_Raw_LD_HD_Norm$Timepoint, OS_Raw_LD_HD_Norm$Dose_relative, sep = " ")
OS_Raw_LD_HD_Norm$Time_dose=factor(OS_Raw_LD_HD_Norm$Time_dose, levels=c("4h Low dose", "4h High dose",
                                                                 "24h Low dose", "24h High dose"))


#### For 18B and 19A (to be able to check at the end if the second step of the correction was efficient)
Run_18B_19A=c("Run_19A_Set_1", "Run_19A_Set_2", "Run_18B_Set_2", "Run_18B_Set_1", "Run_19A_Set_3","Run_19A_Set_4")
OS_Raw_LD_HD_Norm_Run = OS_Raw_LD_HD_Norm %>% filter(OS_Raw_LD_HD_Norm$Run_set %in% Run_18B_19A)

graph_with_Norm <- ggplot(OS_Raw_LD_HD_Norm_Run, aes(x=Time_dose, y=OS_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Raw_OS_Norm_Run_18B_and_19A.pdf", graph_with_Norm, width=25, height=7)

#### For 19C and 19A (to be able to check at the end if the second step of the correction was efficient)
Run_19C_19A=c("Run_19A_Set_1", "Run_19A_Set_2", "Run_19C_Set_2", "Run_19C_Set_1", "Run_19A_Set_3","Run_19A_Set_4")
OS_Raw_LD_HD_Norm_Run = OS_Raw_LD_HD_Norm %>% filter(OS_Raw_LD_HD_Norm$Run_set %in% Run_19C_19A)

graph_with_Norm <- ggplot(OS_Raw_LD_HD_Norm_Run, aes(x=Time_dose, y=OS_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Raw_OS_Norm_Run_19C_and_19A.pdf", graph_with_Norm, width=25, height=7)
...
Corrected_Ox_Stress$Ox_Stress_median_0 = NULL
Corrected_Ox_Stress$Ox_Stress_median_low_dose = NULL
Corrected_Ox_Stress$Ox_Stress_median_high_dose = NULL
...
## Without normalization
# control
OS_Correct1_Control = Corrected_Ox_Stress[,grepl("Ox_Stress_0|Sample|Run_set|Duplicate|Timepoint|Radiation_type|Age|Gender|BMI",colnames(Corrected_Ox_Stress))]
OS_Correct1_Control$Dose_relative= "0 Gy control"
colnames(OS_Correct1_Control)[colnames(OS_Correct1_Control) == "Ox_Stress_0"] <- "Ox_Stress"
# Low dose
OS_Correct1_LD = Corrected_Ox_Stress[,grepl("Ox_Stress_low|Sample|Run_set|Duplicate|Timepoint|Radiation_type|Age|Gender|BMI",colnames(Corrected_Ox_Stress))]
OS_Correct1_LD$Dose_relative= "Low dose"
colnames(OS_Correct1_LD)[colnames(OS_Correct1_LD) == "Ox_Stress_low_dose"] <- "Ox_Stress"
# High dose
OS_Correct1_HD = Corrected_Ox_Stress[,grepl("Ox_Stress_high|Sample|Run_set|Duplicate|Timepoint|Radiation_type|Age|Gender|BMI",colnames(Corrected_Ox_Stress))]
OS_Correct1_HD$Dose_relative= "High dose"
colnames(OS_Correct1_HD)[colnames(OS_Correct1_HD) == "Ox_Stress_high_dose"] <- "Ox_Stress"
## regroup no normalization
OS_Correct1_LD_HD = bind_rows(OS_Correct1_LD, OS_Correct1_HD, OS_Correct1_Control)
OS_Correct1_LD_HD$Radiation_type=factor(OS_Correct1_LD_HD$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
OS_Correct1_LD_HD$Time_dose=paste(OS_Correct1_LD_HD$Timepoint, OS_Correct1_LD_HD$Dose_relative, sep = " ")
OS_Correct1_LD_HD$Time_dose=factor(OS_Correct1_LD_HD$Time_dose, levels=c("4h 0 Gy control", "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))

#### For Run 18B and 19A 
Run_18B_19A=c("Run_19A_Set_1", "Run_19A_Set_2", "Run_18B_Set_2", "Run_18B_Set_1", "Run_19A_Set_3", "Run_19A_Set_4")
OS_Correct1_LD_HD_Run = OS_Correct1_LD_HD %>% filter(OS_Correct1_LD_HD$Run_set %in% Run_18B_19A)
## Graph OS vs Time point/dose + a panel per Radiation 
graph_without_Norm <- ggplot(OS_Correct1_LD_HD_Run, aes(x=Time_dose, y=Ox_Stress)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Correction_OS_step1_No_Norm_Run_18B_19A.pdf", graph_without_Norm, width=25, height=7)
#
## Graph OS vs Run_Set, color code radiation + a panel per time point
OS_Correct1_LD_HD_Run_Control = OS_Correct1_LD_HD_Run %>% filter(OS_Correct1_LD_HD_Run$Dose_relative == "0 Gy control")
OS_Correct1_LD_HD_Run_Control$OS_Correct1_LD_HD_Run_Control=factor(OS_Correct1_LD_HD_Run_Control$OS_Correct1_LD_HD_Run_Control, levels=c("4h", "24h"))
OS_Correct1_LD_HD_Run_Control$Radiation_type=factor(OS_Correct1_LD_HD_Run_Control$Radiation_type, levels=c("Gamma","Si", "Ar", "Fe"))
Run_rad <- ggplot(OS_Correct1_LD_HD_Run_Control, aes(x=Run_set, y=Ox_Stress)) + geom_boxplot(aes(fill=Radiation_type))
Run_rad <- Run_rad + facet_grid(. ~ Timepoint) + theme_gray() + ylim(0,7)
ggsave("Correction_step1_No_Norm_OS_per_Run_Set_18B_19A.pdf", Run_rad, width=25, height=7)

### 10p that overlap
OS_Correct1_LD_HD_Run_10p = OS_Correct1_LD_HD_Run %>% filter(OS_Correct1_LD_HD_Run$Sample_ID %in% Subject_18BS2_19AS1)
OS_Correct1_LD_HD_Run_10p$Radiation_type=factor(OS_Correct1_LD_HD_Run_10p$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
OS_Correct1_LD_HD_Run_10p$Time_dose=paste(OS_Correct1_LD_HD_Run_10p$Timepoint, OS_Correct1_LD_HD_Run_10p$Dose_relative, sep = " ")
OS_Correct1_LD_HD_Run_10p$Time_dose=factor(OS_Correct1_LD_HD_Run_10p$Time_dose, levels=c("4h 0 Gy control", "4h Low dose", "4h High dose","24h 0 Gy control","24h Low dose", "24h High dose"))
#
graph_without_Norm <- ggplot(OS_Correct1_LD_HD_Run_10p, aes(x=Time_dose, y=Ox_Stress)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Correction_1_No_Norm_10p_18B_19A.pdf", graph_without_Norm, width=25, height=7)
...
#### For Run 19C and 19A 
Run_19C_19A=c("Run_19A_Set_1", "Run_19A_Set_2", "Run_19C_Set_2", "Run_19C_Set_1", "Run_19A_Set_3", "Run_19A_Set_4")
OS_Correct1_LD_HD_Run = OS_Correct1_LD_HD %>% filter(OS_Correct1_LD_HD$Run_set %in% Run_19C_19A)
## Graph OS vs Time point/dose + a panel per Radiation 
graph_without_Norm <- ggplot(OS_Correct1_LD_HD_Run, aes(x=Time_dose, y=Ox_Stress)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("CorrectioN_OS_step1_No_Norm_Run_19C_19A.pdf", graph_without_Norm, width=25, height=7)
#
## Graph OS vs Run_Set, color code radiation + a panel per time point
OS_Correct1_LD_HD_Run_Control = OS_Correct1_LD_HD_Run %>% filter(OS_Correct1_LD_HD_Run$Dose_relative == "0 Gy control")
OS_Correct1_LD_HD_Run_Control$Timepoint=factor(OS_Correct1_LD_HD_Run_Control$Timepoint, levels=c("4h", "24h"))
OS_Correct1_LD_HD_Run_Control$Radiation_type=factor(OS_Correct1_LD_HD_Run_Control$Radiation_type, levels=c("Gamma","Si", "Ar", "Fe"))
Run_rad <- ggplot(OS_Correct1_LD_HD_Run_Control, aes(x=Run_set, y=Ox_Stress)) + geom_boxplot(aes(fill=Radiation_type))
Run_rad <- Run_rad + facet_grid(. ~ Timepoint) + theme_gray() + ylim(0,7)
ggsave("Correction_step1_No_Norm_OS_per_Run_Set_19C_19A.pdf", Run_rad, width=25, height=7)

### 10p that overlap
OS_Correct1_LD_HD_Run_10p = OS_Correct1_LD_HD_Run %>% filter(OS_Correct1_LD_HD_Run$Sample_ID %in% Subject_19CS1_19AS1)
OS_Correct1_LD_HD_Run_10p$Radiation_type=factor(OS_Correct1_LD_HD_Run_10p$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
OS_Correct1_LD_HD_Run_10p$Time_dose=paste(OS_Correct1_LD_HD_Run_10p$Timepoint, OS_Correct1_LD_HD_Run_10p$Dose_relative, sep = " ")
OS_Correct1_LD_HD_Run_10p$Time_dose=factor(OS_Correct1_LD_HD_Run_10p$Time_dose, levels=c("4h 0 Gy control", "4h Low dose", "4h High dose","24h 0 Gy control","24h Low dose", "24h High dose"))
#
...
## With normalization
# Low dose
OS_Correct1_LD_Norm = Corrected_Ox_Stress[,grepl("low_dose_norm|Sample|Run_set|Duplicate|Timepoint|Radiation_type|Age|Gender|BMI",colnames(Corrected_Ox_Stress))]
OS_Correct1_LD_Norm$Dose_relative= "Low dose"
colnames(OS_Correct1_LD_Norm)[colnames(OS_Correct1_LD_Norm) == "OS_low_dose_norm"] <- "OS_Norm"
# High dose
OS_Correct1_HD_Norm = Corrected_Ox_Stress[,grepl("high_dose_norm|Run_set|Sample|Duplicate|Timepoint|Radiation_type|Age|Gender|BMI",colnames(Corrected_Ox_Stress))]
OS_Correct1_HD_Norm$Dose_relative= "High dose"
colnames(OS_Correct1_HD_Norm)[colnames(OS_Correct1_HD_Norm) == "OS_high_dose_norm"] <- "OS_Norm"
## regroup no normalization
OS_Correct1_LD_HD_Norm = bind_rows(OS_Correct1_LD_Norm, OS_Correct1_HD_Norm)
OS_Correct1_LD_HD_Norm$Radiation_type=factor(OS_Correct1_LD_HD_Norm$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
OS_Correct1_LD_HD_Norm$Time_dose=paste(OS_Correct1_LD_HD_Norm$Timepoint, OS_Correct1_LD_HD_Norm$Dose_relative, sep = " ")
OS_Correct1_LD_HD_Norm$Time_dose=factor(OS_Correct1_LD_HD_Norm$Time_dose, levels=c("4h 0 Gy control", "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))


#### For Run 18B and 19A 
Run_18B_19A=c("Run_19A_Set_1", "Run_19A_Set_2", "Run_18B_Set_2", "Run_18B_Set_1", "Run_19A_Set_3", "Run_19A_Set_4")
OS_Correct1_LD_HD_Run_Norm = OS_Correct1_LD_HD_Norm %>% filter(OS_Correct1_LD_HD_Norm$Run_set %in% Run_18B_19A)
## Graph all subjects
graph_with_Norm <- ggplot(OS_Correct1_LD_HD_Run_Norm, aes(x=Time_dose, y=OS_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Correction_OS_step1_Norm_Run_19C_19A.pdf", graph_with_Norm, width=25, height=7)
#
#### For Run 19C and 19A 
Run_19C_19A=c("Run_19A_Set_1", "Run_19A_Set_2", "Run_19C_Set_2", "Run_19C_Set_1", "Run_19A_Set_3", "Run_19A_Set_4")
OS_Correct1_LD_HD_Run_Norm = OS_Correct1_LD_HD_Norm %>% filter(OS_Correct1_LD_HD_Norm$Run_set %in% Run_19C_19A)
## Graph all subjects
graph_with_Norm <- ggplot(OS_Correct1_LD_HD_Run_Norm, aes(x=Time_dose, y=OS_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
...
Corrected_Ox_Stress$OS_high_dose_norm = NULL
Corrected_Ox_Stress$OS_low_dose_norm = NULL
...
# Select the 10 people that overlap in these two run
Subject_18BS2_19AS1 = c(1214, 1215,1216,1217,1218,1219,1220,1221,1222,1223)
OS_correct_19A_18B_10p = Corrected_Ox_Stress %>% filter(Corrected_Ox_Stress$Sample_ID %in% Subject_18BS2_19AS1 )
#
#### Z-score for 19A
Samp_19A_10p = OS_correct_19A_18B_10p %>% filter(OS_correct_19A_18B_10p$Run_set =="Run_19A_Set_1")
## For Controls 
Controls_19A= Samp_19A_10p
...
####### Mean
# 4h
Mean_ref_19A_Cont_Fe_4h = mean(NaRV.omit(control_19A_4h_Fe$Ox_Stress_0))
Mean_ref_19A_Cont_Ar_4h = mean(NaRV.omit(control_19A_4h_Ar$Ox_Stress_0))
Mean_ref_19A_Cont_Si_4h = mean(NaRV.omit(control_19A_4h_Si$Ox_Stress_0))
Mean_ref_19A_Cont_Gamma_4h = mean(NaRV.omit(control_19A_4h_Gamma$Ox_Stress_0))
# 24h
Mean_ref_19A_Cont_Fe_24h = mean(NaRV.omit(control_19A_24h_Fe$Ox_Stress_0))
Mean_ref_19A_Cont_Ar_24h = mean(NaRV.omit(control_19A_24h_Ar$Ox_Stress_0))
Mean_ref_19A_Cont_Si_24h = mean(NaRV.omit(control_19A_24h_Si$Ox_Stress_0))
Mean_ref_19A_Cont_Gamma_24h = mean(NaRV.omit(control_19A_24h_Gamma$Ox_Stress_0))
####### sd
# 4h
Std_ref_19A_Cont_Fe_4h = sd(NaRV.omit(control_19A_4h_Fe$Ox_Stress_0))
Std_ref_19A_Cont_Ar_4h = sd(NaRV.omit(control_19A_4h_Ar$Ox_Stress_0))
Std_ref_19A_Cont_Si_4h = sd(NaRV.omit(control_19A_4h_Si$Ox_Stress_0))
Std_ref_19A_Cont_Gamma_4h = sd(NaRV.omit(control_19A_4h_Gamma$Ox_Stress_0))
# 24h
Std_ref_19A_Cont_Fe_24h = sd(NaRV.omit(control_19A_24h_Fe$Ox_Stress_0))
Std_ref_19A_Cont_Ar_24h = sd(NaRV.omit(control_19A_24h_Ar$Ox_Stress_0))
Std_ref_19A_Cont_Si_24h = sd(NaRV.omit(control_19A_24h_Si$Ox_Stress_0))
Std_ref_19A_Cont_Gamma_24h = sd(NaRV.omit(control_19A_24h_Gamma$Ox_Stress_0))
#
#
## For Low dose irradiated samples
LD_19A= Samp_19A_10p
...
####### Mean
# 4h
Mean_ref_19A_LD_Fe_4h = mean(NaRV.omit(LD_19A_4h_Fe$Ox_Stress_low_dose))
Mean_ref_19A_LD_Ar_4h = mean(NaRV.omit(LD_19A_4h_Ar$Ox_Stress_low_dose))
Mean_ref_19A_LD_Si_4h = mean(NaRV.omit(LD_19A_4h_Si$Ox_Stress_low_dose))
Mean_ref_19A_LD_Gamma_4h = mean(NaRV.omit(LD_19A_4h_Gamma$Ox_Stress_low_dose))
# 24h
Mean_ref_19A_LD_Fe_24h = mean(NaRV.omit(LD_19A_24h_Fe$Ox_Stress_low_dose))
Mean_ref_19A_LD_Ar_24h = mean(NaRV.omit(LD_19A_24h_Ar$Ox_Stress_low_dose))
Mean_ref_19A_LD_Si_24h = mean(NaRV.omit(LD_19A_24h_Si$Ox_Stress_low_dose))
Mean_ref_19A_LD_Gamma_24h = mean(NaRV.omit(LD_19A_24h_Gamma$Ox_Stress_low_dose))
####### sd
# 4h
Std_ref_19A_LD_Fe_4h = sd(NaRV.omit(LD_19A_4h_Fe$Ox_Stress_low_dose))
Std_ref_19A_LD_Ar_4h = sd(NaRV.omit(LD_19A_4h_Ar$Ox_Stress_low_dose))
Std_ref_19A_LD_Si_4h = sd(NaRV.omit(LD_19A_4h_Si$Ox_Stress_low_dose))
Std_ref_19A_LD_Gamma_4h = sd(NaRV.omit(LD_19A_4h_Gamma$Ox_Stress_low_dose))
# 24h
Std_ref_19A_LD_Fe_24h = sd(NaRV.omit(LD_19A_24h_Fe$Ox_Stress_low_dose))
Std_ref_19A_LD_Ar_24h = sd(NaRV.omit(LD_19A_24h_Ar$Ox_Stress_low_dose))
Std_ref_19A_LD_Si_24h = sd(NaRV.omit(LD_19A_24h_Si$Ox_Stress_low_dose))
Std_ref_19A_LD_Gamma_24h = sd(NaRV.omit(LD_19A_24h_Gamma$Ox_Stress_low_dose))
#
## For high dose irradiated samples
HD_19A= Samp_19A_10p
...
####### Mean
# 4h
Mean_ref_19A_HD_Fe_4h = mean(NaRV.omit(HD_19A_4h_Fe$Ox_Stress_high_dose))
Mean_ref_19A_HD_Ar_4h = mean(NaRV.omit(HD_19A_4h_Ar$Ox_Stress_high_dose))
Mean_ref_19A_HD_Si_4h = mean(NaRV.omit(HD_19A_4h_Si$Ox_Stress_high_dose))
Mean_ref_19A_HD_Gamma_4h = mean(NaRV.omit(HD_19A_4h_Gamma$Ox_Stress_high_dose))
# 24h
Mean_ref_19A_HD_Fe_24h = mean(NaRV.omit(HD_19A_24h_Fe$Ox_Stress_high_dose))
Mean_ref_19A_HD_Ar_24h = mean(NaRV.omit(HD_19A_24h_Ar$Ox_Stress_high_dose))
Mean_ref_19A_HD_Si_24h = mean(NaRV.omit(HD_19A_24h_Si$Ox_Stress_high_dose))
Mean_ref_19A_HD_Gamma_24h = mean(NaRV.omit(HD_19A_24h_Gamma$Ox_Stress_high_dose))
####### sd
# 4h
Std_ref_19A_HD_Fe_4h = sd(NaRV.omit(HD_19A_4h_Fe$Ox_Stress_high_dose))
Std_ref_19A_HD_Ar_4h = sd(NaRV.omit(HD_19A_4h_Ar$Ox_Stress_high_dose))
Std_ref_19A_HD_Si_4h = sd(NaRV.omit(HD_19A_4h_Si$Ox_Stress_high_dose))
Std_ref_19A_HD_Gamma_4h = sd(NaRV.omit(HD_19A_4h_Gamma$Ox_Stress_high_dose))
# 24h
Std_ref_19A_HD_Fe_24h = sd(NaRV.omit(HD_19A_24h_Fe$Ox_Stress_high_dose))
Std_ref_19A_HD_Ar_24h = sd(NaRV.omit(HD_19A_24h_Ar$Ox_Stress_high_dose))
Std_ref_19A_HD_Si_24h = sd(NaRV.omit(HD_19A_24h_Si$Ox_Stress_high_dose))
Std_ref_19A_HD_Gamma_24h = sd(NaRV.omit(HD_19A_24h_Gamma$Ox_Stress_high_dose))
#
#### Z-score for 18B
Samp_18B_10p = OS_correct_19A_18B_10p %>% filter(OS_correct_19A_18B_10p$Run_set =="Run_18B_Set_2")
## For Controls 
Controls_18B= Samp_18B_10p
...
####### Mean
# 4h
Mean_ref_18B_Cont_Fe_4h = mean(NaRV.omit(control_18B_4h_Fe$Ox_Stress_0))
Mean_ref_18B_Cont_Ar_4h = mean(NaRV.omit(control_18B_4h_Ar$Ox_Stress_0))
Mean_ref_18B_Cont_Si_4h = mean(NaRV.omit(control_18B_4h_Si$Ox_Stress_0))
Mean_ref_18B_Cont_Gamma_4h = mean(NaRV.omit(control_18B_4h_Gamma$Ox_Stress_0))
# 24h
Mean_ref_18B_Cont_Fe_24h = mean(NaRV.omit(control_18B_24h_Fe$Ox_Stress_0))
Mean_ref_18B_Cont_Ar_24h = mean(NaRV.omit(control_18B_24h_Ar$Ox_Stress_0))
Mean_ref_18B_Cont_Si_24h = mean(NaRV.omit(control_18B_24h_Si$Ox_Stress_0))
Mean_ref_18B_Cont_Gamma_24h = mean(NaRV.omit(control_18B_24h_Gamma$Ox_Stress_0))
####### sd
# 4h
Std_ref_18B_Cont_Fe_4h = sd(NaRV.omit(control_18B_4h_Fe$Ox_Stress_0))
Std_ref_18B_Cont_Ar_4h = sd(NaRV.omit(control_18B_4h_Ar$Ox_Stress_0))
Std_ref_18B_Cont_Si_4h = sd(NaRV.omit(control_18B_4h_Si$Ox_Stress_0))
Std_ref_18B_Cont_Gamma_4h = sd(NaRV.omit(control_18B_4h_Gamma$Ox_Stress_0))
# 24h
Std_ref_18B_Cont_Fe_24h = sd(NaRV.omit(control_18B_24h_Fe$Ox_Stress_0))
Std_ref_18B_Cont_Ar_24h = sd(NaRV.omit(control_18B_24h_Ar$Ox_Stress_0))
Std_ref_18B_Cont_Si_24h = sd(NaRV.omit(control_18B_24h_Si$Ox_Stress_0))
Std_ref_18B_Cont_Gamma_24h = sd(NaRV.omit(control_18B_24h_Gamma$Ox_Stress_0))
#
#
## For Low dose irradiated samples
LD_18B= Samp_18B_10p
...
####### Mean
# 4h
Mean_ref_18B_LD_Fe_4h = mean(NaRV.omit(LD_18B_4h_Fe$Ox_Stress_low_dose))
Mean_ref_18B_LD_Ar_4h = mean(NaRV.omit(LD_18B_4h_Ar$Ox_Stress_low_dose))
Mean_ref_18B_LD_Si_4h = mean(NaRV.omit(LD_18B_4h_Si$Ox_Stress_low_dose))
Mean_ref_18B_LD_Gamma_4h = mean(NaRV.omit(LD_18B_4h_Gamma$Ox_Stress_low_dose))
# 24h
Mean_ref_18B_LD_Fe_24h = mean(NaRV.omit(LD_18B_24h_Fe$Ox_Stress_low_dose))
Mean_ref_18B_LD_Ar_24h = mean(NaRV.omit(LD_18B_24h_Ar$Ox_Stress_low_dose))
Mean_ref_18B_LD_Si_24h = mean(NaRV.omit(LD_18B_24h_Si$Ox_Stress_low_dose))
Mean_ref_18B_LD_Gamma_24h = mean(NaRV.omit(LD_18B_24h_Gamma$Ox_Stress_low_dose))
####### sd
# 4h
Std_ref_18B_LD_Fe_4h = sd(NaRV.omit(LD_18B_4h_Fe$Ox_Stress_low_dose))
Std_ref_18B_LD_Ar_4h = sd(NaRV.omit(LD_18B_4h_Ar$Ox_Stress_low_dose))
Std_ref_18B_LD_Si_4h = sd(NaRV.omit(LD_18B_4h_Si$Ox_Stress_low_dose))
Std_ref_18B_LD_Gamma_4h = sd(NaRV.omit(LD_18B_4h_Gamma$Ox_Stress_low_dose))
# 24h
Std_ref_18B_LD_Fe_24h = sd(NaRV.omit(LD_18B_24h_Fe$Ox_Stress_low_dose))
Std_ref_18B_LD_Ar_24h = sd(NaRV.omit(LD_18B_24h_Ar$Ox_Stress_low_dose))
Std_ref_18B_LD_Si_24h = sd(NaRV.omit(LD_18B_24h_Si$Ox_Stress_low_dose))
Std_ref_18B_LD_Gamma_24h = sd(NaRV.omit(LD_18B_24h_Gamma$Ox_Stress_low_dose))
#
## For high dose irradiated samples
HD_18B= Samp_18B_10p
...
####### Mean
# 4h
Mean_ref_18B_HD_Fe_4h = mean(NaRV.omit(HD_18B_4h_Fe$Ox_Stress_high_dose))
Mean_ref_18B_HD_Ar_4h = mean(NaRV.omit(HD_18B_4h_Ar$Ox_Stress_high_dose))
Mean_ref_18B_HD_Si_4h = mean(NaRV.omit(HD_18B_4h_Si$Ox_Stress_high_dose))
Mean_ref_18B_HD_Gamma_4h = mean(NaRV.omit(HD_18B_4h_Gamma$Ox_Stress_high_dose))
# 24h
Mean_ref_18B_HD_Fe_24h = mean(NaRV.omit(HD_18B_24h_Fe$Ox_Stress_high_dose))
Mean_ref_18B_HD_Ar_24h = mean(NaRV.omit(HD_18B_24h_Ar$Ox_Stress_high_dose))
Mean_ref_18B_HD_Si_24h = mean(NaRV.omit(HD_18B_24h_Si$Ox_Stress_high_dose))
Mean_ref_18B_HD_Gamma_24h = mean(NaRV.omit(HD_18B_24h_Gamma$Ox_Stress_high_dose))
####### sd
# 4h
Std_ref_18B_HD_Fe_4h = sd(NaRV.omit(HD_18B_4h_Fe$Ox_Stress_high_dose))
Std_ref_18B_HD_Ar_4h = sd(NaRV.omit(HD_18B_4h_Ar$Ox_Stress_high_dose))
Std_ref_18B_HD_Si_4h = sd(NaRV.omit(HD_18B_4h_Si$Ox_Stress_high_dose))
Std_ref_18B_HD_Gamma_4h = sd(NaRV.omit(HD_18B_4h_Gamma$Ox_Stress_high_dose))
# 24h
Std_ref_18B_HD_Fe_24h = sd(NaRV.omit(HD_18B_24h_Fe$Ox_Stress_high_dose))
Std_ref_18B_HD_Ar_24h = sd(NaRV.omit(HD_18B_24h_Ar$Ox_Stress_high_dose))
Std_ref_18B_HD_Si_24h = sd(NaRV.omit(HD_18B_24h_Si$Ox_Stress_high_dose))
Std_ref_18B_HD_Gamma_24h = sd(NaRV.omit(HD_18B_24h_Gamma$Ox_Stress_high_dose))
#
## Now we apply the "z-score correction" on all subjects from 18B 
#
#
...
Run_19A = c("Run_19A_Set_1", "Run_19A_Set_2", "Run_19A_Set_3", "Run_19A_Set_4")
#
Samp_18B_allp = Corrected_Ox_Stress %>% filter(Corrected_Ox_Stress$Run_set %in% Run_18B)
Samp_19A_allp = Corrected_Ox_Stress %>% filter(Corrected_Ox_Stress$Run_set %in% Run_19A)
#
## For Controls 
Controls_allp_18B= Samp_18B_allp
...
## z-score correction
# 4h
control_allp_18B_4h_Fe$Ox_Stress_0 = ((((control_allp_18B_4h_Fe$Ox_Stress_0 - Mean_ref_18B_Cont_Fe_4h)/Std_ref_18B_Cont_Fe_4h)*Std_ref_19A_Cont_Fe_4h) + Mean_ref_19A_Cont_Fe_4h)

control_allp_18B_4h_Ar$Ox_Stress_0 = ((((control_allp_18B_4h_Ar$Ox_Stress_0 - Mean_ref_18B_Cont_Ar_4h)/Std_ref_18B_Cont_Ar_4h)*Std_ref_19A_Cont_Ar_4h) + Mean_ref_19A_Cont_Ar_4h) 

control_allp_18B_4h_Si$Ox_Stress_0 = ((((control_allp_18B_4h_Si$Ox_Stress_0 - Mean_ref_18B_Cont_Si_4h)/Std_ref_18B_Cont_Si_4h)*Std_ref_19A_Cont_Si_4h) + Mean_ref_19A_Cont_Si_4h)
                                          
control_allp_18B_4h_Gamma$Ox_Stress_0 = ((((control_allp_18B_4h_Gamma$Ox_Stress_0 - Mean_ref_18B_Cont_Gamma_4h)/Std_ref_18B_Cont_Gamma_4h)*Std_ref_19A_Cont_Gamma_4h) + Mean_ref_19A_Cont_Gamma_4h)

# 24h
control_allp_18B_24h_Fe$Ox_Stress_0 = ((((control_allp_18B_24h_Fe$Ox_Stress_0 - Mean_ref_18B_Cont_Fe_24h)/Std_ref_18B_Cont_Fe_24h)*Std_ref_19A_Cont_Fe_24h) + Mean_ref_19A_Cont_Fe_24h)
                                          
control_allp_18B_24h_Ar$Ox_Stress_0 = ((((control_allp_18B_24h_Ar$Ox_Stress_0 - Mean_ref_18B_Cont_Ar_24h)/Std_ref_18B_Cont_Ar_24h)*Std_ref_19A_Cont_Ar_24h) + Mean_ref_19A_Cont_Ar_24h) 

control_allp_18B_24h_Si$Ox_Stress_0 = ((((control_allp_18B_24h_Si$Ox_Stress_0 - Mean_ref_18B_Cont_Si_24h)/Std_ref_18B_Cont_Si_24h)*Std_ref_19A_Cont_Si_24h) + Mean_ref_19A_Cont_Si_24h)
                                          
control_allp_18B_24h_Gamma$Ox_Stress_0 = ((((control_allp_18B_24h_Gamma$Ox_Stress_0 - Mean_ref_18B_Cont_Gamma_24h)/Std_ref_18B_Cont_Gamma_24h)*Std_ref_19A_Cont_Gamma_24h) + Mean_ref_19A_Cont_Gamma_24h)
#
#
## For Low dose irradiated samples
LD_allp_18B= Samp_18B_allp
...
## z-score correction
# 4h
LD_allp_18B_4h_Fe$Ox_Stress_low_dose = ((((LD_allp_18B_4h_Fe$Ox_Stress_low_dose -Mean_ref_18B_LD_Fe_4h)/Std_ref_18B_LD_Fe_4h)*Std_ref_19A_LD_Fe_4h) + Mean_ref_19A_LD_Fe_4h)

LD_allp_18B_4h_Ar$Ox_Stress_low_dose = ((((LD_allp_18B_4h_Ar$Ox_Stress_low_dose -Mean_ref_18B_LD_Ar_4h)/Std_ref_18B_LD_Ar_4h)*Std_ref_19A_LD_Ar_4h) + Mean_ref_19A_LD_Ar_4h)

LD_allp_18B_4h_Si$Ox_Stress_low_dose = ((((LD_allp_18B_4h_Si$Ox_Stress_low_dose -Mean_ref_18B_LD_Si_4h)/Std_ref_18B_LD_Si_4h)*Std_ref_19A_LD_Si_4h) + Mean_ref_19A_LD_Si_4h)
                                            
LD_allp_18B_4h_Gamma$Ox_Stress_low_dose = ((((LD_allp_18B_4h_Gamma$Ox_Stress_low_dose -Mean_ref_18B_LD_Gamma_4h)/Std_ref_18B_LD_Gamma_4h)*Std_ref_19A_LD_Gamma_4h) + Mean_ref_19A_LD_Gamma_4h)
#
# 24h
LD_allp_18B_24h_Fe$Ox_Stress_low_dose = ((((LD_allp_18B_24h_Fe$Ox_Stress_low_dose -Mean_ref_18B_LD_Fe_24h)/Std_ref_18B_LD_Fe_24h)*Std_ref_19A_LD_Fe_24h) + Mean_ref_19A_LD_Fe_24h)

LD_allp_18B_24h_Ar$Ox_Stress_low_dose = ((((LD_allp_18B_24h_Ar$Ox_Stress_low_dose -Mean_ref_18B_LD_Ar_24h)/Std_ref_18B_LD_Ar_24h)*Std_ref_19A_LD_Ar_24h) + Mean_ref_19A_LD_Ar_24h)

LD_allp_18B_24h_Si$Ox_Stress_low_dose = ((((LD_allp_18B_24h_Si$Ox_Stress_low_dose -Mean_ref_18B_LD_Si_24h)/Std_ref_18B_LD_Si_24h)*Std_ref_19A_LD_Si_24h) + Mean_ref_19A_LD_Si_24h)
                                            
LD_allp_18B_24h_Gamma$Ox_Stress_low_dose = ((((LD_allp_18B_24h_Gamma$Ox_Stress_low_dose -Mean_ref_18B_LD_Gamma_24h)/Std_ref_18B_LD_Gamma_24h)*Std_ref_19A_LD_Gamma_24h) + Mean_ref_19A_LD_Gamma_24h)
#
## For high dose irradiated samples
HD_allp_18B= Samp_18B_allp
...
## z-score correction
# 4h
HD_allp_18B_4h_Fe$Ox_Stress_high_dose= ((((HD_allp_18B_4h_Fe$Ox_Stress_high_dose -Mean_ref_18B_HD_Fe_4h)/Std_ref_18B_HD_Fe_4h)*Std_ref_19A_HD_Fe_4h) + Mean_ref_19A_HD_Fe_4h)

HD_allp_18B_4h_Ar$Ox_Stress_high_dose= ((((HD_allp_18B_4h_Ar$Ox_Stress_high_dose -Mean_ref_18B_HD_Ar_4h)/Std_ref_18B_HD_Ar_4h)*Std_ref_19A_HD_Ar_4h) + Mean_ref_19A_HD_Ar_4h)

HD_allp_18B_4h_Si$Ox_Stress_high_dose= ((((HD_allp_18B_4h_Si$Ox_Stress_high_dose -Mean_ref_18B_HD_Si_4h)/Std_ref_18B_HD_Si_4h)*Std_ref_19A_HD_Si_4h) + Mean_ref_19A_HD_Si_4h)

HD_allp_18B_4h_Gamma$Ox_Stress_high_dose= ((((HD_allp_18B_4h_Gamma$Ox_Stress_high_dose -Mean_ref_18B_HD_Gamma_4h)/Std_ref_18B_HD_Gamma_4h)*Std_ref_19A_HD_Gamma_4h) + Mean_ref_19A_HD_Gamma_4h)
#
# 24h
HD_allp_18B_24h_Fe$Ox_Stress_high_dose= ((((HD_allp_18B_24h_Fe$Ox_Stress_high_dose -Mean_ref_18B_HD_Fe_24h)/Std_ref_18B_HD_Fe_24h)*Std_ref_19A_HD_Fe_24h) + Mean_ref_19A_HD_Fe_24h)

HD_allp_18B_24h_Ar$Ox_Stress_high_dose= ((((HD_allp_18B_24h_Ar$Ox_Stress_high_dose -Mean_ref_18B_HD_Ar_24h)/Std_ref_18B_HD_Ar_24h)*Std_ref_19A_HD_Ar_24h) + Mean_ref_19A_HD_Ar_24h)

HD_allp_18B_24h_Si$Ox_Stress_high_dose= ((((HD_allp_18B_24h_Si$Ox_Stress_high_dose -Mean_ref_18B_HD_Si_24h)/Std_ref_18B_HD_Si_24h)*Std_ref_19A_HD_Si_24h) + Mean_ref_19A_HD_Si_24h)

HD_allp_18B_24h_Gamma$Ox_Stress_high_dose= ((((HD_allp_18B_24h_Gamma$Ox_Stress_high_dose -Mean_ref_18B_HD_Gamma_24h)/Std_ref_18B_HD_Gamma_24h) *Std_ref_19A_HD_Gamma_24h) + Mean_ref_19A_HD_Gamma_24h)
#
### Now we regroup everything
## regroup 18B
Cont_18B_All_rad= bind_rows(control_allp_18B_4h_Fe,  control_allp_18B_24h_Fe, 
...
HD_18B_All_rad= bind_rows(HD_allp_18B_4h_Fe,  HD_allp_18B_24h_Fe, 
                           ...
                           HD_allp_18B_4h_Gamma,  HD_allp_18B_24h_Gamma)
#
Control_18B_meta_use= Cont_18B_All_rad[,grepl("Sample_ID|Duplicate|Run_set|Timepoint|Radiation_type|Ox",colnames(Cont_18B_All_rad))]
LD_control_18B=merge(LD_18B_All_rad, Control_18B_meta_use, by=c("Sample_ID", "Duplicate", "Run_set", "Timepoint", "Radiation_type") )
colnames(LD_control_18B)[colnames(LD_control_18B)=="Ox_Stress_low_dose"]<- "Ox_Stress"
LD_control_18B$Dose_relative="Low dose"
HD_control_18B=merge(HD_18B_All_rad, Control_18B_meta_use, by=c("Sample_ID", "Duplicate", "Run_set", "Timepoint", "Radiation_type") )
colnames(HD_control_18B)[colnames(HD_control_18B)=="Ox_Stress_high_dose"]<- "Ox_Stress"
HD_control_18B$Dose_relative="High dose"
Cont_18B_All_rad$Ox_Stress = Cont_18B_All_rad$Ox_Stress_0
Cont_18B_All_rad$Dose_relative = "0 Gy control"
LD_HD_18B=bind_rows(LD_control_18B, HD_control_18B, Cont_18B_All_rad)
#
#19A was used as reference: data were not modified. We format the table to fit the same structure as 18B
Samp_19A_allp_LD = Samp_19A_allp
Samp_19A_allp_LD$Ox_Stress_high_dose = NULL
colnames(Samp_19A_allp_LD)[colnames(Samp_19A_allp_LD)=="Ox_Stress_low_dose"]<- "Ox_Stress"
Samp_19A_allp_LD$Dose_relative="Low dose"
#
Samp_19A_allp_HD = Samp_19A_allp
Samp_19A_allp_HD$Ox_Stress_low_dose = NULL
colnames(Samp_19A_allp_HD)[colnames(Samp_19A_allp_HD)=="Ox_Stress_high_dose"]<- "Ox_Stress"
Samp_19A_allp_HD$Dose_relative="High dose"
#
Samp_19A_allp_cont = Samp_19A_allp
Samp_19A_allp_cont$Ox_Stress_low_dose = NULL
Samp_19A_allp_cont$Ox_Stress_high_dose = NULL
Samp_19A_allp_cont$Ox_Stress = Samp_19A_allp_cont$Ox_Stress_0
Samp_19A_allp_cont$Dose_relative="0 Gy control"
#
Samp_plot_19A_allp= bind_rows(Samp_19A_allp_LD, Samp_19A_allp_HD, Samp_19A_allp_cont)
#
################### regroup 18B and 19A 
All_18B_19A = bind_rows(LD_HD_18B, Samp_plot_19A_allp)
All_18B_19A$Ox_Stress_Norm = All_18B_19A$Ox_Stress / All_18B_19A$Ox_Stress_0
All_18B_19A$Timepoint=factor(All_18B_19A$Timepoint, levels=c("4h", "24h"))
All_18B_19A$Time_dose=paste(All_18B_19A$Timepoint, All_18B_19A$Dose_relative, sep = " ")
All_18B_19A$Time_dose=factor(All_18B_19A$Time_dose, levels=c("4h 0 Gy control",  "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))
All_18B_19A$Radiation_type=factor(All_18B_19A$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))

## Graph Ox_Stress vs Run_Set, color code radiation + a panel per time point without normalization
graph_without_Norm <- ggplot(All_18B_19A, aes(x=Time_dose, y=Ox_Stress)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Correction_step2_No_Norm_Ox_Stress_per_Run_Set_18B_19A.pdf", graph_without_Norm, width=25, height=7)
#
## Graph Ox_Stress vs Run_Set, color code radiation + a panel per time point with normalization
dose_relative= c("Low dose", "High dose")
All_18B_19A_Norm = All_18B_19A %>% filter(All_18B_19A$Dose_relative %in% dose_relative)
All_18B_19A_Norm$Time_dose=factor(All_18B_19A_Norm$Time_dose, levels=c("4h 0 Gy control",  "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))
All_18B_19A_Norm$Radiation_type=factor(All_18B_19A_Norm$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
graph_with_Norm <- ggplot(All_18B_19A_Norm, aes(x=Time_dose, y=Ox_Stress_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Correction_step2_Norm_Ox_Stress_per_Run_Set_18B_19A.pdf", graph_with_Norm, width=25, height=7)
...
All_18B_19A_10p$Radiation_type=factor(All_18B_19A_10p$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
# without normalization
graph_without_Norm <- ggplot(All_18B_19A_10p, aes(x=Time_dose, y=Ox_Stress)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Correction_step2_No_Norm_Ox_Stress_per_Run_Set_18B_19A_10p_overlap.pdf", graph_without_Norm, width=25, height=7)
#
# with normalization
dose_relative= c("Low dose", "High dose")
All_18B_19A_Norm_10p = All_18B_19A_10p %>% filter(All_18B_19A_10p$Dose_relative %in% dose_relative)
All_18B_19A_Norm_10p$Time_dose=factor(All_18B_19A_Norm_10p$Time_dose, levels=c("4h 0 Gy control",  "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))
All_18B_19A_Norm_10p$Radiation_type=factor(All_18B_19A_Norm_10p$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
graph_with_Norm <- ggplot(All_18B_19A_Norm_10p, aes(x=Time_dose, y=Ox_Stress_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Correction_step2_Norm_Ox_Stress_per_Run_Set_18B_19A_10p_overlap.pdf", graph_with_Norm, width=25, height=7)

############ Now we do exaclty the same but for 19A and 19C
# Select the 10 people that overlap in these two run
Subject_19CS1_19AS1 = c(1589,1590,1591,1592,1593,1594,1595,1596,1597)
OS_correct_19A_19C_10p = Corrected_Ox_Stress %>% filter(Corrected_Ox_Stress$Sample_ID %in% Subject_19CS1_19AS1 )
#
#
#### Z-score for 19A
Samp_19A_10p = OS_correct_19A_19C_10p %>% filter(OS_correct_19A_19C_10p$Run_set =="Run_19A_Set_1")
## For Controls 
Controls_19A= Samp_19A_10p
Controls_19A$Ox_Stress_low_dose=NULL
Controls_19A$Ox_Stress_high_dose=NULL
...
#
#### Z-score for 19C
Samp_19C_10p = OS_correct_19A_19C_10p %>% filter(OS_correct_19A_19C_10p$Run_set =="Run_19C_Set_2")
## For Controls 
Controls_19C= Samp_19C_10p
...
####### Mean
# 4h
Mean_ref_19C_Cont_Fe_4h = mean(NaRV.omit(control_19C_4h_Fe$Ox_Stress_0))
Mean_ref_19C_Cont_Ar_4h = mean(NaRV.omit(control_19C_4h_Ar$Ox_Stress_0))
Mean_ref_19C_Cont_Si_4h = mean(NaRV.omit(control_19C_4h_Si$Ox_Stress_0))
Mean_ref_19C_Cont_Gamma_4h = mean(NaRV.omit(control_19C_4h_Gamma$Ox_Stress_0))
# 24h
Mean_ref_19C_Cont_Fe_24h = mean(NaRV.omit(control_19C_24h_Fe$Ox_Stress_0))
Mean_ref_19C_Cont_Ar_24h = mean(NaRV.omit(control_19C_24h_Ar$Ox_Stress_0))
Mean_ref_19C_Cont_Si_24h = mean(NaRV.omit(control_19C_24h_Si$Ox_Stress_0))
Mean_ref_19C_Cont_Gamma_24h = mean(NaRV.omit(control_19C_24h_Gamma$Ox_Stress_0))
####### sd
# 4h
Std_ref_19C_Cont_Fe_4h = sd(NaRV.omit(control_19C_4h_Fe$Ox_Stress_0))
Std_ref_19C_Cont_Ar_4h = sd(NaRV.omit(control_19C_4h_Ar$Ox_Stress_0))
Std_ref_19C_Cont_Si_4h = sd(NaRV.omit(control_19C_4h_Si$Ox_Stress_0))
Std_ref_19C_Cont_Gamma_4h = sd(NaRV.omit(control_19C_4h_Gamma$Ox_Stress_0))
# 24h
Std_ref_19C_Cont_Fe_24h = sd(NaRV.omit(control_19C_24h_Fe$Ox_Stress_0))
Std_ref_19C_Cont_Ar_24h = sd(NaRV.omit(control_19C_24h_Ar$Ox_Stress_0))
Std_ref_19C_Cont_Si_24h = sd(NaRV.omit(control_19C_24h_Si$Ox_Stress_0))
Std_ref_19C_Cont_Gamma_24h = sd(NaRV.omit(control_19C_24h_Gamma$Ox_Stress_0))
#
#
## For Low dose irradiated samples
LD_19C= Samp_19C_10p
...
####### Mean
# 4h
Mean_ref_19C_LD_Fe_4h = mean(NaRV.omit(LD_19C_4h_Fe$Ox_Stress_low_dose))
Mean_ref_19C_LD_Ar_4h = mean(NaRV.omit(LD_19C_4h_Ar$Ox_Stress_low_dose))
Mean_ref_19C_LD_Si_4h = mean(NaRV.omit(LD_19C_4h_Si$Ox_Stress_low_dose))
Mean_ref_19C_LD_Gamma_4h = mean(NaRV.omit(LD_19C_4h_Gamma$Ox_Stress_low_dose))
# 24h
Mean_ref_19C_LD_Fe_24h = mean(NaRV.omit(LD_19C_24h_Fe$Ox_Stress_low_dose))
Mean_ref_19C_LD_Ar_24h = mean(NaRV.omit(LD_19C_24h_Ar$Ox_Stress_low_dose))
Mean_ref_19C_LD_Si_24h = mean(NaRV.omit(LD_19C_24h_Si$Ox_Stress_low_dose))
Mean_ref_19C_LD_Gamma_24h = mean(NaRV.omit(LD_19C_24h_Gamma$Ox_Stress_low_dose))
####### sd
# 4h
Std_ref_19C_LD_Fe_4h = sd(NaRV.omit(LD_19C_4h_Fe$Ox_Stress_low_dose))
Std_ref_19C_LD_Ar_4h = sd(NaRV.omit(LD_19C_4h_Ar$Ox_Stress_low_dose))
Std_ref_19C_LD_Si_4h = sd(NaRV.omit(LD_19C_4h_Si$Ox_Stress_low_dose))
Std_ref_19C_LD_Gamma_4h = sd(NaRV.omit(LD_19C_4h_Gamma$Ox_Stress_low_dose))
# 24h
Std_ref_19C_LD_Fe_24h = sd(NaRV.omit(LD_19C_24h_Fe$Ox_Stress_low_dose))
Std_ref_19C_LD_Ar_24h = sd(NaRV.omit(LD_19C_24h_Ar$Ox_Stress_low_dose))
Std_ref_19C_LD_Si_24h = sd(NaRV.omit(LD_19C_24h_Si$Ox_Stress_low_dose))
Std_ref_19C_LD_Gamma_24h = sd(NaRV.omit(LD_19C_24h_Gamma$Ox_Stress_low_dose))
#
## For high dose irradiated samples
HD_19C= Samp_19C_10p
...
####### Mean
# 4h
Mean_ref_19C_HD_Fe_4h = mean(NaRV.omit(HD_19C_4h_Fe$Ox_Stress_high_dose))
Mean_ref_19C_HD_Ar_4h = mean(NaRV.omit(HD_19C_4h_Ar$Ox_Stress_high_dose))
Mean_ref_19C_HD_Si_4h = mean(NaRV.omit(HD_19C_4h_Si$Ox_Stress_high_dose))
Mean_ref_19C_HD_Gamma_4h = mean(NaRV.omit(HD_19C_4h_Gamma$Ox_Stress_high_dose))
# 24h
Mean_ref_19C_HD_Fe_24h = mean(NaRV.omit(HD_19C_24h_Fe$Ox_Stress_high_dose))
Mean_ref_19C_HD_Ar_24h = mean(NaRV.omit(HD_19C_24h_Ar$Ox_Stress_high_dose))
Mean_ref_19C_HD_Si_24h = mean(NaRV.omit(HD_19C_24h_Si$Ox_Stress_high_dose))
Mean_ref_19C_HD_Gamma_24h = mean(NaRV.omit(HD_19C_24h_Gamma$Ox_Stress_high_dose))
####### sd
# 4h
Std_ref_19C_HD_Fe_4h = sd(NaRV.omit(HD_19C_4h_Fe$Ox_Stress_high_dose))
Std_ref_19C_HD_Ar_4h = sd(NaRV.omit(HD_19C_4h_Ar$Ox_Stress_high_dose))
Std_ref_19C_HD_Si_4h = sd(NaRV.omit(HD_19C_4h_Si$Ox_Stress_high_dose))
Std_ref_19C_HD_Gamma_4h = sd(NaRV.omit(HD_19C_4h_Gamma$Ox_Stress_high_dose))
# 24h
Std_ref_19C_HD_Fe_24h = sd(NaRV.omit(HD_19C_24h_Fe$Ox_Stress_high_dose))
Std_ref_19C_HD_Ar_24h = sd(NaRV.omit(HD_19C_24h_Ar$Ox_Stress_high_dose))
Std_ref_19C_HD_Si_24h = sd(NaRV.omit(HD_19C_24h_Si$Ox_Stress_high_dose))
Std_ref_19C_HD_Gamma_24h = sd(NaRV.omit(HD_19C_24h_Gamma$Ox_Stress_high_dose))
#
## Now we apply the "z-score correction" on all subjects from 19C 
#
#
...
Run_19A = c("Run_19A_Set_1", "Run_19A_Set_2", "Run_19A_Set_3", "Run_19A_Set_4")
#
Samp_19C_allp = Corrected_Ox_Stress %>% filter(Corrected_Ox_Stress$Run_set %in% Run_19C)
Samp_19A_allp = Corrected_Ox_Stress %>% filter(Corrected_Ox_Stress$Run_set %in% Run_19A)
#
## For Controls 
Controls_allp_19C= Samp_19C_allp
...
## z-score correction
# 4h
control_allp_19C_4h_Fe$Ox_Stress_0 = ((((control_allp_19C_4h_Fe$Ox_Stress_0 - Mean_ref_19C_Cont_Fe_4h)/Std_ref_19C_Cont_Fe_4h)*Std_ref_19A_Cont_Fe_4h) + Mean_ref_19A_Cont_Fe_4h)

control_allp_19C_4h_Ar$Ox_Stress_0 = ((((control_allp_19C_4h_Ar$Ox_Stress_0 - Mean_ref_19C_Cont_Ar_4h)/Std_ref_19C_Cont_Ar_4h)*Std_ref_19A_Cont_Ar_4h) + Mean_ref_19A_Cont_Ar_4h) 

control_allp_19C_4h_Si$Ox_Stress_0 = ((((control_allp_19C_4h_Si$Ox_Stress_0 - Mean_ref_19C_Cont_Si_4h)/Std_ref_19C_Cont_Si_4h)*Std_ref_19A_Cont_Si_4h) + Mean_ref_19A_Cont_Si_4h)
                                          
control_allp_19C_4h_Gamma$Ox_Stress_0 = ((((control_allp_19C_4h_Gamma$Ox_Stress_0 - Mean_ref_19C_Cont_Gamma_4h)/Std_ref_19C_Cont_Gamma_4h)*Std_ref_19A_Cont_Gamma_4h) + Mean_ref_19A_Cont_Gamma_4h)

# 24h
control_allp_19C_24h_Fe$Ox_Stress_0 = ((((control_allp_19C_24h_Fe$Ox_Stress_0 - Mean_ref_19C_Cont_Fe_24h)/Std_ref_19C_Cont_Fe_24h)*Std_ref_19A_Cont_Fe_24h) + Mean_ref_19A_Cont_Fe_24h)
                                          
control_allp_19C_24h_Ar$Ox_Stress_0 = ((((control_allp_19C_24h_Ar$Ox_Stress_0 - Mean_ref_19C_Cont_Ar_24h)/Std_ref_19C_Cont_Ar_24h)*Std_ref_19A_Cont_Ar_24h) + Mean_ref_19A_Cont_Ar_24h) 

control_allp_19C_24h_Si$Ox_Stress_0 = ((((control_allp_19C_24h_Si$Ox_Stress_0 - Mean_ref_19C_Cont_Si_24h)/Std_ref_19C_Cont_Si_24h)*Std_ref_19A_Cont_Si_24h) + Mean_ref_19A_Cont_Si_24h)
                                          
control_allp_19C_24h_Gamma$Ox_Stress_0 = ((((control_allp_19C_24h_Gamma$Ox_Stress_0 - Mean_ref_19C_Cont_Gamma_24h)/Std_ref_19C_Cont_Gamma_24h)*Std_ref_19A_Cont_Gamma_24h) + Mean_ref_19A_Cont_Gamma_24h)
#
#
## For Low dose irradiated samples
LD_allp_19C= Samp_19C_allp
...
## z-score correction
# 4h
LD_allp_19C_4h_Fe$Ox_Stress_low_dose = ((((LD_allp_19C_4h_Fe$Ox_Stress_low_dose -Mean_ref_19C_LD_Fe_4h)/Std_ref_19C_LD_Fe_4h)*Std_ref_19A_LD_Fe_4h) + Mean_ref_19A_LD_Fe_4h)

LD_allp_19C_4h_Ar$Ox_Stress_low_dose = ((((LD_allp_19C_4h_Ar$Ox_Stress_low_dose -Mean_ref_19C_LD_Ar_4h)/Std_ref_19C_LD_Ar_4h)*Std_ref_19A_LD_Ar_4h) + Mean_ref_19A_LD_Ar_4h)

LD_allp_19C_4h_Si$Ox_Stress_low_dose = ((((LD_allp_19C_4h_Si$Ox_Stress_low_dose -Mean_ref_19C_LD_Si_4h)/Std_ref_19C_LD_Si_4h)*Std_ref_19A_LD_Si_4h) + Mean_ref_19A_LD_Si_4h)
                                            
LD_allp_19C_4h_Gamma$Ox_Stress_low_dose = ((((LD_allp_19C_4h_Gamma$Ox_Stress_low_dose -Mean_ref_19C_LD_Gamma_4h)/Std_ref_19C_LD_Gamma_4h)*Std_ref_19A_LD_Gamma_4h) + Mean_ref_19A_LD_Gamma_4h)
#
# 24h
LD_allp_19C_24h_Fe$Ox_Stress_low_dose = ((((LD_allp_19C_24h_Fe$Ox_Stress_low_dose -Mean_ref_19C_LD_Fe_24h)/Std_ref_19C_LD_Fe_24h)*Std_ref_19A_LD_Fe_24h) + Mean_ref_19A_LD_Fe_24h)

LD_allp_19C_24h_Ar$Ox_Stress_low_dose = ((((LD_allp_19C_24h_Ar$Ox_Stress_low_dose -Mean_ref_19C_LD_Ar_24h)/Std_ref_19C_LD_Ar_24h)*Std_ref_19A_LD_Ar_24h) + Mean_ref_19A_LD_Ar_24h)

LD_allp_19C_24h_Si$Ox_Stress_low_dose = ((((LD_allp_19C_24h_Si$Ox_Stress_low_dose -Mean_ref_19C_LD_Si_24h)/Std_ref_19C_LD_Si_24h)*Std_ref_19A_LD_Si_24h) + Mean_ref_19A_LD_Si_24h)
                                            
LD_allp_19C_24h_Gamma$Ox_Stress_low_dose = ((((LD_allp_19C_24h_Gamma$Ox_Stress_low_dose -Mean_ref_19C_LD_Gamma_24h)/Std_ref_19C_LD_Gamma_24h)*Std_ref_19A_LD_Gamma_24h) + Mean_ref_19A_LD_Gamma_24h)
#
## For high dose irradiated samples
HD_allp_19C= Samp_19C_allp
...
## z-score correction
# 4h
HD_allp_19C_4h_Fe$Ox_Stress_high_dose= ((((HD_allp_19C_4h_Fe$Ox_Stress_high_dose -Mean_ref_19C_HD_Fe_4h)/Std_ref_19C_HD_Fe_4h)*Std_ref_19A_HD_Fe_4h) + Mean_ref_19A_HD_Fe_4h)

HD_allp_19C_4h_Ar$Ox_Stress_high_dose= ((((HD_allp_19C_4h_Ar$Ox_Stress_high_dose -Mean_ref_19C_HD_Ar_4h)/Std_ref_19C_HD_Ar_4h)*Std_ref_19A_HD_Ar_4h) + Mean_ref_19A_HD_Ar_4h)

HD_allp_19C_4h_Si$Ox_Stress_high_dose= ((((HD_allp_19C_4h_Si$Ox_Stress_high_dose -Mean_ref_19C_HD_Si_4h)/Std_ref_19C_HD_Si_4h)*Std_ref_19A_HD_Si_4h) + Mean_ref_19A_HD_Si_4h)

HD_allp_19C_4h_Gamma$Ox_Stress_high_dose= ((((HD_allp_19C_4h_Gamma$Ox_Stress_high_dose -Mean_ref_19C_HD_Gamma_4h)/Std_ref_19C_HD_Gamma_4h)*Std_ref_19A_HD_Gamma_4h) + Mean_ref_19A_HD_Gamma_4h)
#
# 24h
HD_allp_19C_24h_Fe$Ox_Stress_high_dose= ((((HD_allp_19C_24h_Fe$Ox_Stress_high_dose -Mean_ref_19C_HD_Fe_24h)/Std_ref_19C_HD_Fe_24h)*Std_ref_19A_HD_Fe_24h) + Mean_ref_19A_HD_Fe_24h)

HD_allp_19C_24h_Ar$Ox_Stress_high_dose= ((((HD_allp_19C_24h_Ar$Ox_Stress_high_dose -Mean_ref_19C_HD_Ar_24h)/Std_ref_19C_HD_Ar_24h)*Std_ref_19A_HD_Ar_24h) + Mean_ref_19A_HD_Ar_24h)

HD_allp_19C_24h_Si$Ox_Stress_high_dose= ((((HD_allp_19C_24h_Si$Ox_Stress_high_dose -Mean_ref_19C_HD_Si_24h)/Std_ref_19C_HD_Si_24h)*Std_ref_19A_HD_Si_24h) + Mean_ref_19A_HD_Si_24h)

HD_allp_19C_24h_Gamma$Ox_Stress_high_dose= ((((HD_allp_19C_24h_Gamma$Ox_Stress_high_dose -Mean_ref_19C_HD_Gamma_24h)/Std_ref_19C_HD_Gamma_24h) *Std_ref_19A_HD_Gamma_24h) + Mean_ref_19A_HD_Gamma_24h)
#
### Now we regroup everything
## regroup 19C
Cont_19C_All_rad= bind_rows(control_allp_19C_4h_Fe,  control_allp_19C_24h_Fe, 
...
HD_19C_All_rad= bind_rows(HD_allp_19C_4h_Fe,  HD_allp_19C_24h_Fe, 
                           ...
                           HD_allp_19C_4h_Gamma,  HD_allp_19C_24h_Gamma)
#
Control_19C_meta_use= Cont_19C_All_rad[,grepl("Sample_ID|Duplicate|Run_set|Timepoint|Radiation_type|Ox",colnames(Cont_19C_All_rad))]
LD_control_19C=merge(LD_19C_All_rad, Control_19C_meta_use, by=c("Sample_ID", "Duplicate", "Run_set", "Timepoint", "Radiation_type") )
colnames(LD_control_19C)[colnames(LD_control_19C)=="Ox_Stress_low_dose"]<- "Ox_Stress"
LD_control_19C$Dose_relative="Low dose"
HD_control_19C=merge(HD_19C_All_rad, Control_19C_meta_use, by=c("Sample_ID", "Duplicate", "Run_set", "Timepoint", "Radiation_type") )
colnames(HD_control_19C)[colnames(HD_control_19C)=="Ox_Stress_high_dose"]<- "Ox_Stress"
HD_control_19C$Dose_relative="High dose"
Cont_19C_All_rad$Ox_Stress = Cont_19C_All_rad$Ox_Stress_0
Cont_19C_All_rad$Dose_relative = "0 Gy control"
LD_HD_19C=bind_rows(LD_control_19C, HD_control_19C, Cont_19C_All_rad)
#
#19A was used as reference: data were not modified. We format the table to fit the same structure as 19C
...
################### regroup 19C and 19A 
All_19C_19A = bind_rows(LD_HD_19C, Samp_plot_19A_allp)
All_19C_19A$Ox_Stress_Norm = All_19C_19A$Ox_Stress / All_19C_19A$Ox_Stress_0
All_19C_19A$Timepoint=factor(All_19C_19A$Timepoint, levels=c("4h", "24h"))
All_19C_19A$Time_dose=paste(All_19C_19A$Timepoint, All_19C_19A$Dose_relative, sep = " ")
All_19C_19A$Time_dose=factor(All_19C_19A$Time_dose, levels=c("4h 0 Gy control",  "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))
All_19C_19A$Radiation_type=factor(All_19C_19A$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
...
## Graph Ox_Stress vs Run_Set, color code radiation + a panel per time point without normalization
graph_without_Norm <- ggplot(All_19C_19A, aes(x=Time_dose, y=Ox_Stress)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Correction_step2_No_Norm_Ox_Stress_per_Run_Set_19C_19A.pdf", graph_without_Norm, width=25, height=7)
#
## Graph Ox_Stress vs Run_Set, color code radiation + a panel per time point with normalization
dose_relative= c("Low dose", "High dose")
All_19C_19A_Norm = All_19C_19A %>% filter(All_19C_19A$Dose_relative %in% dose_relative)
All_19C_19A_Norm$Time_dose=factor(All_19C_19A_Norm$Time_dose, levels=c("4h 0 Gy control",  "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))
All_19C_19A_Norm$Radiation_type=factor(All_19C_19A_Norm$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
graph_with_Norm <- ggplot(All_19C_19A_Norm, aes(x=Time_dose, y=Ox_Stress_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Correction_step2_Norm_Ox_Stress_per_Run_Set_19C_19A.pdf", graph_with_Norm, width=25, height=7)
...
All_19C_19A_10p$Radiation_type=factor(All_19C_19A_10p$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
# without normalization
graph_without_Norm <- ggplot(All_19C_19A_10p, aes(x=Time_dose, y=Ox_Stress)) + geom_boxplot(aes(fill=Run_set))
graph_without_Norm <- graph_without_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_without_Norm)
ggsave("Correction_step2_No_Norm_Ox_Stress_per_Run_Set_19C_19A_10p_overlap.pdf", graph_without_Norm, width=25, height=7)
#
# with normalization
dose_relative= c("Low dose", "High dose")
All_19C_19A_Norm_10p = All_19C_19A_10p %>% filter(All_19C_19A_10p$Dose_relative %in% dose_relative)
All_19C_19A_Norm_10p$Time_dose=factor(All_19C_19A_Norm_10p$Time_dose, levels=c("4h 0 Gy control",  "4h Low dose", "4h High dose","24h 0 Gy control", "24h Low dose", "24h High dose"))
All_19C_19A_Norm_10p$Radiation_type=factor(All_19C_19A_Norm_10p$Radiation_type, levels=c("Fe", "Ar", "Si", "Gamma"))
graph_with_Norm <- ggplot(All_19C_19A_Norm_10p, aes(x=Time_dose, y=Ox_Stress_Norm)) + geom_boxplot(aes(fill=Run_set))
graph_with_Norm <- graph_with_Norm + facet_grid(. ~ Radiation_type) + theme_gray() + ylim(0,7)
print(graph_with_Norm)
ggsave("Correction_step2_Norm_Ox_Stress_per_Run_Set_19C_19A_10p_overlap.pdf", graph_with_Norm, width=25, height=7)

#####################################################################################################
###### Now we regroup data 18B/19A and 19C/19A after the final step of the correction ###############
#####################################################################################################
All_Corrected_OS=bind_rows(All_18B_19A, All_19C_19A)
All_Corrected_OS=unique(All_Corrected_OS) # use unique function because we have 19A data in double otherwise
All_Corrected_OS$Ox_Stress_Norm = NULL
All_Corrected_OS$Rad_dose_Gy = NULL
All_Corrected_OS$Time_dose = NULL
